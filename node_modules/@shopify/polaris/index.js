...
function createThemeContext(theme) {
    if (!theme) {
        return { polarisTheme: { logo: null, subscribe: other.noop, unsubscribe: other.noop } };
    }
    var _theme$logo = theme.logo,
        logo = _theme$logo === undefined ? null : _theme$logo,
        _theme$subscribe = theme.subscribe,
        subscribe = _theme$subscribe === undefined ? other.noop : _theme$subscribe,
        _theme$unsubscribe = theme.unsubscribe,
        unsubscribe = _theme$unsubscribe === undefined ? other.noop : _theme$unsubscribe;

    return { polarisTheme: { logo: logo, subscribe: subscribe, unsubscribe: unsubscribe } };
}

var THEME_CONTEXT_TYPES = { polarisTheme: PropTypes.any };
...
tslib_1.__decorate([decorators.autobind], ThemeProvider$1.prototype, "subscribe", null);
tslib_1.__decorate([decorators.autobind], ThemeProvider$1.prototype, "unsubscribe", null);
...
var polarisAppProviderContextTypes = Object.assign({ polaris: PropTypes.any }, THEME_CONTEXT_TYPES);
...
function createAppProviderContext() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        subscribe = _ref$subscribe === undefined ? other.noop : _ref$subscribe,
        _ref$unsubscribe = _ref.unsubscribe,
        unsubscribe = _ref$unsubscribe === undefined ? other.noop : _ref$unsubscribe;
...
function Image$1(_a) {
    ...
    // eslint-disable-next-line jsx-a11y/alt-text
    React.createElement("img", Object.assign({ src: source }, rest, { crossOrigin: crossOrigin }));
}
...
var Avatar$1 = function (_React$PureComponent) {
    ...
    _createClass(Avatar, [{
        ...
        value: function render() {
            ...
            var imageMarkUp = finalSource && !target.isServer && !hasError ? React.createElement(Image$1, { className: styles$1.Image, source: finalSource, alt: '', role: 'presentation', onLoad: this.handleLoad, onError: this.handleError }) : null;
            // Use `dominant-baseline: central` instead of `dy` when Edge supports it.
            var verticalOffset = '0.35em';
            var initialsMarkup = initials && !hasImage ? React.createElement(
                'span',
...
tslib_1.__decorate([decorators.autobind], Avatar$1.prototype, "handleError", null);
tslib_1.__decorate([decorators.autobind], Avatar$1.prototype, "handleLoad", null);
            ...
            _createClass(WithRef, [{
                ...
                value: function render() {
                    ...
                    return React.createElement(
                        ...
                        null,
                        function (ctx) {
                            return React.createElement(WrappedComponent, Object.assign({}, _this2.props, { ref: ctx.forwardedRef }));
                        }
                    );
                }
            }]);
...
function Icon$1(_ref) {
    ...
    if (source === 'placeholder') {
        ...
        contentMarkup = iconSource && iconSource.viewBox && iconSource.body && React.createElement('svg', { className: styles$2.Svg, viewBox: iconSource.viewBox, dangerouslySetInnerHTML: { __html: iconSource.body }, focusable: 'false', 'aria-hidden': 'true' });
    }
    return React.createElement(
        'span',
...
function Indicator$1(_ref) {
    ...
    var className = styles.classNames(styles$4.Indicator, pulse && styles$4.pulseIndicator);
...
function Button$2(_ref) {
  ...
  var className = reactUtilities.classNames(styles$5.Button, primary && styles$5.primary, outline && styles$5.outline, destructive && styles$5.destructive, isDisabled && styles$5.disabled, loading && styles$5.loading, plain && styles$5.plain, size && size !== DEFAULT_SIZE && styles$5[reactUtilities.variationName('size', size)], fullWidth && styles$5.fullWidth, icon && children == null && styles$5.iconOnly);
  var disclosureIconMarkup = disclosure ? React.createElement(
    IconWrapper,
    null,
    React.createElement(Icon$2, { source: loading ? 'placeholder' : 'caretDown' })
  ) : null;
  var iconMarkup = void 0;
  if (icon) {
    var iconInner = isIconSource(icon) ? React.createElement(Icon$2, { source: loading ? 'placeholder' : icon }) : icon;
  ...
  var spinnerSVGMarkup = loading ? React.createElement(
    ...
    React.createElement(Spinner$2, { size: 'small', color: spinnerColor, accessibilityLabel: intl.translate('Polaris.Button.spinnerAccessibilityLabel') })
  ) : null;
  var indicatorMarkup = indicator && React.createElement(Indicator$1, null);
...
var Item$1 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$6.Item, focused && styles$6['Item-focused'], button.props.plain && styles$6['Item-plain']);
            return React.createElement(
                'div',
...
tslib_1.__decorate([decorators.autobind], Item$1.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], Item$1.prototype, "handleBlur", null);
...
function ButtonGroup$2(_ref) {
    ...
    var className = styles.classNames(styles$6.ButtonGroup, segmented && styles$6.segmented, fullWidth && styles$6.fullWidth, connectedTop && styles$6.connectedTop);
    var contents = reactUtilities.elementChildren(children).map(function (child, index) {
        return React.createElement(Item$1, { button: child, key: index });
    });
    return React.createElement(
        'div',
        { className: className },
...
function Item$4(_ref) {
    ...
    var className = styles.classNames(styles$7.Item, fill && styles$7['Item-fill']);
    return React.createElement(
        'div',
        { className: className },
        children
...
var Stack$1 = function (_React$PureComponent) {
    ...
    _createClass(Stack, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$7.Stack, vertical && styles$7.vertical, spacing && styles$7[styles.variationName('spacing', spacing)], distribution && styles$7[styles.variationName('distribution', distribution)], alignment && styles$7[styles.variationName('alignment', alignment)], wrap === false && styles$7.noWrap);
...
function Header$1(_ref) {
    ...
    var actionMarkup = actions$$1 ? React.createElement(
        ButtonGroup$2,
        null,
...
function Section$1(_ref) {
  ...
  var className = styles.classNames(styles$9.Section, subdued && styles$9['Section-subdued'], fullWidth && styles$9['Section-fullWidth']);
  return React.createElement(
    'div',
    { className: className },
    headerContent,
...
var Card$1 = function (_React$PureComponent) {
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$9.Card, subdued && styles$9.subdued);
            var headerMarkup = title ? React.createElement(Header$1, { actions: actions$$1, title: title }) : null;
...
function TextStyle$1(_ref) {
    ...
    var className = styles.classNames(variation && styles$11[styles.variationName('variation', variation)], variation === VariationValue.Code && styles$11.code);
...
function AccountConnection$1(_ref) {
    ...
    var avatarMarkup = connected ? React.createElement(Avatar$2, { accessibilityLabel: '', name: accountName, initials: initials, source: avatarUrl }) : null;
...
var ScrollTo$1 = function (_React$Component) {
    ...
    _createClass(ScrollTo, [{
        ...
        value: function render() {
            ...
            return React.createElement('a', { id: getUniqueId(), ref: this.ref });
        }
    }]);
...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = styles.classNames(className, styles$14.Scrollable, vertical && styles$14.vertical, horizontal && styles$14.horizontal, topShadow && styles$14.hasTopShadow, bottomShadow && styles$14.hasBottomShadow);
            return React.createElement(
                'div',
...
function Badge$1(_ref) {
    ...
    var className = styles.classNames(styles$16.Badge, status && styles$16[styles.variationName('status', status)], progress && styles$16[styles.variationName('progress', progress)], size && size !== DEFAULT_SIZE$1 && styles$16[styles.variationName('size', size)]);
...
function Item$6(_ref) {
  ...
  var className = reactUtilities.classNames(styles$17.Item, disabled && styles$17.disabled, destructive && styles$17.destructive, active && styles$17.active);
  var imageElement = null;
  if (icon) {
    imageElement = React.createElement(
      'div',
      { className: styles$17.Image },
      React.createElement(Icon$2, { source: icon })
    );
  } else if (image) {
    imageElement = React.createElement('div', { role: 'presentation', className: styles$17.Image, style: { backgroundImage: 'url(' + image } });
  }
  ...
  var scrollMarkup = active ? React.createElement(Scrollable$2.ScrollTo, null) : null;
...
function Section$3(_ref) {
    ...
    var actionMarkup = section.items.map(function (_a, index) {
        ...
        return React.createElement(Item$6, Object.assign({ key: content + '-' + index, content: content, role: actionRole, onAction: handleAction(onAction) }, item));
    });
...
function ActionList$1(_ref) {
    ...
    var sectionMarkup = finalSections.map(function (section, index) {
        return React.createElement(Section$3, { key: section.title || index, section: section, onActionAnyItem: onActionAnyItem, hasMultipleSections: hasMultipleSections, actionRole: actionRole });
    });
    return React.createElement(
        Element,
...
function Checkbox$1(_ref) {
  ...
  var className = styles.classNames(styles$18.Checkbox, active && styles$18.active);
  return React.createElement(
    'div',
    { className: className },
    React.createElement('input', { id: id, name: name, value: value, type: 'checkbox', checked: checked, disabled: disabled, className: styles$18.Input, 'aria-checked': checked, onChange: onChange, role: role }),
    React.createElement('div', { className: styles$18.Backdrop }),
    React.createElement(
      'div',
      { className: styles$18.Icon },
      React.createElement(Icon$2, { source: 'checkmark' })
    )
  );
}
...
var Option$1 = function (_React$Component) {
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            ...
            var singleSelectClassName = styles.classNames(styles$19.SingleSelectOption, focused && styles$19.focused, disabled && styles$19.disabled, select && styles$19.select, active && styles$19.active);
            var multiSelectClassName = styles.classNames(styles$19.Label, active && styles$19.active);
            ...
            var optionMarkup = allowMultiple ? React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Checkbox$1, { id: id, value: value, checked: select, active: active, disabled: disabled, onChange: this.handleClick, role: checkBoxRole })
                ),
                mediaMarkup,
                label
            ) : React.createElement(
...
var getUniqueId$1 = other.createUniqueIDFactory('OptionList');
        ...
        value: function render() {
            ...
            var optionsMarkup = optionsExist ? normalizedOptions.map(function (_ref2, sectionIndex) {
                ...
                var optionsMarkup = options && options.map(function (option, optionIndex) {
                    ...
                    return React.createElement(Option$1, Object.assign({}, option, { key: id, id: id, section: sectionIndex, index: optionIndex, onClick: _this2.handleClick, select: isSelected, allowMultiple: allowMultiple, role: optionRole }));
                });
                return React.createElement(
                    'li',
...
var getUniqueID$2 = other.createUniqueIDFactory('portal-');
    ...
    _createClass(Portal, [{
        ...
        value: function componentDidUpdate(_, prevState) {
            var _props$onPortalCreate = this.props.onPortalCreated,
                onPortalCreated = _props$onPortalCreate === undefined ? other.noop : _props$onPortalCreate;
...
function Pane$1(_ref) {
    ...
    var className = styles.classNames(styles$21.Pane, fixed && styles$21['Pane-fixed']);
    var content = sectioned ? reactUtilities.wrapWithComponent(children, Section$5) : children;
...
var PositionedOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PositionedOverlay, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$22.PositionedOverlay, fixed && styles$22.fixed);
            return React.createElement(
                'div',
...
var PopoverOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function renderOverlay(transitionStatus) {
            ...
            return React.createElement(PositionedOverlay$1, { fullWidth: fullWidth, active: active, activator: activator, preferredPosition: preferredPosition, preferredAlignment: preferredAlignment
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = styles.classNames(styles$21.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$21.positionedAbove, fullWidth && styles$21.fullWidth, measuring && styles$21.measuring);
            this.transitionStatus = transitionStatus;
            var contentStyles = measuring ? undefined : { height: desiredHeight };
            var contentClassNames = styles.classNames(styles$21.Content, fullHeight && styles$21['Content-fullHeight']);
            ...
            return React.createElement(
                ...
                React.createElement(KeypressListener$1, { keyCode: exports.Key.Escape, handler: this.handleEscape }),
                React.createElement('div', { className: styles$21.FocusTracker
...
function Label$1(_ref) {
    ...
    var className = styles.classNames(styles$23.Label, hidden && styles$23.hidden);
    return React.createElement(
        'div',
        { className: className },
        React.createElement(
...
function InlineError$1(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Icon$2, { source: 'alert' })
    ),
    message
  );
}
...
function Labelled$1(_a) {
  ...
  var className = styles.classNames(labelHidden && styles$25.hidden);
  ...
  var errorMarkup = error && typeof error !== 'boolean' && React.createElement(
    ...
    React.createElement(InlineError$1, { message: error, fieldID: id })
  );
...
var Resizer$1 = function (_React$PureComponent) {
    ...
    _createClass(Resizer, [{
        ...
        value: function render() {
            ...
            var minimumLinesMarkup = minimumLines ? React.createElement('div', { ref: this.setMinimumLinesNode, className: styles$27.DummyInput, dangerouslySetInnerHTML: {
            ...
            return React.createElement(
                ...
                React.createElement('div', { ref: this.setContentNode, className: styles$27.DummyInput, dangerouslySetInnerHTML: { __html: getFinalContents(contents) } }),
                minimumLinesMarkup
            );
        }
    }, {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Icon$2, { source: 'caretUp' })
      )
    ),
    React.createElement(
      'div',
      ...
      React.createElement(
        'div',
        { className: styles$27.SpinnerIcon },
        React.createElement(Icon$2, { source: 'caretDown' })
      )
    )
  );
}
...
var TextField$5 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$27.TextField, Boolean(value) && styles$27.hasValue, disabled && styles$27.disabled, readOnly && styles$27.readOnly, error && styles$27.error, multiline && styles$27.multiline, this.state.focus && styles$27.focus);
            ...
            var spinnerMarkup = type === 'number' && !disabled ? React.createElement(Spinner$4, { onChange: this.handleNumberChange, onMouseDown: this.handleButtonPress, onMouseUp: this.handleButtonRelease }) : null;
            var style = multiline && height ? { height: height } : null;
            var resizer = multiline ? React.createElement(Resizer$1, { contents: value || placeholder, currentHeight: height, minimumLines: typeof multiline === 'number' ? multiline : 1, onHeightChange: this.handleExpandingResize }) : null;
            var describedBy = [];
            if (error) {
            ...
            var inputClassName = styles.classNames(styles$27.Input, suffix && styles$27['Input-suffixed']);
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        suffixMarkup,
                        spinnerMarkup,
                        React.createElement('div', { className: styles$27.Backdrop }),
                        resizer
                    )
                )
            );
...
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "setInput", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleNumberChange", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleExpandingResize", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleKeyPress", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleChange", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleBlur", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleClick", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleButtonPress", null);
tslib_1.__decorate([decorators.autobind], TextField$5.prototype, "handleButtonRelease", null);
...
var TextField$2 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            return React.createElement(TextField$5, Object.assign({}, this.props, { autoComplete: false, ariaAutocomplete: 'list', ariaActiveDescendant: selectedOptionId, ariaControls: comboBoxId }));
        }
    }, {
        key: 'handleContextUpdate',
        value: function handleContextUpdate() {
...
var ComboBox$1 = function (_React$PureComponent) {
    ...
    _createClass(ComboBox, [{
        ...
        value: function render() {
            ...
            var actionsBeforeMarkup = actionsBefore && actionsBefore.length > 0 && React.createElement(ActionList$1, { actionRole: 'option', items: actionsBefore });
            var actionsAfterMarkup = actionsAfter && actionsAfter.length > 0 && React.createElement(ActionList$1, { actionRole: 'option', items: actionsAfter });
            var optionsMarkup = options.length > 0 && React.createElement(OptionList$2, { role: 'presentation', optionRole: 'option', options: filterForOptions(this.state.navigableOptions), onChange: this.selectOptions, selected: this.state.selectedOptions, title: listTitle, allowMultiple: allowMultiple });
            var scrollListenerMarkup = onEndReached && React.createElement('div', { ref: this.popoverScrollContainer });
            var emptyStateMarkup = !actionsAfter && !actionsBefore && !contentAfter && !contentBefore && options.length === 0 && emptyState && React.createElement(
                'div',
            ...
            return React.createElement(
                ...
                React.createElement(KeypressListener$1, { keyCode: exports.Key.DownArrow, handler: this.handleDownArrow }),
                React.createElement(KeypressListener$1, { keyCode: exports.Key.UpArrow, handler: this.handleUpArrow }),
                React.createElement(KeypressListener$1, { keyCode: exports.Key.Enter, handler: this.handleEnter }),
                React.createElement(KeypressListener$1, { keyCode: exports.Key.Escape, handler: this.handlePopoverClose }),
                React.createElement(
                    Popover$1,
        ...
        value: function addScrollListener() {
            this.popoverScrollContainer.current && this.popoverScrollContainer.current.parentElement && events.addEventListener(this.popoverScrollContainer.current.parentElement, 'scroll', this.handleScroll, { passive: true });
        }
    }, {
        key: 'removeScrollListener',
        value: function removeScrollListener() {
...
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "subscribe", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "unsubscribe", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleDownArrow", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleUpArrow", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleEnter", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleBlur", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleClick", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleScroll", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handleSelection", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "selectOptions", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "updateIndexOfSelectedOption", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "resetVisuallySelectedOptions", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handlePopoverClose", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "handlePopoverOpen", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "selectNextOption", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "selectPreviousOption", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "selectOptionAtIndex", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "visuallyUpdateSelectedOption", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "getSelectedOptionId", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "addScrollListener", null);
tslib_1.__decorate([decorators.autobind], ComboBox$1.prototype, "removeScrollListener", null);
...
function TextField(props) {
    return React.createElement(ComboBox$1.TextField, props);
}
var Autocomplete$1 = function (_React$PureComponent) {
    ...
    _createClass(Autocomplete, [{
        ...
        value: function render() {
            ...
            var spinnerMarkup = loading ? React.createElement(
                'div',
                { className: styles$29.Loading },
                React.createElement(Spinner$2, { size: 'small', accessibilityLabel: intl.translate('Polaris.Autocomplete.spinnerAccessibilityLabel') })
            ) : null;
...
var Banner$1 = function (_React$PureComponent) {
    ...
    _createClass(Banner, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$30.Banner, status && styles$30[styles.variationName('status', status)], onDismiss && styles$30.hasDismiss, withinContentContainer ? styles$30.withinContentContainer : styles$30.withinPage);
            var id = uniqueID();
            ...
            var dismissButton = onDismiss ? React.createElement(
                ...
                React.createElement(Button$3, { plain: true, icon: 'cancelSmall', onClick: onDismiss, accessibilityLabel: 'Dismiss notification' })
            ) : null;
            return React.createElement(
                'div',
                { className: className
                ...
                React.createElement(
                    ...
                    React.createElement(Icon$2, { source: iconName, color: color, backdrop: true })
                ),
                React.createElement(
                    'div',
                    null,
...
function Backdrop$1(props) {
    ...
    var className = reactUtilities.classNames(styles$31.Backdrop, belowNavigation && styles$31.belowNavigation);
    return React.createElement(
        React.Fragment,
        null,
        React.createElement(ScrollLock$1, null),
        React.createElement('div', { className: className, onClick: onClick, onTouchStart: onTouchStart })
    );
}
    ...
    value: function render() {
      ...
      var contentMarkup = React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Icon$2, { source: 'chevronLeft' })
        ),
        React.createElement(
          'span',
...
function TextContainer$1(_ref) {
    ...
    var className = styles.classNames(styles$33.TextContainer, spacing && styles$33[styles.variationName('spacing', spacing)]);
    return React.createElement(
        'div',
        { className: className },
        children
...
function CalloutCard$1(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Image$1, { alt: '', className: styles$34.Image, source: illustration })
    )
  );
}
...
function Choice$1(_ref) {
  ...
  var className = styles.classNames(styles$36.Choice, labelHidden && styles$36.labelHidden, disabled && styles$36.disabled);
...
function Checkbox$3(_ref) {
    ...
    var wrapperClassName = styles.classNames(styles$37.Checkbox, error && styles$37.error);
    ...
    var inputClassName = styles.classNames(styles$37.Input, isIndeterminate && styles$37['Input-indeterminate']);
    return (
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('span', { className: styles$37.Backdrop }),
                React.createElement(
                    'span',
                    { className: styles$37.Icon },
                    React.createElement(Icon$2, { source: iconSource })
                )
            )
        )
...
var getUniqueID$6 = other.createUniqueIDFactory('RadioButton');
function RadioButton$1(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('input', { id: id, name: name, value: value, type: 'radio', checked: checked, disabled: disabled, className: styles$38.Input, onChange: handleChange, onFocus: onFocus, onBlur: onBlur, 'aria-describedby': describedBy }),
            React.createElement('span', { className: styles$38.Backdrop }),
            React.createElement('span', { className: styles$38.Icon })
        )
    );
}
...
var getUniqueID$5 = other.createUniqueIDFactory('ChoiceList');
function ChoiceList$1(_ref) {
    ...
    var className = styles.classNames(styles$39.ChoiceList, titleHidden && styles$39.titleHidden);
    var titleMarkup = title ? React.createElement(
        'legend',
    ...
    var choicesMarkup = choices.map(function (choice) {
        ...
        var children = renderedChildren ? React.createElement(
            'div',
    ...
    var errorMarkup = error && React.createElement(
        ...
        React.createElement(InlineError$1, { message: error, fieldID: finalName })
    );
    return React.createElement(
        'fieldset',
...
var Collapsible$1 = function (_React$Component) {
    ...
    _createClass(Collapsible, [{
        ...
        value: function render() {
            ...
            var wrapperClassName = styles.classNames(styles$40.Collapsible, open && styles$40.open, animating && styles$40.animating);
    ...
    _createClass(Slidable, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                touchEndListener,
                touchCancelListener,
                React.createElement('div', { style: draggerPositioning, className: styles$41.Dragger, ref: this.setDraggerNode })
            );
        }
    }, {
        key: 'setDraggerNode',
    ...
    _createClass(AlphaPicker, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement('div', { className: styles$41.ColorLayer, style: { background: background } }),
                React.createElement(Slidable$1, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
            );
        }
    }, {
        key: 'setSliderHeight',
...
var ColorPicker$1 = function (_React$PureComponent) {
    ...
    _createClass(ColorPicker, [{
        ...
        value: function render() {
            ...
            var alphaSliderMarkup = allowAlpha ? React.createElement(AlphaPicker$1, { alpha: alpha, color: color, onChange: this.handleAlphaChange }) : null;
            return React.createElement(
                'div',
                ...
                React.createElement(
                    ...
                    React.createElement('div', { className: styles$41.ColorLayer, style: { backgroundColor: colorString } }),
                    React.createElement(Slidable$1, { onChange: this.handleDraggerMove, draggerX: draggerX, draggerY: draggerY })
                ),
                React.createElement(HuePicker$1, { hue: hue, onChange: this.handleHueChange }),
                alphaSliderMarkup
            );
        }
    }, {
    ...
    _createClass(Focus, [{
        ...
        value: function componentDidUpdate(_a) {
            var prevChildren = _a.children,
                restPrevProps = tslib_1.__rest(_a, ["children"]);var _b = this.props,
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(EventListener$1, { event: 'focusout', handler: this.handleBlur }),
                    children
                )
            );
        }
...
tslib_1.__decorate([decorators.autobind], TrapFocus$1.prototype, "setFocusTrapWrapper", null);
tslib_1.__decorate([decorators.autobind], TrapFocus$1.prototype, "handleBlur", null);
...
var Toast = function (_React$Component) {
    ...
    _createClass(Toast, [{
        ...
        value: function render() {
            ...
            var dismissMarkup = React.createElement(
                'button',
                { type: 'button', className: styles$42.CloseButton, onClick: onDismiss },
                React.createElement(Icon$2, { source: 'cancel' })
            );
            var className = reactUtilities.classNames(styles$42.Toast, error && styles$42.error);
            return React.createElement(
                'div',
                { className: className },
                React.createElement(KeypressListener$1, { keyCode: exports.Key.Escape, handler: onDismiss }),
                content,
                dismissMarkup
            );
        }
    ...
    _createClass(ToastManager, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(EventListener$1, { event: 'resize', handler: this.updateToasts }),
                React.createElement(
                    'div',
...
tslib_1.__decorate([decorators.autobind], ToastManager$1.prototype, "updateToasts", null);
var toastClasses = {
    enter: styles.classNames(styles$43.ToastWrapper, styles$43['ToastWrapper-enter']),
    enterDone: styles.classNames(styles$43.ToastWrapper, styles$43['ToastWrapper-enter-done']),
    exit: styles.classNames(styles$43.ToastWrapper, styles$43['ToastWrapper-exit'])
};
    ...
    _createClass(Loading$$1, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement('div', { className: styles$44.Level, style: customStyles, 'aria-valuenow': ariaValuenow, 'aria-valuemin': 0, 'aria-valuemax': 100, role: 'progressbar' })
            );
        }
    }, {
        key: 'increment',
...
tslib_1.__decorate([decorators.debounce(15)], Loading$2.prototype, "ariaValuenow", null);
...
function transformActionGroups(appBridge) {
    ...
    var buttonGroups = [].concat(_toConsumableArray(actionGroups.map(function (group) {
        ...
        return actions.ButtonGroup.create(appBridge, { label: group.title, buttons: buttons });
    })));
    return buttonGroups;
}
...
function Dialog$1(_a) {
  ...
  var classes = styles.classNames(styles$45.Modal, large && styles$45.sizeLarge, limitHeight && styles$45.limitHeight);
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(KeypressListener$1, { keyCode: exports.Key.Escape, handler: onClose }),
          children
        )
      )
    )
...
var fadeUpClasses = {
  enter: styles.classNames(styles$45.animateFadeUp, styles$45.entering),
  enterActive: styles.classNames(styles$45.animateFadeUp, styles$45.entered),
  exit: styles.classNames(styles$45.animateFadeUp, styles$45.exiting),
  exitActive: styles.classNames(styles$45.animateFadeUp, styles$45.exited)
};
function FadeUp(_a) {
...
function Footer$1(_ref) {
  ...
  var actions$$1 = primaryActionButton || secondaryActionButtons ? React.createElement(
    ButtonGroup$2,
    null,
...
function DisplayText$1(_ref) {
    ...
    var className = styles.classNames(styles$47.DisplayText, size && styles$47[styles.variationName('size', size)]);
    return React.createElement(
        Element,
        { className: className },
        children
...
function CloseButton$1(_ref) {
    ...
    var className = reactUtilities.classNames(styles$48.CloseButton, !title && styles$48.withoutTitle);
    return React.createElement(
        'button',
        { onClick: onClick, className: className },
        React.createElement(Icon$2, { source: 'cancel', color: 'inkLighter' })
    );
}
...
function Section$7(_ref) {
    ...
    var className = styles.classNames(styles$50.Section, flush && styles$50.flush, subdued && styles$50.subdued);
    return React.createElement(
        'section',
        { className: className },
        children
        ...
        value: function render() {
            ...
            if (open) {
                ...
                var body = loading ? React.createElement(
                    ...
                    React.createElement(Spinner$2, null)
                ) : content;
                var bodyMarkup = src ? React.createElement('iframe', { name: iFrameName, title: iframeTitle, src: src, className: styles$51.IFrame, onLoad: this.handleIFrameLoad, style: { height: iframeHeight + 'px' } }) : React.createElement(
                    Scrollable$2,
                ...
                var headerMarkup = title ? React.createElement(
                    ...
                    title
                ) : React.createElement(CloseButton$1, { onClick: onClose, title: false });
                ...
                backdrop = React.createElement(Backdrop$1, null);
            }
...
tslib_1.__decorate([decorators.autobind], Modal$2.prototype, "handleEntered", null);
tslib_1.__decorate([decorators.autobind], Modal$2.prototype, "handleExited", null);
tslib_1.__decorate([decorators.autobind], Modal$2.prototype, "handleIFrameLoad", null);
...
var ContextualSaveBar$4 = function (_React$PureComponent) {
    ...
    _createClass(ContextualSaveBar, [{
        ...
        value: function render() {
            ...
            var discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && React.createElement(DiscardConfirmationModal$2, { open: discardConfirmationModalVisible, onCancel: this.toggleDiscardConfirmationModal, onDiscard: discardAction.onAction });
            var discardActionMarkup = discardAction && React.createElement(
                Button$3,
            ...
            var saveActionMarkup = saveAction && React.createElement(
                Button$3,
            ...
            var imageMarkup = logo && React.createElement(Image$1, { style: { width: width }, source: logo.contextualSaveBarSource || '', alt: '' });
            var logoMarkup = alignContentFlush ? null : React.createElement(
                'div',
...
tslib_1.__decorate([decorators.autobind], ContextualSaveBar$4.prototype, "toggleDiscardConfirmationModal", null);
...
var Frame$1 = function (_React$PureComponent) {
    ...
    _createClass(Frame, [{
        ...
        value: function render() {
            ...
            var navClassName = styles.classNames(styles$53.Navigation, showMobileNavigation && styles$53['Navigation-visible']);
            ...
            var navigationMarkup = navigation ? React.createElement(
                TrapFocus$1,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(Icon$2, { source: 'cancel', color: 'white' })
                        )
                    )
                )
            ) : null;
            var loadingMarkup = loadingStack > 0 ? React.createElement(
                'div',
                { className: styles$53.LoadingBar, id: APP_FRAME_LOADING_BAR },
                React.createElement(Loading$2, null)
            ) : null;
            var contextualSaveBarMarkup = React.createElement(
                reactTransitionGroup.CSSTransition,
                ...
                React.createElement(
                    ...
                    React.createElement(ContextualSaveBar$5, this.contextualSaveBar)
                )
            );
            var topBarMarkup = topBar ? React.createElement(
                'div',
                Object.assign({ className: styles$53.TopBar }, layer.props, dataPolarisTopBar.props, { id: APP_FRAME_TOP_BAR }),
                topBar
            ) : null;
            var globalRibbonMarkup = globalRibbon ? React.createElement(
                'div',
                { className: styles$53.GlobalRibbonContainer, ref: this.setGlobalRibbonContainer },
                globalRibbon
            ) : null;
            var skipClassName = styles.classNames(styles$53.Skip, skipFocused && styles$53.focused);
            var skipMarkup = React.createElement(
                'div',
            ...
            var frameClassName = styles.classNames(styles$53.Frame, navigation && styles$53.hasNav, topBar && styles$53.hasTopBar);
            var navigationOverlayMarkup = showMobileNavigation && mobileView ? React.createElement(Backdrop$1, { belowNavigation: true, onClick: this.handleNavigationDismiss, onTouchStart: this.handleNavigationDismiss }) : null;
            return React.createElement(
                'div',
                ...
                React.createElement(ToastManager$1, { toastMessages: toastMessages }),
                globalRibbonMarkup,
                React.createElement(EventListener$1, { event: 'resize', handler: this.handleResize })
            );
        }
    }, {
...
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "setGlobalRibbonHeight", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "setGlobalRibbonRootProperty", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "showToast", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "hideToast", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "setContextualSaveBar", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "removeContextualSaveBar", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "startLoading", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "stopLoading", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "handleResize", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "handleClick", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "handleBlur", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "handleNavigationDismiss", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "setGlobalRibbonContainer", null);
tslib_1.__decorate([decorators.autobind], Frame$1.prototype, "handleNavKeydown", null);
var navTransitionClasses = {
    enter: styles.classNames(styles$53['Navigation-enter']),
    enterActive: styles.classNames(styles$53['Navigation-enterActive']),
    enterDone: styles.classNames(styles$53['Navigation-enterActive']),
    exit: styles.classNames(styles$53['Navigation-exit']),
    exitActive: styles.classNames(styles$53['Navigation-exitActive'])
};
var contextualSaveBarTransitionClasses = {
    enter: styles.classNames(styles$53['ContextualSaveBar-enter']),
    enterActive: styles.classNames(styles$53['ContextualSaveBar-enterActive']),
    enterDone: styles.classNames(styles$53['ContextualSaveBar-enterActive']),
    exit: styles.classNames(styles$53['ContextualSaveBar-exit']),
    exitActive: styles.classNames(styles$53['ContextualSaveBar-exitActive'])
};
...
function Cell$1(_ref) {
  ...
  var className = styles.classNames(styles$54.Cell, fixed && styles$54['Cell-fixed'], fixed && truncate && styles$54['Cell-truncated'], header && styles$54['Cell-header'], total && styles$54['Cell-total'], footer && styles$54['Cell-footer'], numeric && styles$54['Cell-numeric'], sortable && styles$54['Cell-sortable'], sorted && styles$54['Cell-sorted']);
  var headerClassName = styles.classNames(header && styles$54.Heading, header && contentType === 'text' && styles$54['Heading-left']);
  var iconClassName = styles.classNames(sortable && styles$54.Icon);
  var style = {
  ...
  var iconMarkup = React.createElement(
    ...
    React.createElement(Icon$2, { source: source, accessibilityLabel: sortAccessibilityLabel })
  );
...
function Navigation$1(_ref) {
    ...
    var pipMarkup = columnVisibilityData.map(function (column, index) {
        var className = styles.classNames(styles$54.Pip, column.isVisible && styles$54['Pip-visible']);
        return React.createElement('div', { className: className, key: 'pip-' + index });
    });
    ...
    return React.createElement(
        ...
        React.createElement(Button$3, { plain: true, icon: 'chevronLeft', disabled: isScrolledFarthestLeft, accessibilityLabel: leftA11yLabel, onClick: navigateTableLeft }),
        pipMarkup,
        React.createElement(Button$3, { plain: true, icon: 'chevronRight', disabled: isScrolledFarthestRight, accessibilityLabel: rightA11yLabel, onClick: navigateTableRight })
    );
}
...
var DataTable$1 = function (_React$PureComponent) {
    ...
    _createClass(DataTable, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$54.DataTable, collapsed && styles$54.collapsed, footerContent && styles$54.hasFooter);
            var wrapperClassName = styles.classNames(styles$54.TableWrapper, collapsed && styles$54.collapsed);
            var footerClassName = styles.classNames(footerContent && styles$54.TableFoot);
            ...
            var headingMarkup = React.createElement(
                ...
                headings.map(function (heading, headingIndex) {
                    ...
                    return React.createElement(Cell$2, Object.assign({ header: true, key: id, height: height, content: heading, contentType: columnContentTypes[headingIndex], fixed: headingIndex === 0, truncate: truncate }, sortableHeadingProps));
                })
            );
            ...
            return React.createElement(
                'div',
                { className: wrapperClassName },
                React.createElement(Navigation$2, { columnVisibilityData: columnVisibilityData, isScrolledFarthestLeft: isScrolledFarthestLeft, isScrolledFarthestRight: isScrolledFarthestRight, navigateTableLeft: this.navigateTable('left'), navigateTableRight: this.navigateTable('right') }),
                React.createElement(
                    'div',
                    ...
                    React.createElement(
                        ...
                        React.createElement(EventListener$1, { event: 'resize', handler: this.handleResize }),
                        React.createElement(EventListener$1, { capture: true, event: 'scroll', handler: this.scrollListener }),
                        React.createElement(
                            'table',
        ...
        value: function renderTotals(total, index) {
            ...
            return React.createElement(Cell$2, { total: true, fixed: index === 0, key: id, height: heights[1], content: content, contentType: contentType, truncate: truncate });
        }
    }, {
        key: 'defaultRenderRow',
        value: function defaultRenderRow(row, index) {
            var className = styles.classNames(styles$54.TableRow);
            var _props4 = this.props,
            ...
            return React.createElement(
                ...
                row.map(function (content, cellIndex) {
                    ...
                    return React.createElement(Cell$2, { key: id, height: bodyCellHeights[index], content: content, contentType: columnContentTypes[cellIndex], fixed: cellIndex === 0, truncate: truncate });
                })
            );
        }
    }, {
        ...
        value: function renderFooter() {
            ...
            return React.createElement(Cell$2, { footer: true, height: footerCellHeight, content: this.props.footerContent, truncate: this.props.truncate });
        }
    }, {
        key: 'defaultOnSort',
...
var Day$1 = function (_React$PureComponent) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            if (!day) {
                return React.createElement('div', { className: styles$55.EmptyDay, onMouseOver: handleHover });
            }
            var handleClick = onClick && !disabled ? onClick.bind(null, day) : other.noop;
            var today = dates.isSameDay(new Date(), day);
            var className = styles.classNames(styles$55.Day, selected && styles$55['Day-selected'], disabled && styles$55['Day-disabled'], today && styles$55['Day-today'], (inRange || inHoveringRange) && !disabled && styles$55['Day-inRange']);
...
function Weekday$1(_ref) {
    ...
    var className = styles.classNames(styles$55.Weekday, current && styles$55['Weekday-current']);
    return React.createElement(
        'div',
...
function Month$1(_ref) {
    ...
    var className = styles.classNames(styles$55.Title, current && styles$55['Month-current']);
    ...
    var weekdays = getWeekdaysOrdered(weekStartsOn).map(function (weekday) {
        return React.createElement(Weekday$1, { key: weekday, title: dates.abbreviationForWeekday(weekday), current: current && new Date().getDay() === weekday, label: weekday });
    });
    ...
    function renderWeek(day, dayIndex) {
        if (day == null) {
            ...
            return (
                // eslint-disable-next-line react/jsx-no-bind
                React.createElement(Day$2, { key: dayIndex, onHover: onHover.bind(null, lastDayOfMonth) })
            );
        }
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Button$3, { plain: true, icon: 'arrowLeft', accessibilityLabel: intl.translate('Polaris.DatePicker.previousMonth', {
                            previousMonthName: previousMonthName,
                            showPreviousYear: showPreviousYear
                        })
                        // eslint-disable-next-line react/jsx-no-bind
                        , onClick: this.handleMonthChangeClick.bind(null, showPreviousMonth, showPreviousYear) }),
                    React.createElement(Button$3, { plain: true, icon: 'arrowRight', accessibilityLabel: intl.translate('Polaris.DatePicker.nextMonth', {
                            nextMonth: nextMonth,
                            nextYear: nextYear
                        })
                        // eslint-disable-next-line react/jsx-no-bind
                ...
                value: function render() {
                    ...
                    return React.createElement(
                        ...
                        function (ctx) {
                            ...
                            return React.createElement(WrappedComponent, Object.assign({}, rest, { context: Object.assign({}, context, ctx) }));
                        }
                    );
                }
            }]);
...
var FileUpload$1 = function (_React$Component) {
    ...
    _createClass(FileUpload, [{
        ...
        value: function render() {
            ...
            var imageClasses = styles.classNames(styles$58.Image, size && size === 'extraLarge' && styles$58.sizeExtraLarge, size && size === 'large' && styles$58.sizeLarge);
            var extraLargeView = size === 'extraLarge' ? React.createElement(
                Stack$1,
                { vertical: true },
                type === 'file' && React.createElement('img', { className: imageClasses, src: AssetFileUpload, alt: '' }),
                type === 'image' && React.createElement('img', { className: imageClasses, src: AssetImageUpload, alt: '' }),
                React.createElement(
                    Button$3,
                    null,
                    actionTitle
            ...
            var smallView = size === 'small' ? React.createElement(
                Stack$1,
                { vertical: true, spacing: 'tight' },
                React.createElement(Icon$2, { source: IconDragDrop, color: 'inkLightest' })
            ) : null;
            return React.createElement(
                'div',
...
var DropZone$1 = function (_React$Component) {
    ...
    _createClass(DropZone, [{
        ...
        value: function render() {
            ...
            var classes = styles.classNames(styles$59.DropZone, outline && styles$59.hasOutline, (active || dragging) && styles$59.isDragging, error && styles$59.hasError, size && size === 'extraLarge' && styles$59.sizeExtraLarge, size && size === 'large' && styles$59.sizeLarge, size && size === 'medium' && styles$59.sizeMedium, size && size === 'small' && styles$59.sizeSmall);
            var dragOverlay = (active || dragging) && !error && overlay ? React.createElement(
                ...
                React.createElement(
                    Stack$1,
                    { vertical: true, spacing: 'tight' },
                    React.createElement(Icon$2, { source: IconDragDrop, color: 'indigo' }),
            ...
            var dragErrorOverlay = dragging && error ? React.createElement(
                ...
                React.createElement(
                    Stack$1,
                    { vertical: true, spacing: 'tight' },
                    React.createElement(Icon$2, { source: IconAlertCircle, color: 'red' }),
                    size === 'extraLarge' && React.createElement(
                        DisplayText$1,
                        { size: 'small', element: 'p' },
                        errorOverlayText
...
var EmptySearchResult$1 = function (_React$PureComponent) {
    ...
    _createClass(EmptySearchResult, [{
        ...
        value: function render() {
            ...
            var illustrationMarkup = withIllustration ? React.createElement(Image$1, { alt: altText, source: emptySearch, className: styles$60.Image, draggable: false }) : null;
            return React.createElement(
                Stack$1,
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$61.EmptyState, imageContained && styles$61.imageContained);
      var imageMarkup = largeImage ? React.createElement(Image$1, { alt: '', role: 'presentation', className: styles$61.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : React.createElement(Image$1, { role: 'presentation', alt: '', className: styles$61.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return React.createElement(
        'div',
        { className: className },
...
function ExceptionList$1(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = styles.classNames(styles$63.Item, status && styles$63[styles.variationName('status', status)]);
    var iconMarkup = icon ? React.createElement(Icon$2, { source: icon }) : React.createElement('span', { className: styles$63.Bullet });
    var titleMarkup = title && React.createElement(
      'span',
    ...
    var Element = truncate ? Truncate$1 : React.Fragment;
    return React.createElement(
      'li',
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Icon$2, { source: 'help', color: 'teal', backdrop: true })
      ),
      React.createElement(
        'div',
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var submitMarkup = implicitSubmit ? React.createElement(
                VisuallyHidden$1,
                null,
                React.createElement('button', { type: 'submit', 'aria-hidden': 'true' })
            ) : null;
            return React.createElement(
                'form',
...
function Group$1(_ref) {
    ...
    var className = styles.classNames(condensed ? styles$65.condensed : styles$65.grouped);
...
function Section$9(_ref) {
    ...
    var className = styles.classNames(styles$67.Section, secondary && styles$67['Section-secondary'], fullWidth && styles$67['Section-fullWidth']);
    return React.createElement(
        'div',
        { className: className },
        children
...
var ContentList = function (_React$PureComponent) {
    ...
    _createClass(ContentList, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$68.List, type && styles$68[styles.variationName('type', type)]);
...
var BaseItem = function (_React$Component) {
    ...
    _createClass(BaseItem, [{
        ...
        value: function render() {
            ...
            var indicatorMarkup = hasNewChild ? React.createElement(
                'span',
                { className: styles$69.Indicator },
                React.createElement(Indicator$1, { pulse: true })
            ) : null;
            var badgeMarkup = badge || isNew ? React.createElement(
                'div',
            ...
            var iconMarkup = iconBody ? React.createElement('span', { className: styles$69.Icon, dangerouslySetInnerHTML: { __html: iconBody } }) : icon && React.createElement(
                'div',
                { className: styles$69.Icon },
                React.createElement(Icon$2, { source: icon })
            );
            var itemContentMarkup = React.createElement(
                React.Fragment,
                null,
                iconMarkup,
                React.createElement(
            ...
            if (url == null) {
                var _className = styles.classNames(styles$69.Item, disabled && styles$69['Item-disabled']);
                return React.createElement(
                    'li',
            ...
            var secondaryActionMarkup = secondaryAction && React.createElement(
                UnstyledLink$2,
                ...
                React.createElement(Icon$2, { source: secondaryAction.icon })
            );
            ...
            var itemClassName = styles.classNames(styles$69.Item, disabled && styles$69['Item-disabled'], selected && subNavigationItems.length === 0 && styles$69['Item-selected'], showExpanded && styles$69.subNavigationActive);
            ...
            if (subNavigationItems.length > 0 && showExpanded) {
                ...
                secondaryNavigationMarkup = React.createElement(
                    'div',
                    ...
                    React.createElement(
                        ...
                        subNavigationItems.map(function (item) {
                            ...
                            return React.createElement(Item$15, Object.assign({}, rest, { key: label, label: label, matches: item === longestMatch, onClick: onNavigationDismiss }));
                        })
                    )
                );
            }
            var className = styles.classNames(styles$69.ListItem, secondaryAction && styles$69['ListItem-hasAction']);
            return React.createElement(
                'li',
                { className: className },
                React.createElement(
...
var Section$11 = function (_React$Component) {
    ...
    _createClass(Section, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$69.Section, separator && styles$69['Section-withSeparator'], fill && styles$69['Section-fill']);
            var actionMarkup = action && React.createElement(
                'button',
                { type: 'button', className: styles$69.Action, 'aria-label': action.accessibilityLabel, onClick: action.onClick },
                React.createElement(Icon$2, { source: action.icon })
            );
            var sectionHeadingMarkup = title && React.createElement(
                'li',
            ...
            var itemsMarkup = items.map(function (item) {
                ...
                return React.createElement(Item$15, Object.assign({}, rest, { key: label, label: label, onClick: _this2.handleClick(onClick) }));
            });
            var toggleClassName = styles.classNames(styles$69.Item, styles$69.RollupToggle);
            var ariaLabel = rollup && (expanded ? rollup.hide : rollup.view);
            var toggleRollup = rollup && items.length > rollup.after && React.createElement(
                'div',
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'span',
                        { className: styles$69.Icon },
                        React.createElement(Icon$2, { source: ellipsis })
                    ),
                    ariaLabel
                )
            );
            ...
            var activeItemsMarkup = rollup && additionalItems.length > 0 && React.createElement(
                'li',
...
tslib_1.__decorate([decorators.memoize()], Section$11.prototype, "handleClick", null);
tslib_1.__decorate([decorators.autobind], Section$11.prototype, "toggleViewAll", null);
...
function MessageIndicator$1(_ref) {
  ...
  var indicatorMarkup = active && React.createElement('div', { className: styles$71.MessageIndicator });
  return React.createElement(
    'div',
...
var UserMenu$1 = function (_React$PureComponent) {
    ...
    _createClass(UserMenu, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$72.UserMenu, userMenuExpanded && styles$72.expanded);
            ...
            var itemsMarkup = actions$$1 && actions$$1.map(function (section) {
                return React.createElement(
                    ...
                    section.items.map(function (item) {
                        var icon = item.icon;
                        return item.url ? React.createElement(
                            UnstyledLink$2,
                            ...
                            item.icon && React.createElement(
                                'span',
                                { className: styles$72.Icon },
                                React.createElement(Icon$2, { source: item.icon })
                            ),
                            item.content
                        );
                    })
            ...
            var messageMarkup = message && React.createElement(
                'div',
                { className: styles$72.Section },
                React.createElement(Message$1, { title: message.title, description: message.description, action: {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(Avatar$2, { size: 'small', source: avatarSource, initials: avatarInitials && avatarInitials.replace(' ', '') })
                        )
                    ),
                    React.createElement(
                        'span',
                    ...
                    React.createElement(
                        ...
                        React.createElement(Icon$2, { source: 'chevronDown', color: 'inkLightest', accessibilityLabel: 'Show user menu' })
                    )
                ),
                React.createElement(
                    'div',
...
tslib_1.__decorate([decorators.memoize()], UserMenu$1.prototype, "createActionHandler", null);
tslib_1.__decorate([decorators.autobind], UserMenu$1.prototype, "handleClick", null);
...
var TooltipOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderTooltip(overlayDetails) {
            ...
            var containerClassName = styles.classNames(styles$73.Tooltip, light && styles$73.light, measuring && styles$73.measuring, positioning === 'above' && styles$73.positionedAbove);
...
var getUniqueID$10 = other.createUniqueIDFactory('TooltipContent');
    ...
    _createClass(Tooltip, [{
        ...
        value: function render() {
            ...
            var portal = activatorNode ? React.createElement(
                ...
                React.createElement(
                    TooltipOverlay$1,
                    { id: id, preferredPosition: preferredPosition, activator: activatorNode, active: active, onClose: other.noop, light: light },
                    React.createElement(
                        'div',
...
function Pagination$1(_ref) {
    ...
    var className = reactUtilities.classNames(styles$74.Pagination, plain && styles$74.plain);
    var previousButton = previousURL ? React.createElement(
        ...
        React.createElement(Icon$2, { source: 'arrowLeft' })
    ) : React.createElement(
        'button',
    ...
    var nextButton = nextURL ? React.createElement(
        ...
        React.createElement(Icon$2, { source: 'arrowRight' })
    ) : React.createElement(
        'button',
    ...
    var previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map(function (key) {
        return React.createElement(KeypressListener$1, { key: key, keyCode: key, handler: previousURL ? handleCallback(clickPaginationLink('previousURL', node)) : handleCallback(onPrevious) });
    });
    var nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map(function (key) {
        return React.createElement(KeypressListener$1, { key: key, keyCode: key, handler: nextURL ? handleCallback(clickPaginationLink('nextURL', node)) : handleCallback(onNext) });
    });
    return React.createElement(
        'nav',
...
function Action(_ref) {
  ...
  var className = reactUtilities.classNames(styles$75.Action, disabled && styles$75.disabled, icon && children == null && styles$75.iconOnly);
  return React.createElement(
    'button',
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(ActionList$1, { items: actions$$1, onActionAnyItem: this.handleClose }),
                    detailsMarkup
                )
            );
        }
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            ...
            var paginationMarkup = pagination ? React.createElement(
                ...
                React.createElement(Pagination$2, Object.assign({}, pagination, { plain: true }))
            ) : null;
            var nonPrimaryActionsMarkup = this.renderSecondaryActions();
            var actionsMarkup = primaryAction || secondaryActions || actionGroups ? React.createElement(
                'div',
        ...
        value: function renderSecondaryActions() {
            ...
            var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref, index) {
                ...
                return React.createElement(
                    ...
                    React.createElement(ActionGroup, { title: title, icon: icon, actions: actions$$1, details: details, onOpen: _this2.handleActionGroupOpen, onClose: _this2.handleActionGroupClose, active: title === openActionGroup })
                );
            }) : null;
...
var Page = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$78.Page, fullWidth && styles$78.fullWidth, singleColumn && styles$78.singleColumn);
            var headerMarkup = this.props.polaris.appBridge || this.hasHeaderContent() === false ? null : React.createElement(Header$5, rest);
            return React.createElement(
                'div',
                { className: className },
                headerMarkup,
...
var getUniqueID$11 = other.createUniqueIDFactory('RangeSlider');
...
var RangeSlider$1 = function (_React$PureComponent) {
    ...
    _createClass(RangeSlider, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$80.RangeSlider, error && styles$80.error, disabled && styles$80.disabled);
            return React.createElement(
                Labelled$1,
    ...
    _createClass(Sticky, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                null,
                React.createElement('div', { ref: this.setPlaceHolderNode }),
                React.createElement(
                    'div',
...
var getUniqueID$13 = other.createUniqueIDFactory('Select');
function Select$1(_ref) {
    ...
    var className = styles.classNames(styles$81.Select, error && styles$81.error, disabled && styles$81.disabled);
    ...
    var contentMarkup = React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(Icon$2, { source: 'arrowUpDown' })
        )
    );
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            contentMarkup,
            React.createElement('div', { className: styles$81.Backdrop })
        )
    );
}
...
function CheckableButton$1(_ref) {
    ...
    var className = plain ? styles.classNames(styles$82.CheckableButton, styles$82['CheckableButton-plain']) : styles.classNames(styles$82.CheckableButton, selectMode && styles$82['CheckableButton-selectMode'], selected && styles$82['CheckableButton-selected'], measuring && styles$82['CheckableButton-measuring']);
    return React.createElement(
        'div',
        ...
        React.createElement(
            ...
            React.createElement(Checkbox$4, { label: accessibilityLabel, labelHidden: true, checked: selected, disabled: disabled })
        ),
        React.createElement(
            'span',
...
var BulkActionButton$1 = function (_React$PureComponent) {
    ...
    _createClass(BulkActionButton, [{
        ...
        value: function render() {
            ...
            var className = reactUtilities.classNames(styles$83.Button, disabled && styles$83.disabled);
            return React.createElement(
                'button',
...
var slideClasses = {
    appear: styles.classNames(styles$83.Slide, styles$83['Slide-appear']),
    appearActive: styles.classNames(styles$83.Slide, styles$83['Slide-appearing']),
    enter: styles.classNames(styles$83.Slide, styles$83['Slide-enter']),
    enterActive: styles.classNames(styles$83.Slide, styles$83['Slide-entering']),
    exit: styles.classNames(styles$83.Slide, styles$83['Slide-exit'])
};
var BulkActions$1 = function (_React$PureComponent) {
    ...
    _createClass(BulkActions, [{
        ...
        value: function render() {
            ...
            var cancelButtonClassName = styles.classNames(styles$83.Button, styles$83['Button-cancel']);
            ...
            var allActionsPopover = this.hasActions ? React.createElement(
                ...
                React.createElement(
                    Popover$1,
                    { active: smallScreenPopoverVisible, activator: React.createElement(BulkActionButton$1, { disclosure: true, onAction: this.toggleSmallScreenPopover, content: intl.translate('Polaris.ResourceList.BulkActions.actionsActivatorLabel') }), onClose: this.toggleSmallScreenPopover },
                    React.createElement(ActionList$1, { items: promotedActions, sections: this.actionSections, onActionAnyItem: this.toggleSmallScreenPopover })
                )
            ) : null;
            var promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [].concat(_toConsumableArray(promotedActions)).slice(0, numberOfPromotedActionsToRender).map(function (action, index) {
                return React.createElement(BulkActionButton$1, Object.assign({}, action, { key: index, handleMeasurement: _this2.handleMeasurement }));
            }) : null;
            ...
            var actionsPopover = this.actionSections || rolledInPromotedActions.length > 0 || measuring ? React.createElement(
                ...
                React.createElement(
                    Popover$1,
                    { active: largeScreenPopoverVisible, activator: React.createElement(BulkActionButton$1, { disclosure: true, onAction: this.toggleLargeScreenPopover, content: activatorLabel, disabled: disabled }), onClose: this.toggleLargeScreenPopover },
                    React.createElement(ActionList$1, { sections: combinedActions, onActionAnyItem: this.toggleLargeScreenPopover })
                )
            ) : null;
            ...
            var smallScreenGroup = React.createElement(
                ...
                function (status) {
                    var smallScreenGroupClassName = styles.classNames(styles$83.Group, styles$83['Group-smallScreen'], styles$83['Group-' + status]);
                    return React.createElement(
                        'div',
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(CheckableButton$2, checkableButtonProps)
                            ),
                            allActionsPopover,
                            cancelButton
                        ),
            ...
            var largeScreenGroup = React.createElement(
                ...
                function (status) {
                    var largeScreenGroupClassName = styles.classNames(styles$83.Group, styles$83['Group-largeScreen'], !measuring && styles$83['Group-' + status], measuring && styles$83['Group-measuring']);
                    return React.createElement(
                        'div',
                        { className: largeScreenGroupClassName },
                        React.createElement(EventListener$1, { event: 'resize', handler: _this2.handleResize }),
                        React.createElement(
                            'div',
...
function Tag$1(_ref) {
  ...
  var className = reactUtilities.classNames(disabled && styles$84.disabled, styles$84.Tag);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Icon$2, { source: 'cancelSmall' })
    )
  );
}
        ...
        value: function render() {
            ...
            var datePredicateMarkup = showDatePredicate && React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(TextField$5, { label: intl.translate('Polaris.ResourceList.DateSelector.dateValueLabel'), placeholder: intl.translate('Polaris.ResourceList.DateSelector.dateValuePlaceholder'), value: this.dateTextFieldValue, error: userInputDateError, prefix: React.createElement(Icon$2, { source: 'calendar', color: 'skyDark' }), autoComplete: false, onChange: this.handleDateFieldChange, onBlur: this.handleDateBlur })
                ),
                React.createElement(
                    'div',
                    { className: styles$85.DatePicker },
                    React.createElement(DatePicker$2, { selected: selectedDate, month: datePickerMonth, year: datePickerYear, onChange: this.handleDatePickerChange, onMonthChange: this.handleDatePickerMonthChange })
                )
            );
            return React.createElement(
                React.Fragment,
...
var FilterValueSelector$1 = function (_React$PureComponent) {
    ...
    _createClass(FilterValueSelector, [{
        ...
        value: function render() {
            ...
            var operatorOptionsMarkup = showOperatorOptions ? React.createElement(Select$1, { label: filter.label, labelHidden: true, options: buildOperatorOptions(operatorText), value: filterKey, onChange: this.handleOperatorOptionChange }) : null;
            ...
            switch (filter.type) {
                case exports.FilterType.Select:
                    return React.createElement(
                        ...
                        React.createElement(Select$1, { label: selectedFilterLabel, options: filter.options, placeholder: intl.translate('Polaris.ResourceList.FilterValueSelector.selectFilterValuePlaceholder'), value: value, onChange: onChange })
                    );
                case exports.FilterType.TextField:
                    return React.createElement(
                        ...
                        { vertical: true },
                        operatorOptionsMarkup,
                        React.createElement(TextField$5, { label: selectedFilterLabel, value: value, type: filter.textFieldType, onChange: onChange })
                    );
                case exports.FilterType.DateSelector:
                    return React.createElement(DateSelector$2, { dateOptionType: filter.dateOptionType, filterValue: value, filterKey: filterKey, filterMinKey: filter.minKey, filterMaxKey: filter.maxKey, onFilterValueChange: onChange, onFilterKeyChange: onFilterKeyChange });
                default:
                    return null;
            }
        }
...
var FilterCreator$1 = function (_React$PureComponent) {
    ...
    _createClass(FilterCreator, [{
        ...
        value: function render() {
            ...
            var filterValueSelectionMarkup = selectedFilter ? React.createElement(FilterValueSelector$2, { filter: selectedFilter, filterKey: selectedFilterKey, value: selectedFilterValue, onFilterKeyChange: this.handleFilterKeyChange, onChange: this.handleFilterValueChange }) : null;
...
var FilterControl$1 = function (_React$Component) {
    ...
    _createClass(FilterControl, [{
        ...
        value: function render() {
            ...
            var filterCreatorMarkup = filters.length > 0 ? React.createElement(FilterCreator$2, { resourceName: resourceName, filters: filters, onAddFilter: this.handleAddFilter, disabled: selectMode }) : null;
            ...
            return React.createElement(
                FormLayout$1,
                null,
                React.createElement(TextField$5, { connectedLeft: filterCreatorMarkup, connectedRight: additionalActionButton, label: textFieldLabel, labelHidden: true, placeholder: textFieldLabel, prefix: React.createElement(Icon$2, { source: 'search', color: 'skyDark' }), value: searchValue, onChange: onSearchChange, onBlur: onSearchBlur, focused: focused, disabled: selectMode }),
...
var Item$18 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            if (selectable) {
                ...
                handleMarkup = React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(Checkbox$4, { id: this.checkboxId, label: label, labelHidden: true, onChange: this.handleSelection, checked: selected, disabled: loading })
                    )
                );
            }
            if (media || selectable) {
            ...
            var className = styles.classNames(styles$87.Item, focused && styles$87.focused, selectable && styles$87.selectable, selected && styles$87.selected, selectMode && styles$87.selectMode, persistActions && styles$87.persistActions, focusedInner && styles$87.focusedInner);
            ...
            if (shortcutActions) {
                if (persistActions) {
                    ...
                    disclosureMarkup = React.createElement(
                        ...
                        React.createElement(
                            Popover$1,
                            { activator: React.createElement(Button$3, { 'aria-label': intl.translate('Polaris.ResourceList.Item.actionsDropdown'), onClick: this.handleActionsClick, plain: true, icon: 'horizontalDots' }), onClose: this.handleCloseRequest, active: actionsMenuVisible },
                            React.createElement(ActionList$1, { items: shortcutActions })
                        )
                    );
                } else {
                    actionsMarkup = React.createElement(
            ...
            var accessibleMarkup = url ? React.createElement(UnstyledLink$2, { 'aria-describedby': this.props.id, 'aria-label': accessibilityLabel, className: styles$87.Link, url: url, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur }) : React.createElement('button', { className: styles$87.Button, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, onClick: this.handleClick, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur });
            return React.createElement(
                'div',
...
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "setNode", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleAnchorFocus", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleFocusedBlur", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleBlur", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleMouseDown", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleLargerSelectionArea", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleSelection", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleClick", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleKeypress", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleActionsClick", null);
tslib_1.__decorate([decorators.autobind], Item$18.prototype, "handleCloseRequest", null);
...
var getUniqueID$12 = other.createUniqueIDFactory('Select');
    ...
    _createClass(ResourceList, [{
        ...
        value: function render() {
            ...
            var sortingSelectMarkup = sortOptions && sortOptions.length > 0 ? React.createElement(
                ...
                sortingLabelMarkup,
                React.createElement(Select$1, { label: intl.translate('Polaris.ResourceList.sortingLabel'), labelHidden: true, options: sortOptions, onChange: onSortChange, value: sortValue, disabled: selectMode })
            ) : null;
            ...
            var checkableButtonMarkup = this.selectable ? React.createElement(
                ...
                React.createElement(CheckableButton$2, { accessibilityLabel: this.bulkActionsAccessibilityLabel, label: this.headerTitle, onToggleAll: this.handleToggleAll, plain: true, disabled: loading })
            ) : null;
            var needsHeader = this.selectable || sortOptions && sortOptions.length > 0;
            var headerWrapperOverlay = loading ? React.createElement('div', { className: styles$88['HeaderWrapper-overlay'] }) : null;
            var headerMarkup = (showHeader || needsHeader) && listNode && React.createElement(
                'div',
                ...
                React.createElement(
                    ...
                    function (isSticky) {
                        var headerClassName = styles.classNames(styles$88.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$88['HeaderWrapper-hasSort'], _this3.selectable && styles$88['HeaderWrapper-hasSelect'], loading && styles$88['HeaderWrapper-disabled'], _this3.selectable && selectMode && styles$88['HeaderWrapper-inSelectMode'], isSticky && styles$88['HeaderWrapper-isSticky']);
                        return React.createElement(
                            'div',
            ...
            var emptyStateMarkup = filterControl && !itemsExist && !loading ? React.createElement(
                ...
                React.createElement(EmptySearchResult$2, Object.assign({}, this.emptySearchResultText, { withIllustration: true }))
            ) : null;
            ...
            var loadingOverlay = loading ? React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Spinner$2, { size: spinnerSize, accessibilityLabel: 'Items are loading' })
                ),
                React.createElement('div', { className: styles$88.LoadingOverlay })
            ) : null;
            var className = styles.classNames(styles$88.ItemWrapper, loading && styles$88['ItemWrapper-isLoading']);
            var loadingWithoutItemsMarkup = loading && !itemsExist ? React.createElement(
                'div',
                { className: className, tabIndex: -1 },
                loadingOverlay
            ) : null;
            var resourceListClassName = styles.classNames(styles$88.ResourceList, loading && styles$88.disabledPointerEvents);
...
tslib_1.__decorate([decorators.autobind], Item$21.prototype, "setFocusedNode", null);
...
var Tab$1 = function (_React$PureComponent) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$89.Tab, selected && styles$89['Tab-selected']);
            var tabIndex = void 0;
...
var TabMeasurer$1 = function (_React$PureComponent) {
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var classname = styles.classNames(styles$89.Tabs, styles$89.TabMeasurer);
            return React.createElement(
                'div',
...
var Tabs$1 = function (_React$PureComponent) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var classname = styles.classNames(styles$89.Tabs, fitted && styles$89.fitted, disclosureActivatorVisible && styles$89.fillSpace);
            var disclosureTabClassName = styles.classNames(styles$89.DisclosureTab, disclosureActivatorVisible && styles$89['DisclosureTab-visible']);
            var activator = React.createElement(
                'button',
                { tabIndex: -1, className: styles$89.DisclosureActivator, onClick: this.handleDisclosureActivatorClick },
                React.createElement(Icon$2, { source: 'horizontalDots' })
            );
            return React.createElement(
                'div',
                null,
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(List$3, { focusIndex: hiddenTabs.indexOf(tabToFocus), disclosureTabs: disclosureTabs, onClick: this.handleTabClick, onKeyPress: this.handleKeyPress })
                        )
                    )
                ),
                React.createElement(TabMeasurer$1, { tabToFocus: tabToFocus, activator: activator, selected: selected, tabs: tabs, siblingTabHasFocus: tabToFocus > -1, handleMeasurement: this.handleMeasurement }),
                panelMarkup
            );
        }
    }, {
...
function Thumbnail$1(_ref) {
    ...
    var className = styles.classNames(styles$90.Thumbnail, size && styles$90[styles.variationName('size', size)]);
    return React.createElement(
        'span',
        { className: className },
        React.createElement(Image$1, { alt: alt, source: source, className: styles$90.Image })
    );
}
...
var Search$1 = function (_React$PureComponent) {
    ...
    _createClass(Search, [{
        ...
        value: function render() {
            ...
            var searchClassName = styles.classNames(styles$91.Search, visible && styles$91.visible);
            return React.createElement(
                'div',
...
tslib_1.__decorate([decorators.autobind], Search$1.prototype, "handleDismiss", null);
...
var SearchField$1 = function (_React$Component) {
    ...
    _createClass(SearchField, [{
        ...
        value: function render() {
            ...
            var clearMarkup = value !== '' && React.createElement(
                'button',
                { type: 'button', 'aria-label': 'Clear', className: styles$92.Clear, onClick: this.handleClear },
                React.createElement(Icon$2, { source: 'circleCancel' })
            );
            var className = styles.classNames(styles$92.SearchField, (focused || active) && styles$92.focused);
            return React.createElement(
                'div',
                { className: className, onFocus: this.handleFocus, onBlur: this.handleBlur },
                React.createElement('input', { className: styles$92.Input, placeholder: placeholder, type: 'search', autoCapitalize: 'off', autoComplete: 'off', autoCorrect: 'off', ref: this.input, value: value, onChange: this.handleChange, onKeyDown: preventDefault }),
                React.createElement(
                    'span',
                    { className: styles$92.Icon },
                    React.createElement(Icon$2, { source: 'search' })
                ),
                clearMarkup,
                React.createElement('div', { className: styles$92.Backdrop })
            );
        }
    }, {
        key: 'handleFocus',
...
tslib_1.__decorate([decorators.autobind], SearchField$1.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], SearchField$1.prototype, "handleBlur", null);
tslib_1.__decorate([decorators.autobind], SearchField$1.prototype, "handleClear", null);
tslib_1.__decorate([decorators.autobind], SearchField$1.prototype, "handleChange", null);
...
function Menu$1(props) {
    ...
    var messageMarkup = message && React.createElement(Message$3, { title: message.title, description: message.description, action: {
            onClick: message.action.onClick,
            content: message.action.content
        }, link: { to: message.link.to, content: message.link.content }, badge: badgeProps });
...
function UserMenu$4(_ref) {
  ...
  var showIndicator = Boolean(message);
  var activatorContentMarkup = React.createElement(
    'div',
    { className: styles$95.UserMenu },
    React.createElement(
      MessageIndicator$1,
      { active: showIndicator },
      React.createElement(Avatar$2, { size: 'small', source: avatar, initials: initials && initials.replace(' ', '') })
    ),
    React.createElement(
      'span',
  ...
  return React.createElement(Menu$1, { activatorContent: activatorContentMarkup, open: open, onOpen: onToggle, onClose: onToggle, actions: actions$$1, message: message });
}
...
var TopBar$1 = function (_React$PureComponent) {
    ...
    _createClass(TopBar, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$96.NavigationIcon, focused && styles$96.focused);
            var navigationButtonMarkup = showNavigationToggle ? React.createElement(
                'button',
                ...
                React.createElement(Icon$2, { source: menu, color: 'white' })
            ) : null;
            var width = getWidth(logo, 104);
            var logoMarkup = logo ? React.createElement(
                UnstyledLink$2,
                { url: logo.url || '', className: styles$96.LogoLink, style: { width: width } },
                React.createElement(Image$1, { source: logo.topBarSource || '', alt: logo.accessibilityLabel || '', className: styles$96.Logo, style: { width: width } })
            ) : null;
            var searchResultsMarkup = searchResults && searchResultsVisible ? React.createElement(
                Search$1,
                { visible: searchResultsVisible, onDismiss: onSearchResultsDismiss },
                searchResults
            ) : null;
            var searchMarkup = searchField ? React.createElement(
                React.Fragment,
                null,
                searchField,
                searchResultsMarkup
...
tslib_1.__decorate([decorators.autobind], TopBar$1.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], TopBar$1.prototype, "handleBlur", null);
...
function SkeletonDisplayText$1(_ref) {
    ...
    var className = styles.classNames(styles$97.DisplayText, size && styles$97[styles.variationName('size', size)]);
...
function SkeletonBodyText$1(_ref) {
    ...
    for (var i = 0; i < lines; i++) {
        bodyTextLines.push(React.createElement('div', { className: styles$98.SkeletonBodyText, key: i }));
    }
    return React.createElement(
        'div',
...
var SkeletonPage = function (_React$PureComponent) {
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$99.Page, fullWidth && styles$99.fullWidth, singleColumn && styles$99.singleColumn);
      var headerClassName = styles.classNames(styles$99.Header, breadcrumbs && styles$99['Header-hasBreadcrumbs'], secondaryActions && styles$99['Header-hasSecondaryActions']);
      var titleMarkup = title !== null ? renderTitle(title) : null;
      var primaryActionMarkup = primaryAction ? React.createElement(
        'div',
        { className: styles$99.PrimaryAction },
        React.createElement(SkeletonDisplayText$1, { size: 'large' })
      ) : null;
      ...
      var headerMarkup = !this.props.polaris.appBridge ? React.createElement(
        'div',
        { className: headerClassName },
        breadcrumbMarkup,
        React.createElement(
...
function renderSecondaryActions(actionCount) {
  ...
  for (var i = 0; i < actionCount; i++) {
    ...
    actions$$1.push(React.createElement(
      'div',
...
function ProgressBar$1(_ref) {
    ...
    var className = styles.classNames(styles$100.ProgressBar, size && styles$100[styles.variationName('size', size)]);
    ...
    return React.createElement(
        'div',
        { className: className },
        React.createElement('progress', { className: styles$100.Progress, value: parsedProgress, max: '100' }),
        React.createElement(
            'div',
...
exports.Autocomplete = Autocomplete$2;
exports.Avatar = Avatar$2;
exports.Badge = Badge$2;
...
exports.ButtonGroup = ButtonGroup$2;
exports.CalloutCard = CalloutCard$1;
exports.Caption = Caption$1;
exports.Card = Card$1;
exports.Checkbox = Checkbox$4;
exports.ChoiceList = ChoiceList$2;
exports.Collapsible = Collapsible$2;
...
exports.Loading = Loading$6;
exports.Modal = Modal$3;
exports.OptionList = OptionList$2;
exports.Navigation = Navigation$4;
...
exports.RangeSlider = RangeSlider$2;
exports.ResourceList = ResourceList$2;
exports.ResourcePicker = ResourcePicker$3;
exports.Scrollable = Scrollable$2;
