...
import { Children, Component, Fragment, PureComponent, createContext, createElement, createRef, forwardRef, isValidElement } from 'react';
...
import { classNames as classNames$1, elementChildren, isElementOfType, variationName as variationName$1, wrapWithComponent } from '@shopify/react-utilities';
...
import { Button, ButtonGroup, Flash, Loading, Modal, Redirect, ResourcePicker, TitleBar } from '@shopify/app-bridge/actions';
...
function compose$1() {
    ...
    return fns.reduce(function (func$$1, group) {
        return function () {
            return func$$1(group.apply(undefined, arguments));
        };
    });
}
...
function rgbToHsbl(color) {
    ...
    var r = color.red,
        ...
        alpha = _color$alpha3 === undefined ? 1 : _color$alpha3;
...
function hslToString(hslColor) {
    ...
    var _hslColor$alpha = hslColor.alpha,
        alpha = _hslColor$alpha === undefined ? 1 : _hslColor$alpha,
        hue = hslColor.hue,
...
function constructColorName(baseName, property, suffix) {
    ...
    var propertyName = property ? '-' + normalizeName(property) : '';
    var constructedSuffix = suffix ? '-' + suffix : '';
...
function createThemeContext(theme) {
    ...
    var _theme$logo = theme.logo,
        logo = _theme$logo === undefined ? null : _theme$logo,
        _theme$subscribe = theme.subscribe,
        subscribe = _theme$subscribe === undefined ? noop : _theme$subscribe,
        _theme$unsubscribe = theme.unsubscribe,
        unsubscribe = _theme$unsubscribe === undefined ? noop : _theme$unsubscribe;

    return { polarisTheme: { logo: logo, subscribe: subscribe, unsubscribe: unsubscribe } };
}

var THEME_CONTEXT_TYPES = { polarisTheme: any };
...
var ThemeProvider$1 = function (_React$Component) {
...
ThemeProvider$1.childContextTypes = THEME_CONTEXT_TYPES;
__decorate([autobind], ThemeProvider$1.prototype, "subscribe", null);
__decorate([autobind], ThemeProvider$1.prototype, "unsubscribe", null);
function setThemeContext(ctx, subscribe, unsubscribe) {
    var colors = ctx.colors,
        _ctx$logo = ctx.logo,
        logo = _ctx$logo === undefined ? null : _ctx$logo,
        rest = __rest(ctx, ["colors", "logo"]);

    return { polarisTheme: Object.assign({ logo: logo, subscribe: subscribe, unsubscribe: unsubscribe }, rest) };
}

var polarisAppProviderContextTypes = Object.assign({ polaris: any }, THEME_CONTEXT_TYPES);
...
var StickyManager = function () {
    ...
    _createClass(StickyManager, [{
        ...
        value: function setTopBarOffset() {
            var topbarElement = this.container.querySelector(':not(' + scrollable.selector + ') ' + dataPolarisTopBar.selector);
...
function withSticky() {
    return function addStickyManager(WrappedComponent) {
        ...
        var WithStickyManager = function (_React$Component) {
            ...
            function WithStickyManager(props, context) {
                ...
                var _this = _possibleConstructorReturn(this, (WithStickyManager.__proto__ || Object.getPrototypeOf(WithStickyManager)).call(this, props));

                _this.stickyManager = new StickyManager();
                var polaris = context.polaris;

                _this.polarisContext = Object.assign({}, polaris, { stickyManager: _this.stickyManager });
                return _this;
            }
            ...
            _createClass(WithStickyManager, [{
                ...
                key: 'render',
                value: function render() {
                    return createElement(WrappedComponent, Object.assign({}, this.props, { polaris: this.polarisContext }));
                }
            }]);
...
function createAppProviderContext() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        subscribe = _ref$subscribe === undefined ? noop : _ref$subscribe,
        _ref$unsubscribe = _ref.unsubscribe,
        unsubscribe = _ref$unsubscribe === undefined ? noop : _ref$unsubscribe;
...
function createPolarisContext(contextOne, contextTwo) {
    var appProviderContext = void 0;
    var themeContext = void 0;
            ...
            _createClass(WithProvider, [{
                ...
                value: function componentDidMount() {
                    var _context = this.context,
                        subscribeToPolaris = _context.polaris.subscribe,
                        subscribeToTheme = _context.polarisTheme.subscribe;
                ...
                value: function componentWillUnmount() {
                    var _context2 = this.context,
                        unsubscribeToPolaris = _context2.polaris.unsubscribe,
                        unsubscribeToTheme = _context2.polarisTheme.unsubscribe;
                ...
                value: function render() {
                    var _context3 = this.context,
                        polaris = _context3.polaris,
                        polarisTheme = _context3.polarisTheme;

                    var polarisContext = Object.assign({}, polaris, { theme: polarisTheme });
                    if (!polaris) {
                    ...
                    return createElement(WrappedComponent, Object.assign({}, this.props, { polaris: polarisContext }));
                }
            }, {
...
var AppProvider = function (_React$Component) {
    ...
    function AppProvider(props) {
        ...
        _this.polarisContext = createAppProviderContext(Object.assign({}, rest, { stickyManager: _this.stickyManager, scrollLockManager: _this.scrollLockManager, subscribe: _this.subscribe, unsubscribe: _this.unsubscribe }));
        return _this;
    }
    ...
    _createClass(AppProvider, [{
        ...
        value: function render() {
            var _props$theme = this.props.theme,
                theme = _props$theme === undefined ? { logo: null } : _props$theme;
...
function Image$1(_a) {
    ...
    createElement("img", Object.assign({ src: source, srcSet: finalSourceSet, crossOrigin: crossOrigin }, rest)) :
    // eslint-disable-next-line jsx-a11y/alt-text
    createElement("img", Object.assign({ src: source }, rest, { crossOrigin: crossOrigin }));
}
...
var AVATAR_IMAGES = Object.keys(avatars).map(
// import/namespace does not allow computed values by default
// eslint-disable-next-line import/namespace
function (key) {
    return avatars[key];
});
var Avatar$1 = function (_React$PureComponent) {
    ...
    _createClass(Avatar, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$1.Avatar, styles$1[variationName('style', styleClass(nameString))], size && styles$1[variationName('size', size)], hasImage && !hasLoaded && styles$1.hidden, hasImage && styles$1.hasImage);
            var imageMarkUp = finalSource && !isServer && !hasError ? createElement(Image$1, { className: styles$1.Image, source: finalSource, alt: '', role: 'presentation', onLoad: this.handleLoad, onError: this.handleError }) : null;
            // Use `dominant-baseline: central` instead of `dy` when Edge supports it.
            var verticalOffset = '0.35em';
            var initialsMarkup = initials && !hasImage ? createElement(
                'span',
...
__decorate([autobind], Avatar$1.prototype, "handleError", null);
__decorate([autobind], Avatar$1.prototype, "handleLoad", null);
...
var Avatar$2 = withAppProvider()(Avatar$1);
            ...
            _createClass(WithRef, [{
                ...
                value: function render() {
                    ...
                    return createElement(
                        ...
                        null,
                        function (ctx) {
                            return createElement(WrappedComponent, Object.assign({}, _this2.props, { ref: ctx.forwardedRef }));
                        }
                    );
                }
            }]);
...
var UnstyledLink$1 = function (_React$PureComponent) {
    ...
    _createClass(UnstyledLink, [{
        ...
        value: function render() {
            ...
            return createElement('a', Object.assign({ target: target$$1 }, rest, { href: url, rel: rel }, unstyled.props));
        }
    }]);

    return UnstyledLink;
}(PureComponent);
var UnstyledLink$2 = compose$2(withAppProvider(), withRef$1())(UnstyledLink$1);
...
function Icon$1(_ref) {
    ...
    var className = classNames(styles$2.Icon, color && styles$2[variationName('color', color)], color && color !== 'white' && styles$2.isColored, backdrop && styles$2.hasBackdrop);
    ...
    if (source === 'placeholder') {
        ...
        contentMarkup = iconSource && iconSource.viewBox && iconSource.body && createElement('svg', { className: styles$2.Svg, viewBox: iconSource.viewBox, dangerouslySetInnerHTML: { __html: iconSource.body }, focusable: 'false', 'aria-hidden': 'true' });
    }
    return createElement(
        'span',
...
function Indicator$1(_ref) {
    ...
    var className = classNames(styles$4.Indicator, pulse && styles$4.pulseIndicator);
...
function Button$2(_ref) {
  ...
  var className = classNames$1(styles$5.Button, primary && styles$5.primary, outline && styles$5.outline, destructive && styles$5.destructive, isDisabled && styles$5.disabled, loading && styles$5.loading, plain && styles$5.plain, size && size !== DEFAULT_SIZE && styles$5[variationName$1('size', size)], fullWidth && styles$5.fullWidth, icon && children == null && styles$5.iconOnly);
  var disclosureIconMarkup = disclosure ? createElement(
    IconWrapper,
    null,
    createElement(Icon$2, { source: loading ? 'placeholder' : 'caretDown' })
  ) : null;
  var iconMarkup = void 0;
  if (icon) {
    var iconInner = isIconSource(icon) ? createElement(Icon$2, { source: loading ? 'placeholder' : icon }) : icon;
    iconMarkup = createElement(
      IconWrapper,
      null,
      iconInner
    );
  ...
  var spinnerSVGMarkup = loading ? createElement(
    ...
    createElement(Spinner$2, { size: 'small', color: spinnerColor, accessibilityLabel: intl.translate('Polaris.Button.spinnerAccessibilityLabel') })
  ) : null;
  var indicatorMarkup = indicator && createElement(Indicator$1, null);
  ...
  return url ? createElement(
    UnstyledLink$2,
    { id: id, url: url, external: external, onClick: onClick, onFocus: onFocus, onBlur: onBlur, onMouseUp: handleMouseUpByBlurring, className: className, disabled: isDisabled, 'aria-label': accessibilityLabel },
    indicatorMarkup,
    content
  ) : createElement(
    'button',
    { id: id, type: type, onClick: onClick, onFocus: onFocus, onBlur: onBlur, onMouseUp: handleMouseUpByBlurring, className: className, disabled: isDisabled, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, role: loading ? 'alert' : undefined, 'aria-busy': loading ? true : undefined },
    indicatorMarkup,
    content
  );
}
...
var Button$3 = withAppProvider()(Button$2);
...
var Item$1 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$6.Item, focused && styles$6['Item-focused'], button.props.plain && styles$6['Item-plain']);
            return createElement(
                'div',
...
__decorate([autobind], Item$1.prototype, "handleFocus", null);
__decorate([autobind], Item$1.prototype, "handleBlur", null);

function ButtonGroup$2(_ref) {
    var children = _ref.children,
        segmented = _ref.segmented,
        fullWidth = _ref.fullWidth,
        connectedTop = _ref.connectedTop;

    var className = classNames(styles$6.ButtonGroup, segmented && styles$6.segmented, fullWidth && styles$6.fullWidth, connectedTop && styles$6.connectedTop);
    var contents = elementChildren(children).map(function (child, index) {
        return createElement(Item$1, { button: child, key: index });
    });
    return createElement(
        'div',
        { className: className },
...
function Item$4(_ref) {
    ...
    var className = classNames(styles$7.Item, fill && styles$7['Item-fill']);
    return createElement(
        'div',
        { className: className },
        children
...
var Stack$1 = function (_React$PureComponent) {
    ...
    _createClass(Stack, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$7.Stack, vertical && styles$7.vertical, spacing && styles$7[variationName('spacing', spacing)], distribution && styles$7[variationName('distribution', distribution)], alignment && styles$7[variationName('alignment', alignment)], wrap === false && styles$7.noWrap);
...
function Header$1(_ref) {
    ...
    var actionMarkup = actions$$1 ? createElement(
        ButtonGroup$2,
        null,
        buttonsFrom(actions$$1, { plain: true })
    ) : null;
    var titleMarkup = isValidElement(title) ? title : createElement(
        Heading$1,
        null,
        title
    );
    var headingMarkup = actionMarkup || children ? createElement(
        Stack$1,
        { alignment: 'baseline' },
        createElement(
            Stack$1.Item,
...
function Subheading$1(_ref) {
    ...
    return createElement(
        Element,
        { 'aria-label': ariaLabel, className: styles$10.Subheading },
        children
    );
}
...
function Section$1(_ref) {
  ...
  var headerContent = title ? createElement(
    'div',
    { className: styles$9.SectionHeader },
    createElement(
      Subheading$1,
      null,
      title
  ...
  var className = classNames(styles$9.Section, subdued && styles$9['Section-subdued'], fullWidth && styles$9['Section-fullWidth']);
  return createElement(
    'div',
    { className: className },
    headerContent,
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                actions$$1 = _props.actions,
                primaryFooterAction = _props.primaryFooterAction,
                secondaryFooterAction = _props.secondaryFooterAction;

            var className = classNames(styles$9.Card, subdued && styles$9.subdued);
            var headerMarkup = title ? createElement(Header$1, { actions: actions$$1, title: title }) : null;
...
function TextStyle$1(_ref) {
    ...
    var className = classNames(variation && styles$11[variationName('variation', variation)], variation === VariationValue.Code && styles$11.code);
...
function SettingAction$1(_ref) {
  ...
  return createElement(
    'div',
    { className: styles$12.SettingAction },
    createElement(
      'div',
      { className: styles$12.Setting },
      children
    ),
    createElement(
      'div',
      { className: styles$12.Action },
      action
    )
  );
}
...
function AccountConnection$1(_ref) {
    ...
    var avatarMarkup = connected ? createElement(Avatar$2, { accessibilityLabel: '', name: accountName, initials: initials, source: avatarUrl }) : null;
    ...
    var termsOfServiceMarkup = termsOfService ? createElement(
        'div',
        { className: styles$13.TermsOfService },
        termsOfService
    ) : null;
...
var ScrollTo$1 = function (_React$Component) {
    ...
    _createClass(ScrollTo, [{
        ...
        key: 'render',
        value: function render() {
            var getUniqueId = createUniqueIDFactory('ScrollTo');
            // eslint-disable-next-line jsx-a11y/anchor-is-valid
            return createElement('a', { id: getUniqueId(), ref: this.ref });
        }
    }]);
...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = classNames(className, styles$14.Scrollable, vertical && styles$14.vertical, horizontal && styles$14.horizontal, topShadow && styles$14.hasTopShadow, bottomShadow && styles$14.hasBottomShadow);
            return createElement(
                'div',
        ...
        value: function handleScroll() {
            ...
            var _props = this.props,
                ...
                onScrolledToBottom = _props.onScrolledToBottom;
...
__decorate([autobind], Scrollable$1.prototype, "scrollToPosition", null);
...
function VisuallyHidden$1(_ref) {
    ...
    return createElement(
        'span',
        { className: styles$15.VisuallyHidden },
        children
    );
}
...
function Badge$1(_ref) {
    var children = _ref.children,
        ...
        _ref$size = _ref.size,
        size = _ref$size === undefined ? DEFAULT_SIZE$1 : _ref$size,
        intl = _ref.polaris.intl;

    var className = classNames(styles$16.Badge, status && styles$16[variationName('status', status)], progress && styles$16[variationName('progress', progress)], size && size !== DEFAULT_SIZE$1 && styles$16[variationName('size', size)]);
...
function Item$6(_ref) {
  ...
  var className = classNames$1(styles$17.Item, disabled && styles$17.disabled, destructive && styles$17.destructive, active && styles$17.active);
  var imageElement = null;
  if (icon) {
    imageElement = createElement(
      'div',
      { className: styles$17.Image },
      createElement(Icon$2, { source: icon })
    );
  } else if (image) {
    imageElement = createElement('div', { role: 'presentation', className: styles$17.Image, style: { backgroundImage: 'url(' + image } });
  }
  var contentMarkup = ellipsis && content ? content + '\u2026' : content;
  var badgeMarkup = badge && createElement(
    'span',
    { className: styles$17.BadgeWrapper },
    createElement(
      Badge$2,
      { status: badge.status },
      badge.content
  ...
  var textMarkup = imageElement ? createElement(
    'div',
    { className: styles$17.Text },
    contentMarkup
  ) : contentMarkup;
  var contentElement = createElement(
    'div',
  ...
  var scrollMarkup = active ? createElement(Scrollable$2.ScrollTo, null) : null;
  var control = url ? createElement(
    UnstyledLink$2,
    { id: id, url: url, onClick: onAction, className: className, external: external },
    contentElement
  ) : createElement(
    'button',
    { id: id, onClick: onAction, className: className, disabled: disabled, type: 'button' },
    contentElement
  );
  return createElement(
    'li',
...
function Section$3(_ref) {
    ...
    var actionMarkup = section.items.map(function (_a, index) {
        ...
        return createElement(Item$6, Object.assign({ key: content + '-' + index, content: content, role: actionRole, onAction: handleAction(onAction) }, item));
    });
    var className = section.title ? null : styles$17['Section-withoutTitle'];
    ...
    var sectionMarkup = createElement(
        ...
        createElement(
            'ul',
            { className: styles$17.Actions, role: sectionRole },
            actionMarkup
        )
    );
    return hasMultipleSections ? createElement(
        'li',
        { className: styles$17.Section },
        sectionMarkup
    ) : sectionMarkup;
}
...
function ActionList$1(_ref) {
    ...
    var sectionMarkup = finalSections.map(function (section, index) {
        return createElement(Section$3, { key: section.title || index, section: section, onActionAnyItem: onActionAnyItem, hasMultipleSections: hasMultipleSections, actionRole: actionRole });
    });
    return createElement(
        Element,
        { className: styles$17.ActionList },
        sectionMarkup
    );
}
...
function Checkbox$1(_ref) {
  ...
  var className = classNames(styles$18.Checkbox, active && styles$18.active);
  return createElement(
    'div',
    { className: className },
    createElement('input', { id: id, name: name, value: value, type: 'checkbox', checked: checked, disabled: disabled, className: styles$18.Input, 'aria-checked': checked, onChange: onChange, role: role }),
    createElement('div', { className: styles$18.Backdrop }),
    createElement(
      'div',
      { className: styles$18.Icon },
      createElement(Icon$2, { source: 'checkmark' })
    )
  );
}
...
var Option$1 = function (_React$Component) {
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            ...
            var mediaMarkup = media ? createElement(
                'div',
                { className: styles$19.Media },
                media
            ) : null;
            var singleSelectClassName = classNames(styles$19.SingleSelectOption, focused && styles$19.focused, disabled && styles$19.disabled, select && styles$19.select, active && styles$19.active);
            var multiSelectClassName = classNames(styles$19.Label, active && styles$19.active);
            var checkBoxRole = role === 'option' ? 'presentation' : undefined;
            var optionMarkup = allowMultiple ? createElement(
                'label',
                { htmlFor: id, className: multiSelectClassName },
                createElement(
                    'div',
                    { className: styles$19.Checkbox },
                    createElement(Checkbox$1, { id: id, value: value, checked: select, active: active, disabled: disabled, onChange: this.handleClick, role: checkBoxRole })
                ),
                mediaMarkup,
                label
            ) : createElement(
                'button',
                { id: id, type: 'button', className: singleSelectClassName, onClick: this.handleClick, disabled: disabled, onFocus: this.toggleFocus, onBlur: this.toggleFocus },
                mediaMarkup,
                label
            );
            var scrollMarkup = active ? createElement(Scrollable$2.ScrollTo, null) : null;
            return createElement(
                'li',
                { key: id, className: styles$19.Option, tabIndex: -1, 'aria-selected': active, role: role },
                scrollMarkup,
                optionMarkup
            );
        }
...
__decorate([autobind], Option$1.prototype, "handleClick", null);
__decorate([autobind], Option$1.prototype, "toggleFocus", null);
...
var getUniqueId$1 = createUniqueIDFactory('OptionList');
var OptionList$1 = function (_React$Component) {
    ...
    function OptionList() {
        ...
        _this.id = _this.props.id || getUniqueId$1();
        return _this;
    }
    // eslint-disable-next-line react/no-deprecated
        ...
        value: function render() {
            ...
            var optionsMarkup = optionsExist ? normalizedOptions.map(function (_ref2, sectionIndex) {
                ...
                var titleMarkup = title ? createElement(
                    'p',
                    { className: styles$20.Title, role: role },
                    title
                ) : null;
                var optionsMarkup = options && options.map(function (option, optionIndex) {
                    ...
                    return createElement(Option$1, Object.assign({}, option, { key: id, id: id, section: sectionIndex, index: optionIndex, onClick: _this2.handleClick, select: isSelected, allowMultiple: allowMultiple, role: optionRole }));
                });
                return createElement(
                    'li',
                    ...
                    createElement(
                        'ul',
                        { className: styles$20.Options, id: _this2.id, role: role, 'aria-multiselectable': allowMultiple },
                        optionsMarkup
                    )
                );
            }) : null;
            return createElement(
                'ul',
                { className: styles$20.OptionList, role: role },
                optionsMarkup
            );
        }
    }, {
...
__decorate([autobind], OptionList$1.prototype, "handleClick", null);
...
var OptionList$2 = withAppProvider()(OptionList$1);

var getUniqueID$2 = createUniqueIDFactory('portal-');
...
var Portal$1 = function (_React$PureComponent) {
    ...
    function Portal() {
        ...
        _this.portalId = _this.props.idPrefix !== '' ? _this.props.idPrefix + '-' + getUniqueID$2() : getUniqueID$2();
        return _this;
    }
    ...
    _createClass(Portal, [{
        ...
        value: function componentDidUpdate(_, prevState) {
            var _props$onPortalCreate = this.props.onPortalCreated,
                onPortalCreated = _props$onPortalCreate === undefined ? noop : _props$onPortalCreate;
...
function Pane$1(_ref) {
    ...
    var className = classNames(styles$21.Pane, fixed && styles$21['Pane-fixed']);
    var content = sectioned ? wrapWithComponent(children, Section$5) : children;
...
var PositionedOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PositionedOverlay, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$22.PositionedOverlay, fixed && styles$22.fixed);
            return createElement(
                'div',
                { className: className, style: style, ref: this.setOverlay },
...
var PopoverOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function render() {
            ...
            return createElement(
                Transition,
                { 'in': active, timeout: Duration.Fast, mountOnEnter: true, unmountOnExit: true },
                this.renderOverlay
            );
        }
    }, {
        ...
        value: function renderOverlay(transitionStatus) {
            ...
            return createElement(PositionedOverlay$1, { fullWidth: fullWidth, active: active, activator: activator, preferredPosition: preferredPosition, preferredAlignment: preferredAlignment
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = classNames(styles$21.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$21.positionedAbove, fullWidth && styles$21.fullWidth, measuring && styles$21.measuring);
            this.transitionStatus = transitionStatus;
            var contentStyles = measuring ? undefined : { height: desiredHeight };
            var contentClassNames = classNames(styles$21.Content, fullHeight && styles$21['Content-fullHeight']);
            var content = createElement(
                'div',
                { id: id, tabIndex: -1, className: contentClassNames, style: contentStyles, ref: this.contentNode },
            ...
            return createElement(
                ...
                createElement(KeypressListener$1, { keyCode: Key.Escape, handler: this.handleEscape }),
                createElement('div', { className: styles$21.FocusTracker
                    // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
                    , tabIndex: 0, onFocus: this.handleFocusFirstItem }),
                createElement(
                    'div',
                    { className: styles$21.Wrapper },
                    content
                ),
                createElement('div', { className: styles$21.FocusTracker
                    // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
        ...
        value: function handleClick(event) {
            ...
            var isDescendant = contentNode.current != null && nodeContainsDescendant(contentNode.current, target$$1);
            var isActivatorDescendant = nodeContainsDescendant(activator, target$$1);
...
__decorate([autobind], PopoverOverlay$1.prototype, "renderOverlay", null);
__decorate([autobind], PopoverOverlay$1.prototype, "renderPopover", null);
__decorate([autobind], PopoverOverlay$1.prototype, "handleClick", null);
__decorate([autobind], PopoverOverlay$1.prototype, "handleScrollOut", null);
__decorate([autobind], PopoverOverlay$1.prototype, "handleEscape", null);
__decorate([autobind], PopoverOverlay$1.prototype, "handleFocusFirstItem", null);
__decorate([autobind], PopoverOverlay$1.prototype, "handleFocusLastItem", null);
    ...
    _createClass(Popover, [{
        ...
        value: function render() {
            var _a = this.props,
                ...
                active = _a.active,
                fixed = _a.fixed,
                rest = __rest(_a, ["activatorWrapper", "children", "onClose", "activator", "activatorWrapper", "active", "fixed"]);var activatorNode = this.state.activatorNode;

            var portal = activatorNode ? createElement(
                Portal$1,
                { idPrefix: 'popover' },
                createElement(
                    PopoverOverlay$1,
                    Object.assign({ id: this.id, activator: activatorNode, onClose: this.handleClose, active: active, fixed: fixed }, rest),
                    children
                )
            ) : null;
            return createElement(
...
function Label$1(_ref) {
    ...
    var className = classNames(styles$23.Label, hidden && styles$23.hidden);
    return createElement(
        'div',
        { className: className },
        createElement(
            'label',
            { id: labelID(id), htmlFor: id, className: styles$23.Text },
            children
        )
    );
}
...
function InlineError$1(_ref) {
  ...
  return createElement(
    'div',
    { id: fieldID + 'Error', className: styles$24.InlineError },
    createElement(
      'div',
      { className: styles$24.Icon },
      createElement(Icon$2, { source: 'alert' })
    ),
    message
  );
}
...
function Labelled$1(_a) {
  ...
  var className = classNames(labelHidden && styles$25.hidden);
  var actionMarkup = action ? buttonFrom(action, { plain: true }) : null;
  var helpTextMarkup = helpText ? createElement(
    'div',
    { className: styles$25.HelpText, id: helpTextID(id) },
    helpText
  ) : null;
  var errorMarkup = error && typeof error !== 'boolean' && createElement(
    'div',
    { className: styles$25.Error },
    createElement(InlineError$1, { message: error, fieldID: id })
  );
  var labelMarkup = label ? createElement(
    'div',
    { className: styles$25.LabelWrapper },
    createElement(
      Label$1,
...
var Item$8 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$26.Item, focused && styles$26['Item-focused'], position === ItemPosition.Primary ? styles$26['Item-primary'] : styles$26['Item-connection']);
            return createElement(
                'div',
...
var Resizer$1 = function (_React$PureComponent) {
    ...
    _createClass(Resizer, [{
        ...
        value: function render() {
            ...
            var minimumLinesMarkup = minimumLines ? createElement('div', { ref: this.setMinimumLinesNode, className: styles$27.DummyInput, dangerouslySetInnerHTML: {
                    __html: getContentsForMinimumLines(minimumLines)
                } }) : null;
            return createElement(
                'div',
                { 'aria-hidden': true, className: styles$27.Resizer },
                createElement(EventListener$1, { event: 'resize', handler: this.handleHeightCheck }),
                createElement('div', { ref: this.setContentNode, className: styles$27.DummyInput, dangerouslySetInnerHTML: { __html: getFinalContents(contents) } }),
                minimumLinesMarkup
            );
        }
    }, {
...
__decorate([autobind], Resizer$1.prototype, "handleHeightCheck", null);
__decorate([autobind], Resizer$1.prototype, "setContentNode", null);
__decorate([autobind], Resizer$1.prototype, "setMinimumLinesNode", null);
...
function Spinner$4(_ref) {
  ...
  return createElement(
    'div',
    { className: styles$27.Spinner, onClick: onClick, 'aria-hidden': true },
    createElement(
      'div',
      { role: 'button', className: styles$27.Segment, tabIndex: -1, onClick: handleStep(1), onMouseDown: handleMouseDown(handleStep(1)), onMouseUp: onMouseUp },
      createElement(
        'div',
        { className: styles$27.SpinnerIcon },
        createElement(Icon$2, { source: 'caretUp' })
      )
    ),
    createElement(
      'div',
      ...
      createElement(
        'div',
        { className: styles$27.SpinnerIcon },
        createElement(Icon$2, { source: 'caretDown' })
      )
    )
  );
}
...
var TextField$5 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$27.TextField, Boolean(value) && styles$27.hasValue, disabled && styles$27.disabled, readOnly && styles$27.readOnly, error && styles$27.error, multiline && styles$27.multiline, this.state.focus && styles$27.focus);
            var inputType = type === 'currency' ? 'text' : type;
            var prefixMarkup = prefix ? createElement(
                'div',
                { className: styles$27.Prefix, id: id + 'Prefix' },
                prefix
            ) : null;
            var suffixMarkup = suffix ? createElement(
                'div',
                { className: styles$27.Suffix, id: id + 'Suffix' },
                suffix
            ) : null;
            var spinnerMarkup = type === 'number' && !disabled ? createElement(Spinner$4, { onChange: this.handleNumberChange, onMouseDown: this.handleButtonPress, onMouseUp: this.handleButtonRelease }) : null;
            var style = multiline && height ? { height: height } : null;
            var resizer = multiline ? createElement(Resizer$1, { contents: value || placeholder, currentHeight: height, minimumLines: typeof multiline === 'number' ? multiline : 1, onHeightChange: this.handleExpandingResize }) : null;
            var describedBy = [];
            if (error) {
            ...
            var inputClassName = classNames(styles$27.Input, suffix && styles$27['Input-suffixed']);
            ...
            return createElement(
                ...
                createElement(
                    ...
                    createElement(
                        ...
                        suffixMarkup,
                        spinnerMarkup,
                        createElement('div', { className: styles$27.Backdrop }),
                        resizer
                    )
                )
            );
...
__decorate([autobind], TextField$5.prototype, "setInput", null);
__decorate([autobind], TextField$5.prototype, "handleNumberChange", null);
__decorate([autobind], TextField$5.prototype, "handleExpandingResize", null);
__decorate([autobind], TextField$5.prototype, "handleKeyPress", null);
__decorate([autobind], TextField$5.prototype, "handleChange", null);
__decorate([autobind], TextField$5.prototype, "handleFocus", null);
__decorate([autobind], TextField$5.prototype, "handleBlur", null);
__decorate([autobind], TextField$5.prototype, "handleClick", null);
__decorate([autobind], TextField$5.prototype, "handleButtonPress", null);
__decorate([autobind], TextField$5.prototype, "handleButtonRelease", null);
...
var TextField$2 = function (_React$PureComponent) {
    _inherits(TextField, _React$PureComponent);
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            var _context = this.context,
                selectedOptionId = _context.selectedOptionId,
                comboBoxId = _context.comboBoxId;

            return createElement(TextField$5, Object.assign({}, this.props, { autoComplete: false, ariaAutocomplete: 'list', ariaActiveDescendant: selectedOptionId, ariaControls: comboBoxId }));
        }
    }, {
        key: 'handleContextUpdate',
        value: function handleContextUpdate() {
...
var ComboBox$1 = function (_React$PureComponent) {
    _inherits(ComboBox, _React$PureComponent);

    function ComboBox() {
        _classCallCheck(this, ComboBox);

        var _this = _possibleConstructorReturn(this, (ComboBox.__proto__ || Object.getPrototypeOf(ComboBox)).apply(this, arguments));
    ...
    _createClass(ComboBox, [{
        ...
        value: function componentDidMount() {
            var _props = this.props,
                ...
                actionsBefore = _props.actionsBefore,
                actionsAfter = _props.actionsAfter;
        ...
        value: function componentDidUpdate(_, prevState) {
            var _props2 = this.props,
                contentBefore = _props2.contentBefore,
                contentAfter = _props2.contentAfter,
                emptyState = _props2.emptyState;
            var _state = this.state,
                navigableOptions = _state.navigableOptions,
                popoverActive = _state.popoverActive,
                popoverWasActive = _state.popoverWasActive;
        ...
        value: function render() {
            var _props3 = this.props,
                ...
                listTitle = _props3.listTitle,
                allowMultiple = _props3.allowMultiple,
                preferredPosition = _props3.preferredPosition,
                actionsBefore = _props3.actionsBefore,
                actionsAfter = _props3.actionsAfter,
                contentBefore = _props3.contentBefore,
                contentAfter = _props3.contentAfter,
                onEndReached = _props3.onEndReached,
                emptyState = _props3.emptyState;

            var actionsBeforeMarkup = actionsBefore && actionsBefore.length > 0 && createElement(ActionList$1, { actionRole: 'option', items: actionsBefore });
            var actionsAfterMarkup = actionsAfter && actionsAfter.length > 0 && createElement(ActionList$1, { actionRole: 'option', items: actionsAfter });
            var optionsMarkup = options.length > 0 && createElement(OptionList$2, { role: 'presentation', optionRole: 'option', options: filterForOptions(this.state.navigableOptions), onChange: this.selectOptions, selected: this.state.selectedOptions, title: listTitle, allowMultiple: allowMultiple });
            var scrollListenerMarkup = onEndReached && createElement('div', { ref: this.popoverScrollContainer });
            var emptyStateMarkup = !actionsAfter && !actionsBefore && !contentAfter && !contentBefore && options.length === 0 && emptyState && createElement(
                'div',
                { className: styles$28.EmptyState },
                emptyState
            );
            return createElement(
                'div',
                { onClick: this.handleClick, role: 'combobox', 'aria-expanded': this.state.popoverActive, 'aria-owns': this.state.comboBoxId, 'aria-controls': this.state.comboBoxId, 'aria-haspopup': true, onFocus: this.handleFocus, onBlur: this.handleBlur, tabIndex: 0 },
                createElement(KeypressListener$1, { keyCode: Key.DownArrow, handler: this.handleDownArrow }),
                createElement(KeypressListener$1, { keyCode: Key.UpArrow, handler: this.handleUpArrow }),
                createElement(KeypressListener$1, { keyCode: Key.Enter, handler: this.handleEnter }),
                createElement(KeypressListener$1, { keyCode: Key.Escape, handler: this.handlePopoverClose }),
                createElement(
                    Popover$1,
                    { activator: textField, active: this.state.popoverActive, onClose: this.handlePopoverClose, preferredPosition: preferredPosition, fullWidth: true, preventAutofocus: true },
                    createElement(
                        'div',
                        { id: this.state.comboBoxId, role: 'listbox', 'aria-multiselectable': allowMultiple },
        ...
        value: function handleDownArrow() {
            var _state2 = this.state,
                ...
                navigableOptions = _state2.navigableOptions;
        ...
        value: function handleBlur() {
            ...
            this.setState({ popoverActive: false, popoverWasActive: false }, function () {
        ...
        value: function handlePopoverOpen() {
            var _state4 = this.state,
                popoverActive = _state4.popoverActive,
                navigableOptions = _state4.navigableOptions;

            !popoverActive && navigableOptions && navigableOptions.length > 0 && this.setState({ popoverActive: true, popoverWasActive: true });
        }
    }, {
        ...
        value: function selectNextOption() {
            var _state5 = this.state,
                ...
                navigableOptions = _state5.navigableOptions;
        ...
        value: function selectPreviousOption() {
            var _state6 = this.state,
                ...
                navigableOptions = _state6.navigableOptions;
        ...
        value: function selectOptionAtIndex(newOptionIndex) {
            ...
            var _state7 = this.state,
                navigableOptions = _state7.navigableOptions,
                oldSelectedOption = _state7.selectedOption;
        ...
        value: function getSelectedOptionId() {
            var _state8 = this.state,
                selectedOption = _state8.selectedOption,
                selectedIndex = _state8.selectedIndex,
                comboBoxId = _state8.comboBoxId;
        ...
        value: function addScrollListener() {
            this.popoverScrollContainer.current && this.popoverScrollContainer.current.parentElement && addEventListener(this.popoverScrollContainer.current.parentElement, 'scroll', this.handleScroll, { passive: true });
        }
    }, {
        key: 'removeScrollListener',
        value: function removeScrollListener() {
...
ComboBox$1.TextField = TextField$2;
ComboBox$1.OptionList = OptionList$2;
ComboBox$1.childContextTypes = contextTypes$1;
__decorate([autobind], ComboBox$1.prototype, "subscribe", null);
__decorate([autobind], ComboBox$1.prototype, "unsubscribe", null);
__decorate([autobind], ComboBox$1.prototype, "handleDownArrow", null);
__decorate([autobind], ComboBox$1.prototype, "handleUpArrow", null);
__decorate([autobind], ComboBox$1.prototype, "handleEnter", null);
__decorate([autobind], ComboBox$1.prototype, "handleFocus", null);
__decorate([autobind], ComboBox$1.prototype, "handleBlur", null);
__decorate([autobind], ComboBox$1.prototype, "handleClick", null);
__decorate([autobind], ComboBox$1.prototype, "handleScroll", null);
__decorate([autobind], ComboBox$1.prototype, "handleSelection", null);
__decorate([autobind], ComboBox$1.prototype, "selectOptions", null);
__decorate([autobind], ComboBox$1.prototype, "updateIndexOfSelectedOption", null);
__decorate([autobind], ComboBox$1.prototype, "resetVisuallySelectedOptions", null);
__decorate([autobind], ComboBox$1.prototype, "handlePopoverClose", null);
__decorate([autobind], ComboBox$1.prototype, "handlePopoverOpen", null);
__decorate([autobind], ComboBox$1.prototype, "selectNextOption", null);
__decorate([autobind], ComboBox$1.prototype, "selectPreviousOption", null);
__decorate([autobind], ComboBox$1.prototype, "selectOptionAtIndex", null);
__decorate([autobind], ComboBox$1.prototype, "visuallyUpdateSelectedOption", null);
__decorate([autobind], ComboBox$1.prototype, "getSelectedOptionId", null);
__decorate([autobind], ComboBox$1.prototype, "addScrollListener", null);
__decorate([autobind], ComboBox$1.prototype, "removeScrollListener", null);
...
function TextField(props) {
    return createElement(ComboBox$1.TextField, props);
}
var Autocomplete$1 = function (_React$PureComponent) {
    ...
    _createClass(Autocomplete, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                preferredPosition = _props.preferredPosition,
                listTitle = _props.listTitle,
                allowMultiple = _props.allowMultiple,
                loading = _props.loading,
                actionBefore = _props.actionBefore,
                willLoadMoreResults = _props.willLoadMoreResults,
                emptyState = _props.emptyState,
                onSelect = _props.onSelect,
                onLoadMoreResults = _props.onLoadMoreResults,
                intl = _props.polaris.intl;

            var spinnerMarkup = loading ? createElement(
                'div',
                { className: styles$29.Loading },
                createElement(Spinner$2, { size: 'small', accessibilityLabel: intl.translate('Polaris.Autocomplete.spinnerAccessibilityLabel') })
            ) : null;
            ...
            return createElement(ComboBox$1, { id: id, options: conditionalOptions, selected: selected, textField: textField, preferredPosition: preferredPosition, listTitle: listTitle, allowMultiple: allowMultiple, contentAfter: spinnerMarkup, actionsBefore: conditionalAction, onSelect: onSelect, onEndReached: onLoadMoreResults, emptyState: emptyState });
        }
    }]);

    return Autocomplete;
}(PureComponent);
Autocomplete$1.TextField = TextField;
Autocomplete$1.ComboBox = ComboBox$1;
var Autocomplete$2 = withAppProvider()(Autocomplete$1);
...
var Banner$1 = function (_React$PureComponent) {
    ...
    _createClass(Banner, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$30.Banner, status && styles$30[variationName('status', status)], onDismiss && styles$30.hasDismiss, withinContentContainer ? styles$30.withinContentContainer : styles$30.withinPage);
            var id = uniqueID();
            ...
            if (title) {
                ...
                headingMarkup = createElement(
                    'div',
                    { className: styles$30.Heading, id: headingID },
                    createElement(
                        Heading$1,
                        { element: 'p' },
                        title
            ...
            if (children || actionMarkup) {
                ...
                contentMarkup = createElement(
                    'div',
                    { className: styles$30.Content, id: contentID },
                    children,
                    actionMarkup
                );
            }
            var dismissButton = onDismiss ? createElement(
                'div',
                { className: styles$30.Dismiss },
                createElement(Button$3, { plain: true, icon: 'cancelSmall', onClick: onDismiss, accessibilityLabel: 'Dismiss notification' })
            ) : null;
            return createElement(
                'div',
                { className: className
                ...
                createElement(
                    'div',
                    { className: styles$30.Ribbon },
                    createElement(Icon$2, { source: iconName, color: color, backdrop: true })
                ),
                createElement(
                    'div',
                    null,
...
function secondaryActionFrom(action) {
    if (action.url) {
        return createElement(
            UnstyledLink$2,
            { className: styles$30.SecondaryAction, url: action.url, external: action.external },
            createElement(
                'span',
    ...
    return createElement(
        'button',
        { className: styles$30.SecondaryAction, onClick: action.onAction },
        createElement(
            'span',
            { className: styles$30.Text },
            action.content
...
var ScrollLock$1 = function (_React$Component) {
...
function Backdrop$1(props) {
    ...
    var className = classNames$1(styles$31.Backdrop, belowNavigation && styles$31.belowNavigation);
    return createElement(
        Fragment,
        null,
        createElement(ScrollLock$1, null),
        createElement('div', { className: className, onClick: onClick, onTouchStart: onTouchStart })
    );
}
...
var Breadcrumbs$1 = function (_React$PureComponent) {
  ...
  _createClass(Breadcrumbs, [{
    ...
    value: function render() {
      ...
      var contentMarkup = createElement(
        Fragment,
        null,
        createElement(
          'span',
          { className: styles$32.Icon },
          createElement(Icon$2, { source: 'chevronLeft' })
        ),
        createElement(
          'span',
          { className: styles$32.Content },
          content
        )
      );
      var breadcrumbMarkup = 'url' in breadcrumb ? createElement(
        UnstyledLink$2,
        { key: content, url: breadcrumb.url, className: styles$32.Breadcrumb, onMouseUp: handleMouseUpByBlurring },
        contentMarkup
      ) : createElement(
        'button',
        { key: content, className: styles$32.Breadcrumb, onClick: breadcrumb.onAction, onMouseUp: handleMouseUpByBlurring, type: 'button' },
        contentMarkup
      );
      return createElement(
        'nav',
...
function TextContainer$1(_ref) {
    ...
    var className = classNames(styles$33.TextContainer, spacing && styles$33[variationName('spacing', spacing)]);
    return createElement(
        'div',
        { className: className },
        children
...
function CalloutCard$1(_ref) {
  ...
  return createElement(
    ...
    createElement(
      'div',
      { className: styles$34.CalloutCard },
      createElement(
        'div',
        { className: styles$34.Content },
        createElement(
          'div',
          { className: styles$34.Title },
          createElement(
            Heading$1,
            null,
            title
        ...
        createElement(
          'div',
          { className: styles$34.Buttons },
          buttonMarkup
        )
      ),
      createElement(Image$1, { alt: '', className: styles$34.Image, source: illustration })
    )
  );
}
...
function Choice$1(_ref) {
  ...
  var className = classNames(styles$36.Choice, labelHidden && styles$36.labelHidden, disabled && styles$36.disabled);
  var labelMarkup = createElement(
    'label',
    { className: className, htmlFor: id },
    createElement(
      'span',
      { className: styles$36.Control },
      children
    ),
    createElement(
      'span',
      { className: styles$36.Label },
      label
    )
  );
  var helpTextMarkup = helpText ? createElement(
    'div',
    { className: styles$36.HelpText, id: helpTextID$1(id) },
    helpText
  ) : null;
  var errorMarkup = error && typeof error !== 'boolean' && createElement(
    'div',
    { className: styles$36.Error },
    createElement(InlineError$1, { message: error, fieldID: id })
  );
  var descriptionMarkup = helpTextMarkup || errorMarkup ? createElement(
    'div',
    { className: styles$36.Descriptions },
    errorMarkup,
    helpTextMarkup
  ) : null;
...
function Checkbox$3(_ref) {
    var _ref$id = _ref.id,
        id = _ref$id === undefined ? getUniqueID$4() : _ref$id,
        label = _ref.label,
        labelHidden = _ref.labelHidden,
        helpText = _ref.helpText,
        _ref$checked = _ref.checked,
    ...
    var wrapperClassName = classNames(styles$37.Checkbox, error && styles$37.error);
    ...
    var inputClassName = classNames(styles$37.Input, isIndeterminate && styles$37['Input-indeterminate']);
    return (
        /* eslint-disable jsx-a11y/no-redundant-roles, jsx-a11y/role-has-required-aria-props */
        createElement(
            Choice$1,
            { id: id, label: label, labelHidden: labelHidden, helpText: helpText, error: error, disabled: disabled },
            createElement(
                'span',
                ...
                createElement('span', { className: styles$37.Backdrop }),
                createElement(
                    'span',
                    { className: styles$37.Icon },
                    createElement(Icon$2, { source: iconSource })
                )
            )
        )
...
var Checkbox$4 = withAppProvider()(Checkbox$3);
...
var getUniqueID$6 = createUniqueIDFactory('RadioButton');
function RadioButton$1(_ref) {
    ...
    return createElement(
        Choice$1,
        { label: label, labelHidden: labelHidden, disabled: disabled, id: id, helpText: helpText },
        createElement(
            'span',
            { className: styles$38.RadioButton },
            createElement('input', { id: id, name: name, value: value, type: 'radio', checked: checked, disabled: disabled, className: styles$38.Input, onChange: handleChange, onFocus: onFocus, onBlur: onBlur, 'aria-describedby': describedBy }),
            createElement('span', { className: styles$38.Backdrop }),
            createElement('span', { className: styles$38.Icon })
        )
    );
}
...
var getUniqueID$5 = createUniqueIDFactory('ChoiceList');
function ChoiceList$1(_ref) {
    var title = _ref.title,
        ...
        error = _ref.error,
        _ref$name = _ref.name,
        name = _ref$name === undefined ? getUniqueID$5() : _ref$name;

    var ControlComponent = allowMultiple ? Checkbox$4 : RadioButton$1;
    var finalName = allowMultiple ? name + '[]' : name;
    var className = classNames(styles$39.ChoiceList, titleHidden && styles$39.titleHidden);
    var titleMarkup = title ? createElement(
        'legend',
        { className: styles$39.Title },
        title
    ) : null;
    var choicesMarkup = choices.map(function (choice) {
        ...
        var children = renderedChildren ? createElement(
            'div',
            { className: styles$39.ChoiceChildren },
            renderedChildren
        ) : null;
        return createElement(
            'li',
    ...
    var errorMarkup = error && createElement(
        'div',
        { className: styles$39.ChoiceError },
        createElement(InlineError$1, { message: error, fieldID: finalName })
    );
    return createElement(
        'fieldset',
        { className: className, id: finalName, 'aria-invalid': error != null, 'aria-describedby': finalName + 'Error' },
        titleMarkup,
        createElement(
            'ul',
            { className: styles$39.Choices },
            choicesMarkup
        ),
        errorMarkup
    );
...
var ChoiceList$2 = withAppProvider()(ChoiceList$1);
...
var Collapsible$1 = function (_React$Component) {
    ...
    _createClass(Collapsible, [{
        ...
        value: function render() {
            ...
            var wrapperClassName = classNames(styles$40.Collapsible, open && styles$40.open, animating && styles$40.animating);
...
var Collapsible$2 = withAppProvider()(Collapsible$1);
...
var Slidable$1 = function (_React$PureComponent) {
    ...
    _createClass(Slidable, [{
        ...
        value: function render() {
            ...
            return createElement(
                'div',
                { ref: this.setNode, className: styles$41.Slidable, onMouseDown: this.startDrag, onTouchStart: this.startDrag },
                endDragListener,
                moveListener,
                touchMoveListener,
                touchEndListener,
                touchCancelListener,
                createElement('div', { style: draggerPositioning, className: styles$41.Dragger, ref: this.setDraggerNode })
            );
        }
    }, {
        key: 'setDraggerNode',
...
__decorate([autobind], Slidable$1.prototype, "setDraggerNode", null);
__decorate([autobind], Slidable$1.prototype, "setNode", null);
__decorate([autobind], Slidable$1.prototype, "startDrag", null);
__decorate([autobind], Slidable$1.prototype, "handleDragEnd", null);
__decorate([autobind], Slidable$1.prototype, "handleMove", null);
__decorate([autobind], Slidable$1.prototype, "handleDraggerMove", null);
...
var AlphaPicker$1 = function (_React$PureComponent) {
    ...
    _createClass(AlphaPicker, [{
        ...
        value: function render() {
            ...
            return createElement(
                'div',
                { className: styles$41.AlphaPicker, ref: this.setSliderHeight },
                createElement('div', { className: styles$41.ColorLayer, style: { background: background } }),
                createElement(Slidable$1, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
            );
        }
    }, {
        key: 'setSliderHeight',
...
__decorate([autobind], AlphaPicker$1.prototype, "setSliderHeight", null);
__decorate([autobind], AlphaPicker$1.prototype, "setDraggerHeight", null);
__decorate([autobind], AlphaPicker$1.prototype, "handleChange", null);
...
var HuePicker$1 = function (_React$PureComponent) {
    ...
    _createClass(HuePicker, [{
        ...
        value: function render() {
            ...
            return createElement(
                'div',
                { className: styles$41.HuePicker, ref: this.setSliderHeight },
                createElement(Slidable$1, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
            );
        }
    }, {
...
__decorate([autobind], HuePicker$1.prototype, "setSliderHeight", null);
__decorate([autobind], HuePicker$1.prototype, "setDraggerHeight", null);
__decorate([autobind], HuePicker$1.prototype, "handleChange", null);
...
var ColorPicker$1 = function (_React$PureComponent) {
    ...
    _createClass(ColorPicker, [{
        ...
        value: function render() {
            ...
            var alphaSliderMarkup = allowAlpha ? createElement(AlphaPicker$1, { alpha: alpha, color: color, onChange: this.handleAlphaChange }) : null;
            return createElement(
                'div',
                { className: styles$41.ColorPicker, id: id },
                createElement(
                    'div',
                    { ref: this.setColorNode, className: styles$41.MainColor },
                    createElement('div', { className: styles$41.ColorLayer, style: { backgroundColor: colorString } }),
                    createElement(Slidable$1, { onChange: this.handleDraggerMove, draggerX: draggerX, draggerY: draggerY })
                ),
                createElement(HuePicker$1, { hue: hue, onChange: this.handleHueChange }),
                alphaSliderMarkup
            );
        }
    }, {
    ...
    _createClass(Focus, [{
        ...
        value: function componentDidUpdate(_a) {
            var prevChildren = _a.children,
                restPrevProps = __rest(_a, ["children"]);var _b = this.props,
...
var TrapFocus$1 = function (_React$PureComponent) {
    _inherits(TrapFocus, _React$PureComponent);

    function TrapFocus() {
        _classCallCheck(this, TrapFocus);

        var _this = _possibleConstructorReturn(this, (TrapFocus.__proto__ || Object.getPrototypeOf(TrapFocus)).apply(this, arguments));
    ...
    _createClass(TrapFocus, [{
        ...
        value: function render() {
            ...
            return createElement(
                ...
                createElement(
                    ...
                    createElement(EventListener$1, { event: 'focusout', handler: this.handleBlur }),
                    children
                )
            );
        }
        ...
        value: function handleBlur(event) {
            ...
            var _props$trapping2 = this.props.trapping,
                trapping = _props$trapping2 === undefined ? true : _props$trapping2;
        ...
        key: 'shouldDisable',
        get: function get$$1() {
            var _props$trapping3 = this.props.trapping,
                trapping = _props$trapping3 === undefined ? true : _props$trapping3;
...
__decorate([autobind], TrapFocus$1.prototype, "setFocusTrapWrapper", null);
__decorate([autobind], TrapFocus$1.prototype, "handleBlur", null);
...
var Toast = function (_React$Component) {
    ...
    _createClass(Toast, [{
        ...
        value: function render() {
            ...
            var dismissMarkup = createElement(
                'button',
                { type: 'button', className: styles$42.CloseButton, onClick: onDismiss },
                createElement(Icon$2, { source: 'cancel' })
            );
            var className = classNames$1(styles$42.Toast, error && styles$42.error);
            return createElement(
                'div',
                { className: className },
                createElement(KeypressListener$1, { keyCode: Key.Escape, handler: onDismiss }),
                content,
                dismissMarkup
            );
        }
        ...
        value: function triggerDismissalTimeout() {
            var _props2 = this.props,
                ...
                duration = _props2$duration === undefined ? DEFAULT_TOAST_DURATION : _props2$duration;
...
var ToastManager$1 = function (_React$PureComponent) {
    _inherits(ToastManager, _React$PureComponent);

    function ToastManager() {
        _classCallCheck(this, ToastManager);

        var _this = _possibleConstructorReturn(this, (ToastManager.__proto__ || Object.getPrototypeOf(ToastManager)).apply(this, arguments));
    ...
    _createClass(ToastManager, [{
        ...
        value: function render() {
            ...
            var toastsMarkup = toastMessages.map(function (toast, index) {
                ...
                return createElement(
                    CSSTransition,
                    { key: toast.id, timeout: { enter: 0, exit: 400 }, classNames: toastClasses },
                    createElement(
                        'div',
                        { ref: _this2.toastNodes[index], 'aria-live': 'polite' },
            ...
            return createElement(
                ...
                createElement(EventListener$1, { event: 'resize', handler: this.updateToasts }),
                createElement(
                    'div',
                    { className: styles$43.ToastManager },
                    createElement(
                        TransitionGroup,
                        { component: null },
                        toastsMarkup
...
__decorate([autobind], ToastManager$1.prototype, "updateToasts", null);
var toastClasses = {
    enter: classNames(styles$43.ToastWrapper, styles$43['ToastWrapper-enter']),
    enterDone: classNames(styles$43.ToastWrapper, styles$43['ToastWrapper-enter-done']),
    exit: classNames(styles$43.ToastWrapper, styles$43['ToastWrapper-exit'])
};
...
var Loading$2 = function (_React$Component) {
    _inherits(Loading$$1, _React$Component);

    function Loading$$1() {
        _classCallCheck(this, Loading$$1);

        var _this = _possibleConstructorReturn(this, (Loading$$1.__proto__ || Object.getPrototypeOf(Loading$$1)).apply(this, arguments));
    ...
    _createClass(Loading$$1, [{
        ...
        value: function render() {
            ...
            return createElement(
                'div',
                { className: styles$44.Loading },
                createElement('div', { className: styles$44.Level, style: customStyles, 'aria-valuenow': ariaValuenow, 'aria-valuemin': 0, 'aria-valuemax': 100, role: 'progressbar' })
            );
        }
    }, {
        key: 'increment',
...
__decorate([debounce(15)], Loading$2.prototype, "ariaValuenow", null);
...
function redirectAction(target$$1, external) {
    ...
    return Redirect.Action[target$$1];
}
...
function transformSecondaryActions(appBridge) {
    ...
    var secondary = [].concat(_toConsumableArray(secondaryActions.map(function (secondaryAction) {
...
function transformActionGroups(appBridge) {
    ...
    var buttonGroups = [].concat(_toConsumableArray(actionGroups.map(function (group) {
        var buttons = group.actions.map(function (groupAction) {
            return transformAction(appBridge, groupAction);
        });
        return ButtonGroup.create(appBridge, { label: group.title, buttons: buttons });
    })));
    return buttonGroups;
}
...
function DialogContainer(props) {
  return createElement(
    'div',
    { className: styles$45.Container, 'data-polaris-layer': true, 'data-polaris-overlay': true },
    props.children
  );
}
function Dialog$1(_a) {
  ...
  var classes = classNames(styles$45.Modal, large && styles$45.sizeLarge, limitHeight && styles$45.limitHeight);
  var TransitionChild = instant ? Transition : FadeUp;
  return createElement(
    TransitionChild,
    Object.assign({}, props, { mountOnEnter: true, unmountOnExit: true, timeout: Duration.Base, onEntered: onEntered, onExited: onExited }),
    createElement(
      DialogContainer,
      null,
      createElement(
        ...
        createElement(
          'div',
          { className: classes, role: 'dialog', 'aria-labelledby': labelledBy, tabIndex: -1 },
          createElement(KeypressListener$1, { keyCode: Key.Escape, handler: onClose }),
          children
        )
      )
    )
...
var fadeUpClasses = {
  enter: classNames(styles$45.animateFadeUp, styles$45.entering),
  enterActive: classNames(styles$45.animateFadeUp, styles$45.entered),
  exit: classNames(styles$45.animateFadeUp, styles$45.exiting),
  exitActive: classNames(styles$45.animateFadeUp, styles$45.exited)
};
function FadeUp(_a) {
  ...
  return createElement(
    CSSTransition,
    Object.assign({}, props, { classNames: fadeUpClasses }),
    children
  );
}
...
function Footer$1(_ref) {
  ...
  var actions$$1 = primaryActionButton || secondaryActionButtons ? createElement(
    ButtonGroup$2,
    null,
  ...
  return createElement(
    'div',
    { className: styles$46.Footer },
    createElement(
      'div',
      { className: styles$46.FooterContent },
      createElement(
        Stack$1,
        { alignment: 'center' },
        createElement(
...
function DisplayText$1(_ref) {
    ...
    var className = classNames(styles$47.DisplayText, size && styles$47[variationName('size', size)]);
    return createElement(
        Element,
        { className: className },
        children
...
function CloseButton$1(_ref) {
    ...
    var className = classNames$1(styles$48.CloseButton, !title && styles$48.withoutTitle);
    return createElement(
        'button',
        { onClick: onClick, className: className },
        createElement(Icon$2, { source: 'cancel', color: 'inkLighter' })
    );
}
...
function Header$3(_ref) {
  ...
  return createElement(
    'div',
    { className: styles$49.Header },
    createElement(
      'div',
      { id: id, className: styles$49.Title },
      createElement(
        DisplayText$1,
        { element: 'h2', size: 'small' },
        children
      )
    ),
    createElement(CloseButton$1, { onClick: onClose })
  );
}
...
function Section$7(_ref) {
    ...
    var className = classNames(styles$50.Section, flush && styles$50.flush, subdued && styles$50.subdued);
    return createElement(
        'section',
        { className: className },
        children
...
var Modal$2 = function (_React$Component) {
    _inherits(Modal$$1, _React$Component);

    function Modal$$1() {
        _classCallCheck(this, Modal$$1);

        var _this = _possibleConstructorReturn(this, (Modal$$1.__proto__ || Object.getPrototypeOf(Modal$$1)).apply(this, arguments));
    ...
    _createClass(Modal$$1, [{
        ...
        value: function render() {
            ...
            var backdrop = void 0;
            if (open) {
                var footerMarkup = !footer && !primaryAction && !secondaryActions ? null : createElement(
                    Footer$1,
                    { primaryAction: primaryAction, secondaryActions: secondaryActions },
                    footer
                );
                var content = sectioned ? wrapWithComponent(children, Section$7) : children;
                var body = loading ? createElement(
                    'div',
                    { className: styles$51.Spinner },
                    createElement(Spinner$2, null)
                ) : content;
                var bodyMarkup = src ? createElement('iframe', { name: iFrameName, title: iframeTitle, src: src, className: styles$51.IFrame, onLoad: this.handleIFrameLoad, style: { height: iframeHeight + 'px' } }) : createElement(
                    Scrollable$2,
                    { shadow: true, className: styles$51.Body },
                    body
                );
                var headerMarkup = title ? createElement(
                    Header$3,
                    { id: this.headerId, onClose: onClose },
                    title
                ) : createElement(CloseButton$1, { onClick: onClose, title: false });
                dialog = createElement(
                    Dialog$1,
                    { instant: instant, labelledBy: this.headerId, onClose: onClose, onEntered: this.handleEntered, onExited: this.handleExited, large: large, limitHeight: limitHeight },
                    headerMarkup,
                    createElement(
                        'div',
                        { className: styles$51.BodyWrapper },
                        bodyMarkup
                    ),
                    footerMarkup
                );
                backdrop = createElement(Backdrop$1, null);
            }
            ...
            return createElement(
                ...
                createElement(
                    TransitionGroup,
                    { appear: animated, enter: animated, exit: animated },
                    dialog
                ),
                backdrop
            );
        ...
        value: function transformProps() {
            var _props2 = this.props,
                ...
                src = _props2.src,
                primaryAction = _props2.primaryAction,
                secondaryActions = _props2.secondaryActions,
            ...
            return Object.assign({ title: safeTitle, message: message, size: safeSize }, srcPayload, { footer: {
...
Modal$2.childContextTypes = contentContextTypes;
Modal$2.Dialog = Dialog$1;
Modal$2.Section = Section$7;
__decorate([autobind], Modal$2.prototype, "handleEntered", null);
__decorate([autobind], Modal$2.prototype, "handleExited", null);
__decorate([autobind], Modal$2.prototype, "handleIFrameLoad", null);
function isIframeModal(options) {
    return typeof options.url === 'string' || typeof options.path === 'string';
}
var Modal$3 = withAppProvider()(Modal$2);

function DiscardConfirmationModal$1(_ref) {
    var open = _ref.open,
    ...
    return createElement(
        Modal$3,
        { title: intl.translate('Polaris.DiscardConfirmationModal.title'), open: open, onClose: onCancel, primaryAction: {
...
var DiscardConfirmationModal$2 = withAppProvider()(DiscardConfirmationModal$1);
...
var ContextualSaveBar$4 = function (_React$PureComponent) {
    _inherits(ContextualSaveBar, _React$PureComponent);

    function ContextualSaveBar() {
        _classCallCheck(this, ContextualSaveBar);

        var _this = _possibleConstructorReturn(this, (ContextualSaveBar.__proto__ || Object.getPrototypeOf(ContextualSaveBar)).apply(this, arguments));
    ...
    _createClass(ContextualSaveBar, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                alignContentFlush = _props.alignContentFlush,
                message = _props.message,
                discardAction = _props.discardAction,
                saveAction = _props.saveAction,
                _props$polaris = _props.polaris,
                logo = _props$polaris.theme.logo,
                intl = _props$polaris.intl;
            ...
            var discardActionHandler = void 0;
            ...
            var discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && createElement(DiscardConfirmationModal$2, { open: discardConfirmationModalVisible, onCancel: this.toggleDiscardConfirmationModal, onDiscard: discardAction.onAction });
            var discardActionMarkup = discardAction && createElement(
                Button$3,
                { url: discardAction.url, onClick: discardActionHandler, loading: discardAction.loading, disabled: discardAction.disabled, accessibilityLabel: discardAction.content },
                discardActionContent
            );
            var saveActionContent = saveAction && saveAction.content ? saveAction.content : intl.translate('Polaris.ContextualSaveBar.save');
            var saveActionMarkup = saveAction && createElement(
                Button$3,
                { primary: true, url: saveAction.url, onClick: saveAction.onAction, loading: saveAction.loading, disabled: saveAction.disabled, accessibilityLabel: saveAction.content },
                saveActionContent
            );
            var width = getWidth(logo, 104);
            var imageMarkup = logo && createElement(Image$1, { style: { width: width }, source: logo.contextualSaveBarSource || '', alt: '' });
            var logoMarkup = alignContentFlush ? null : createElement(
                'div',
                { className: styles$52.LogoContainer, style: { width: width } },
                imageMarkup
            );
            return createElement(
                Fragment,
                ...
                createElement(
                    'div',
                    { className: styles$52.ContextualSaveBar },
                    logoMarkup,
                    createElement(
                        'div',
                        { className: styles$52.Contents },
                        createElement(
                            'h2',
                            { className: styles$52.Message },
                            message
                        ),
                        createElement(
                            Stack$1,
                            { spacing: 'tight', wrap: false },
                            discardActionMarkup,
                            saveActionMarkup
                        )
                    )
...
__decorate([autobind], ContextualSaveBar$4.prototype, "toggleDiscardConfirmationModal", null);
var ContextualSaveBar$5 = withAppProvider()(ContextualSaveBar$4);
...
var Frame$1 = function (_React$PureComponent) {
    _inherits(Frame, _React$PureComponent);

    function Frame() {
        _classCallCheck(this, Frame);

        var _this = _possibleConstructorReturn(this, (Frame.__proto__ || Object.getPrototypeOf(Frame)).apply(this, arguments));
    ...
    _createClass(Frame, [{
        ...
        value: function render() {
            var _state = this.state,
                skipFocused = _state.skipFocused,
                loadingStack = _state.loadingStack,
                toastMessages = _state.toastMessages,
                showContextualSaveBar = _state.showContextualSaveBar,
                mobileView = _state.mobileView;
            var _props = this.props,
                children = _props.children,
                navigation = _props.navigation,
                topBar = _props.topBar,
                globalRibbon = _props.globalRibbon,
                _props$showMobileNavi = _props.showMobileNavigation,
                showMobileNavigation = _props$showMobileNavi === undefined ? false : _props$showMobileNavi,
                intl = _props.polaris.intl;

            var navClassName = classNames(styles$53.Navigation, showMobileNavigation && styles$53['Navigation-visible']);
            ...
            var navigationMarkup = navigation ? createElement(
                TrapFocus$1,
                { trapping: mobileNavShowing },
                createElement(
                    CSSTransition,
                    { appear: mobileView, exit: mobileView, 'in': showMobileNavigation, timeout: Duration.Base, classNames: navTransitionClasses },
                    createElement(
                        'div',
                        { className: navClassName, onKeyDown: this.handleNavKeydown, id: APP_FRAME_NAV, key: 'NavContent', hidden: mobileNavHidden },
                        navigation,
                        createElement(
                            'button',
                            { type: 'button', className: styles$53.NavigationDismiss, onClick: this.handleNavigationDismiss, 'aria-hidden': mobileNavHidden || !mobileView && !showMobileNavigation, 'aria-label': intl.translate('Polaris.Frame.Navigation.closeMobileNavigationLabel'), tabIndex: tabIndex },
                            createElement(Icon$2, { source: 'cancel', color: 'white' })
                        )
                    )
                )
            ) : null;
            var loadingMarkup = loadingStack > 0 ? createElement(
                'div',
                { className: styles$53.LoadingBar, id: APP_FRAME_LOADING_BAR },
                createElement(Loading$2, null)
            ) : null;
            var contextualSaveBarMarkup = createElement(
                CSSTransition,
                { appear: true, exit: true, 'in': showContextualSaveBar, timeout: 300, classNames: contextualSaveBarTransitionClasses, mountOnEnter: true, unmountOnExit: true },
                createElement(
                    'div',
                    { className: styles$53.ContextualSaveBar },
                    createElement(ContextualSaveBar$5, this.contextualSaveBar)
                )
            );
            var topBarMarkup = topBar ? createElement(
                'div',
                Object.assign({ className: styles$53.TopBar }, layer.props, dataPolarisTopBar.props, { id: APP_FRAME_TOP_BAR }),
                topBar
            ) : null;
            var globalRibbonMarkup = globalRibbon ? createElement(
                'div',
                { className: styles$53.GlobalRibbonContainer, ref: this.setGlobalRibbonContainer },
                globalRibbon
            ) : null;
            var skipClassName = classNames(styles$53.Skip, skipFocused && styles$53.focused);
            var skipMarkup = createElement(
                'div',
                { className: skipClassName },
                createElement(
                    Button$3,
                    { onClick: this.handleClick, onFocus: this.handleFocus, onBlur: this.handleBlur },
            ...
            var frameClassName = classNames(styles$53.Frame, navigation && styles$53.hasNav, topBar && styles$53.hasTopBar);
            var navigationOverlayMarkup = showMobileNavigation && mobileView ? createElement(Backdrop$1, { belowNavigation: true, onClick: this.handleNavigationDismiss, onTouchStart: this.handleNavigationDismiss }) : null;
            return createElement(
                'div',
                Object.assign({ className: frameClassName }, layer.props, navigationAttributes),
                skipMarkup,
                topBarMarkup,
                ...
                createElement(
                    'main',
                    { className: styles$53.Main, id: APP_FRAME_MAIN, 'data-has-global-ribbon': Boolean(globalRibbon) },
                    createElement(
                        'div',
                        { className: styles$53.Content },
                        children
                    )
                ),
                createElement(ToastManager$1, { toastMessages: toastMessages }),
                globalRibbonMarkup,
                createElement(EventListener$1, { event: 'resize', handler: this.handleResize })
            );
        }
    }, {
...
Frame$1.childContextTypes = frameContextTypes;
__decorate([autobind], Frame$1.prototype, "setGlobalRibbonHeight", null);
__decorate([autobind], Frame$1.prototype, "setGlobalRibbonRootProperty", null);
__decorate([autobind], Frame$1.prototype, "showToast", null);
__decorate([autobind], Frame$1.prototype, "hideToast", null);
__decorate([autobind], Frame$1.prototype, "setContextualSaveBar", null);
__decorate([autobind], Frame$1.prototype, "removeContextualSaveBar", null);
__decorate([autobind], Frame$1.prototype, "startLoading", null);
__decorate([autobind], Frame$1.prototype, "stopLoading", null);
__decorate([autobind], Frame$1.prototype, "handleResize", null);
__decorate([autobind], Frame$1.prototype, "handleClick", null);
__decorate([autobind], Frame$1.prototype, "handleFocus", null);
__decorate([autobind], Frame$1.prototype, "handleBlur", null);
__decorate([autobind], Frame$1.prototype, "handleNavigationDismiss", null);
__decorate([autobind], Frame$1.prototype, "setGlobalRibbonContainer", null);
__decorate([autobind], Frame$1.prototype, "handleNavKeydown", null);
var navTransitionClasses = {
    enter: classNames(styles$53['Navigation-enter']),
    enterActive: classNames(styles$53['Navigation-enterActive']),
    enterDone: classNames(styles$53['Navigation-enterActive']),
    exit: classNames(styles$53['Navigation-exit']),
    exitActive: classNames(styles$53['Navigation-exitActive'])
};
var contextualSaveBarTransitionClasses = {
    enter: classNames(styles$53['ContextualSaveBar-enter']),
    enterActive: classNames(styles$53['ContextualSaveBar-enterActive']),
    enterDone: classNames(styles$53['ContextualSaveBar-enterActive']),
    exit: classNames(styles$53['ContextualSaveBar-exit']),
    exitActive: classNames(styles$53['ContextualSaveBar-exitActive'])
};
...
var Frame$2 = withAppProvider()(Frame$1);

var ContextualSaveBar$1 = function (_React$PureComponent) {
    _inherits(ContextualSaveBar, _React$PureComponent);

    function ContextualSaveBar() {
        _classCallCheck(this, ContextualSaveBar);

        return _possibleConstructorReturn(this, (ContextualSaveBar.__proto__ || Object.getPrototypeOf(ContextualSaveBar)).apply(this, arguments));
    }
...
ContextualSaveBar$1.contextTypes = frameContextTypes;
...
function Cell$1(_ref) {
  ...
  var className = classNames(styles$54.Cell, fixed && styles$54['Cell-fixed'], fixed && truncate && styles$54['Cell-truncated'], header && styles$54['Cell-header'], total && styles$54['Cell-total'], footer && styles$54['Cell-footer'], numeric && styles$54['Cell-numeric'], sortable && styles$54['Cell-sortable'], sorted && styles$54['Cell-sorted']);
  var headerClassName = classNames(header && styles$54.Heading, header && contentType === 'text' && styles$54['Heading-left']);
  var iconClassName = classNames(sortable && styles$54.Icon);
  var style = {
  ...
  var iconMarkup = createElement(
    'span',
    { className: iconClassName },
    createElement(Icon$2, { source: source, accessibilityLabel: sortAccessibilityLabel })
  );
  var sortableHeadingContent = createElement(
    'button',
    { className: headerClassName, onClick: onSort },
    iconMarkup,
    content
  );
  var columnHeadingContent = sortable ? sortableHeadingContent : content;
  var headingMarkup = header ? createElement(
    'th',
    Object.assign({}, headerCell.props, { className: className, scope: 'col', 'aria-sort': sortDirection, style: style }),
    columnHeadingContent
  ) : createElement(
    'th',
    { className: className, scope: 'row', style: style },
    content
  );
  var cellMarkup = header || fixed ? headingMarkup : createElement(
    'td',
...
function Navigation$1(_ref) {
    ...
    var pipMarkup = columnVisibilityData.map(function (column, index) {
        var className = classNames(styles$54.Pip, column.isVisible && styles$54['Pip-visible']);
        return createElement('div', { className: className, key: 'pip-' + index });
    });
    ...
    return createElement(
        'div',
        { className: styles$54.Navigation },
        createElement(Button$3, { plain: true, icon: 'chevronLeft', disabled: isScrolledFarthestLeft, accessibilityLabel: leftA11yLabel, onClick: navigateTableLeft }),
        pipMarkup,
        createElement(Button$3, { plain: true, icon: 'chevronRight', disabled: isScrolledFarthestRight, accessibilityLabel: rightA11yLabel, onClick: navigateTableRight })
    );
}
...
var DataTable$1 = function (_React$PureComponent) {
    ...
    _createClass(DataTable, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$54.DataTable, collapsed && styles$54.collapsed, footerContent && styles$54.hasFooter);
            var wrapperClassName = classNames(styles$54.TableWrapper, collapsed && styles$54.collapsed);
            var footerClassName = classNames(footerContent && styles$54.TableFoot);
            var footerMarkup = footerContent ? createElement(
                'tfoot',
            ...
            var totalsMarkup = totals ? createElement(
                'tr',
                null,
                totals.map(this.renderTotals)
            ) : null;
            var headingMarkup = createElement(
                'tr',
                null,
                headings.map(function (heading, headingIndex) {
                    ...
                    return createElement(Cell$2, Object.assign({ header: true, key: id, height: height, content: heading, contentType: columnContentTypes[headingIndex], fixed: headingIndex === 0, truncate: truncate }, sortableHeadingProps));
                })
            );
            ...
            return createElement(
                'div',
                { className: wrapperClassName },
                createElement(Navigation$2, { columnVisibilityData: columnVisibilityData, isScrolledFarthestLeft: isScrolledFarthestLeft, isScrolledFarthestRight: isScrolledFarthestRight, navigateTableLeft: this.navigateTable('left'), navigateTableRight: this.navigateTable('right') }),
                createElement(
                    'div',
                    { className: className, ref: this.dataTable },
                    createElement(
                        'div',
                        { className: styles$54.ScrollContainer, ref: this.scrollContainer, style: style },
                        createElement(EventListener$1, { event: 'resize', handler: this.handleResize }),
                        createElement(EventListener$1, { capture: true, event: 'scroll', handler: this.scrollListener }),
                        createElement(
                            'table',
                            { className: styles$54.Table, ref: this.table },
                            createElement(
                                'thead',
                                null,
                                headingMarkup,
        ...
        value: function renderTotals(total, index) {
            ...
            return createElement(Cell$2, { total: true, fixed: index === 0, key: id, height: heights[1], content: content, contentType: contentType, truncate: truncate });
        }
    }, {
        key: 'defaultRenderRow',
        value: function defaultRenderRow(row, index) {
            var className = classNames(styles$54.TableRow);
            var _props4 = this.props,
            ...
            return createElement(
                'tr',
                { key: 'row-' + index, className: className },
                row.map(function (content, cellIndex) {
                    var id = 'cell-' + cellIndex + '-row-' + index;
                    return createElement(Cell$2, { key: id, height: bodyCellHeights[index], content: content, contentType: columnContentTypes[cellIndex], fixed: cellIndex === 0, truncate: truncate });
                })
            );
        }
    }, {
        ...
        value: function renderFooter() {
            ...
            return createElement(Cell$2, { footer: true, height: footerCellHeight, content: this.props.footerContent, truncate: this.props.truncate });
        }
    }, {
        key: 'defaultOnSort',
                ...
                _this7.setState({
                    ...
                    if (onSort) {
                        ...
                        if (!truncate && _this7.scrollContainer.current) {
                            ...
                            _this7.setState({ preservedScrollPosition: preservedScrollPosition });
                            _this7.handleResize();
                        }
                    }
                });
...
__decorate([autobind, debounce()], DataTable$1.prototype, "handleResize", null);
__decorate([autobind], DataTable$1.prototype, "tallestCellHeights", null);
__decorate([autobind], DataTable$1.prototype, "resetScrollPosition", null);
__decorate([autobind], DataTable$1.prototype, "setHeightsAndScrollPosition", null);
__decorate([autobind], DataTable$1.prototype, "calculateColumnVisibilityData", null);
__decorate([autobind], DataTable$1.prototype, "scrollListener", null);
__decorate([autobind], DataTable$1.prototype, "navigateTable", null);
__decorate([autobind], DataTable$1.prototype, "renderTotals", null);
__decorate([autobind], DataTable$1.prototype, "defaultRenderRow", null);
__decorate([autobind], DataTable$1.prototype, "renderFooter", null);
__decorate([autobind], DataTable$1.prototype, "defaultOnSort", null);
var DataTable$2 = withAppProvider()(DataTable$1);
...
var Day$1 = function (_React$PureComponent) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            if (!day) {
                return createElement('div', { className: styles$55.EmptyDay, onMouseOver: handleHover });
            }
            var handleClick = onClick && !disabled ? onClick.bind(null, day) : noop;
            var today = isSameDay(new Date(), day);
            var className = classNames(styles$55.Day, selected && styles$55['Day-selected'], disabled && styles$55['Day-disabled'], today && styles$55['Day-today'], (inRange || inHoveringRange) && !disabled && styles$55['Day-inRange']);
            var date = day.getDate();
            var tabIndex = (focused || selected || today || date === 1) && !disabled ? 0 : -1;
            var ariaLabel = ['' + (today ? intl.translate('Polaris.DatePicker.today') : ''), Months[day.getMonth()] + ' ', date + ' ', '' + day.getFullYear()].join('');
            return createElement(
                'button',
                {
                    // eslint-disable-next-line react/jsx-no-bind
...
__decorate([autobind], Day$1.prototype, "setNode", null);
...
function Weekday$1(_ref) {
    ...
    var className = classNames(styles$55.Weekday, current && styles$55['Weekday-current']);
    return createElement(
        'div',
...
function Month$1(_ref) {
    ...
    var className = classNames(styles$55.Title, current && styles$55['Month-current']);
    var weeks = getWeeksForMonth(month, year, weekStartsOn);
    var weekdays = getWeekdaysOrdered(weekStartsOn).map(function (weekday) {
        return createElement(Weekday$1, { key: weekday, title: abbreviationForWeekday(weekday), current: current && new Date().getDay() === weekday, label: weekday });
    });
    ...
    function renderWeek(day, dayIndex) {
        if (day == null) {
            ...
            return (
                // eslint-disable-next-line react/jsx-no-bind
                createElement(Day$2, { key: dayIndex, onHover: onHover.bind(null, lastDayOfMonth) })
            );
        }
        var disabled = disableDatesBefore && isDateBefore(day, disableDatesBefore) || disableDatesAfter && isDateAfter(day, disableDatesAfter);
        return createElement(Day$2, { focused: focusedDate != null && isSameDay(day, focusedDate), day: day, key: dayIndex, onFocus: onFocus, onClick: handleDateClick, onHover: onHover, selected: selected != null && dateIsSelected(day, selected), inRange: selected != null && dateIsInRange(day, selected), disabled: disabled, inHoveringRange: selected != null && hoverDate != null && isInHoveringRange(day, selected, hoverDate) });
    }
    var weeksMarkup = weeks.map(function (week, index) {
        return createElement(
            'div',
            { role: 'row', className: styles$55.Week, key: index },
            week.map(renderWeek)
        );
    });
    return createElement(
        'div',
        { role: 'grid', className: styles$55.Month },
        createElement(
            'div',
            { className: className },
            Months[month],
        ...
        createElement(
            'div',
            { role: 'rowheader', className: styles$55.WeekHeadings },
            weekdays
        ),
        weeksMarkup
    );
    ...
    _createClass(DatePicker, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                weekStartsOn = _props$weekStartsOn === undefined ? Weekdays.Sunday : _props$weekStartsOn,
                intl = _props.polaris.intl;
            var _state = this.state,
            ...
            return createElement(
                'div',
                { id: id, className: styles$55.DatePicker, onKeyDown: handleKeyDown, onKeyUp: this.handleKeyUp },
                createElement(
                    'div',
                    { className: styles$55.Header },
                    createElement(Button$3, { plain: true, icon: 'arrowLeft', accessibilityLabel: intl.translate('Polaris.DatePicker.previousMonth', {
                            previousMonthName: previousMonthName,
                            showPreviousYear: showPreviousYear
                        })
                        // eslint-disable-next-line react/jsx-no-bind
                        , onClick: this.handleMonthChangeClick.bind(null, showPreviousMonth, showPreviousYear) }),
                    createElement(Button$3, { plain: true, icon: 'arrowRight', accessibilityLabel: intl.translate('Polaris.DatePicker.nextMonth', {
                            nextMonth: nextMonth,
                            nextYear: nextYear
                        })
                        // eslint-disable-next-line react/jsx-no-bind
                ...
                createElement(
                    'div',
                    { className: styles$55.MonthContainer },
...
__decorate([autobind], DatePicker$1.prototype, "resetFocus", null);
...
function DescriptionList$1(_ref) {
    ...
    var terms = items.reduce(function (allTerms, _ref2) {
        ...
        return [].concat(_toConsumableArray(allTerms), [createElement(
            'dt',
            { key: getUniqueTermKey(), className: styles$56.Term },
            term
        ), createElement(
            'dd',
            { key: getUniqueDescriptionKey(), className: styles$56.Description },
            description
        )]);
    }, []);
    return createElement(
        'dl',
        { className: styles$56.DescriptionList },
        terms
    );
}
...
function Link$3(_ref) {
  ...
  return url ? createElement(
    UnstyledLink$2,
    { onClick: onClick, className: styles$57.Link, url: url, external: external, id: id },
    children
  ) : createElement(
    'button',
    { type: 'button', onClick: onClick, className: styles$57.Link, id: id },
    children
  );
}
                ...
                value: function render() {
                    ...
                    return createElement(
                        ...
                        function (ctx) {
                            ...
                            return createElement(WrappedComponent, Object.assign({}, rest, { context: Object.assign({}, context, ctx) }));
                        }
                    );
                }
            }]);
...
var FileUpload$1 = function (_React$Component) {
    ...
    _createClass(FileUpload, [{
        ...
        value: function render() {
            ...
            var imageClasses = classNames(styles$58.Image, size && size === 'extraLarge' && styles$58.sizeExtraLarge, size && size === 'large' && styles$58.sizeLarge);
            var extraLargeView = size === 'extraLarge' ? createElement(
                Stack$1,
                { vertical: true },
                type === 'file' && createElement('img', { className: imageClasses, src: AssetFileUpload, alt: '' }),
                type === 'image' && createElement('img', { className: imageClasses, src: AssetImageUpload, alt: '' }),
                createElement(
                    Button$3,
                    null,
                    actionTitle
            ...
            var largeView = size === 'large' ? createElement(
                Stack$1,
                { vertical: true, spacing: 'tight' },
                type === 'file' && createElement('img', { className: imageClasses, src: AssetFileUpload, alt: '' }),
                type === 'image' && createElement('img', { className: imageClasses, src: AssetImageUpload, alt: '' }),
                createElement(
                    Button$3,
            ...
            var mediumView = size === 'medium' ? createElement(
                Stack$1,
                { vertical: true, spacing: 'tight' },
                createElement(
                    Link$3,
            ...
            var smallView = size === 'small' ? createElement(
                Stack$1,
                { vertical: true, spacing: 'tight' },
                createElement(Icon$2, { source: IconDragDrop, color: 'inkLightest' })
            ) : null;
            return createElement(
                'div',
                { className: styles$58.FileUpload },
                smallView,
                mediumView,
                largeView,
                extraLargeView
...
var FileUpload$2 = compose$2(withContext$1(Consumer$1), withAppProvider(), withRef$1())(FileUpload$1);
...
var DropZone$1 = function (_React$Component) {
    ...
    _createClass(DropZone, [{
        ...
        value: function render() {
            ...
            var classes = classNames(styles$59.DropZone, outline && styles$59.hasOutline, (active || dragging) && styles$59.isDragging, error && styles$59.hasError, size && size === 'extraLarge' && styles$59.sizeExtraLarge, size && size === 'large' && styles$59.sizeLarge, size && size === 'medium' && styles$59.sizeMedium, size && size === 'small' && styles$59.sizeSmall);
            var dragOverlay = (active || dragging) && !error && overlay ? createElement(
                'div',
                { className: styles$59.Overlay },
                createElement(
                    Stack$1,
                    { vertical: true, spacing: 'tight' },
                    createElement(Icon$2, { source: IconDragDrop, color: 'indigo' }),
                    size === 'extraLarge' && createElement(
                        DisplayText$1,
                        { size: 'small', element: 'p' },
                        overlayText
                    ),
                    (size === 'medium' || size === 'large') && createElement(
                        Caption$1,
                        null,
                        overlayText
                    )
            ...
            var dragErrorOverlay = dragging && error ? createElement(
                'div',
                { className: styles$59.Overlay },
                createElement(
                    Stack$1,
                    { vertical: true, spacing: 'tight' },
                    createElement(Icon$2, { source: IconAlertCircle, color: 'red' }),
                    size === 'extraLarge' && createElement(
                        DisplayText$1,
                        { size: 'small', element: 'p' },
                        errorOverlayText
            ...
            var dropZoneMarkup = createElement(
                'div',
                { ref: this.setNode, className: classes, 'aria-disabled': disabled, onClick: this.handleClick, onDragStart: handleDragStart },
                dragOverlay,
                dragErrorOverlay,
                createElement(
                    'div',
                    { className: styles$59.Container },
                    children
                ),
                createElement(
                    VisuallyHidden$1,
                    null,
                    createElement('input', inputAttributes)
                )
            );
            var labelledDropzoneMarkup = label ? createElement(
                Labelled$1,
                { id: id, label: label, action: labelAction, labelHidden: labelHidden },
                dropZoneMarkup
            ) : dropZoneMarkup;
            return createElement(
                Provider$1,
...
__decorate([autobind], DropZone$1.prototype, "triggerFileDialog", null);
__decorate([autobind], DropZone$1.prototype, "open", null);
__decorate([autobind, debounce(50, { trailing: true })], DropZone$1.prototype, "adjustSize", null);
__decorate([autobind], DropZone$1.prototype, "getValidatedFiles", null);
__decorate([autobind], DropZone$1.prototype, "setNode", null);
__decorate([autobind], DropZone$1.prototype, "setInputNode", null);
__decorate([autobind], DropZone$1.prototype, "handleClick", null);
__decorate([autobind], DropZone$1.prototype, "handleDrop", null);
__decorate([autobind], DropZone$1.prototype, "handleDragEnter", null);
__decorate([autobind], DropZone$1.prototype, "handleDragOver", null);
__decorate([autobind], DropZone$1.prototype, "handleDragLeave", null);
function handleDragStart(event) {
    event.preventDefault();
    event.stopPropagation();
}
var DropZone$2 = withAppProvider()(DropZone$1);
...
var EmptySearchResult$1 = function (_React$PureComponent) {
    ...
    _createClass(EmptySearchResult, [{
        ...
        value: function render() {
            ...
            var descriptionMarkup = description ? createElement(
                'p',
                null,
                description
            ) : null;
            var illustrationMarkup = withIllustration ? createElement(Image$1, { alt: altText, source: emptySearch, className: styles$60.Image, draggable: false }) : null;
            return createElement(
                Stack$1,
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$61.EmptyState, imageContained && styles$61.imageContained);
      var imageMarkup = largeImage ? createElement(Image$1, { alt: '', role: 'presentation', className: styles$61.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : createElement(Image$1, { role: 'presentation', alt: '', className: styles$61.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return createElement(
        'div',
        { className: className },
        createElement(
          'div',
          { className: styles$61.Section },
          createElement(
            'div',
            { className: styles$61.DetailsContainer },
            createElement(
              'div',
              { className: styles$61.Details },
              createElement(
                TextContainer$1,
                null,
                createElement(
                ...
                createElement(
                  'div',
                  { className: styles$61.Content },
                  children
                )
              ),
              createElement(
                'div',
                { className: styles$61.Actions },
                createElement(
                  Stack$1,
                  { alignment: 'center' },
          ...
          createElement(
            'div',
            { className: styles$61.ImageContainer },
            imageMarkup
          )
        )
      );
...
function Truncate$1(_ref) {
    var children = _ref.children;

    return createElement(
        'span',
        { className: styles$62.Truncate },
        children
    );
}
...
function ExceptionList$1(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    var status = item.status,
        ...
        truncate = _item$truncate === undefined ? false : _item$truncate;

    var itemClasses = classNames(styles$63.Item, status && styles$63[variationName('status', status)]);
    var iconMarkup = icon ? createElement(Icon$2, { source: icon }) : createElement('span', { className: styles$63.Bullet });
    var titleMarkup = title && createElement(
      'span',
      { className: styles$63.Title },
      title
    );
    var descriptionMarkup = description && createElement(
      'span',
      { className: styles$63.Description },
      description
    );
    var Element = truncate ? Truncate$1 : Fragment;
    return createElement(
      'li',
      { className: itemClasses, key: index },
      createElement(
        'span',
        { className: styles$63.Icon },
        iconMarkup
      ),
      createElement(
        Element,
  ...
  return createElement(
    'ul',
    { className: styles$63.ExceptionList },
    items
  );
}
...
function FooterHelp$1(_ref) {
  ...
  return createElement(
    'div',
    { className: styles$64.FooterHelp },
    createElement(
      'div',
      { className: styles$64.Content },
      createElement(
        'div',
        { className: styles$64.Icon },
        createElement(Icon$2, { source: 'help', color: 'teal', backdrop: true })
      ),
      createElement(
        'div',
        { className: styles$64.Text },
        children
      )
    )
  );
...
var Form$1 = function (_React$PureComponent) {
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var submitMarkup = implicitSubmit ? createElement(
                VisuallyHidden$1,
                null,
                createElement('button', { type: 'submit', 'aria-hidden': 'true' })
            ) : null;
            return createElement(
                'form',
                { acceptCharset: acceptCharset, action: action, autoComplete: autoCompleteInputs, encType: encType, method: method, name: name, noValidate: noValidate, target: target$$1, onSubmit: this.handleSubmit },
                children,
                submitMarkup
            );
        }
...
__decorate([autobind], Form$1.prototype, "handleSubmit", null);
...
function Group$1(_ref) {
    ...
    var className = classNames(condensed ? styles$65.condensed : styles$65.grouped);
    ...
    if (helpText) {
        ...
        helpTextElement = createElement(
            'div',
            { id: helpTextID, className: styles$65.HelpText },
            helpText
        );
    }
    if (title) {
        ...
        titleElement = createElement(
            'div',
            { id: titleID, className: styles$65.Title },
            title
        );
    }
    var itemsMarkup = Children.map(children, function (child) {
        return wrapWithComponent(child, Item$11);
    });
    return createElement(
        'div',
...
var FormLayout$1 = function (_React$PureComponent) {
    ...
    _createClass(FormLayout, [{
        ...
        value: function render() {
            ...
            return createElement(
                'div',
                { className: styles$65.FormLayout },
...
function wrapChildren(child, index) {
    ...
    var props = { key: index };
    return wrapWithComponent(child, Item$11, props);
}
...
function KeyboardKey$1(_ref) {
    ...
    return createElement(
        'kbd',
        { className: styles$66.KeyboardKey },
        key
    );
}
...
function AnnotatedSection$1(props) {
  ...
  var descriptionMarkup = typeof description === 'string' ? createElement(
    'p',
    null,
    description
  ) : description;
  return createElement(
    'div',
    { className: styles$67.AnnotatedSection },
    createElement(
      'div',
      { className: styles$67.AnnotationWrapper },
      createElement(
        'div',
        { className: styles$67.Annotation },
        createElement(
          TextContainer$1,
          null,
          createElement(
          ...
          descriptionMarkup && createElement(
            'div',
            { className: styles$67.AnnotationDescription },
            descriptionMarkup
          )
        )
      ),
      createElement(
        'div',
        { className: styles$67.AnnotationContent },
        children
      )
    )
  );
...
function Section$9(_ref) {
    ...
    var className = classNames(styles$67.Section, secondary && styles$67['Section-secondary'], fullWidth && styles$67['Section-fullWidth']);
    return createElement(
        'div',
        { className: className },
        children
...
var ContentList = function (_React$PureComponent) {
    ...
    _createClass(ContentList, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$68.List, type && styles$68[variationName('type', type)]);
...
var Loading$5 = function (_React$PureComponent) {
    _inherits(Loading$$1, _React$PureComponent);

    function Loading$$1() {
        _classCallCheck(this, Loading$$1);

        return _possibleConstructorReturn(this, (Loading$$1.__proto__ || Object.getPrototypeOf(Loading$$1)).apply(this, arguments));
    }
...
Loading$5.contextTypes = frameContextTypes;
var Loading$6 = withAppProvider()(Loading$5);

// This path comment acts as a unique ID
// https://github.com/Shopify/sewing-kit/issues/590
// @polaris/components/Loading/index.ts
...
function Secondary$1(_ref) {
    ...
    return createElement(
        Collapsible$2,
        { id: secondaryNavigationId, open: expanded },
        createElement(
            'ul',
            { className: styles$69.List },
            children
        )
    );
}
...
var BaseItem = function (_React$Component) {
    ...
    function BaseItem() {
        ...
        var _this = _possibleConstructorReturn(this, (BaseItem.__proto__ || Object.getPrototypeOf(BaseItem)).apply(this, arguments));
    ...
    _createClass(BaseItem, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                label = _props.label,
                badge = _props.badge,
                _props$subNavigationI = _props.subNavigationItems,
                subNavigationItems = _props$subNavigationI === undefined ? [] : _props$subNavigationI,
                secondaryAction = _props.secondaryAction,
                disabled = _props.disabled,
                onClick = _props.onClick,
                accessibilityLabel = _props.accessibilityLabel,
                iconBody = _props.iconBody,
                isNew = _props.new,
                intl = _props.polaris.intl,
                selectedOverride = _props.selected;
            var _context = this.context,
                location = _context.location,
                onNavigationDismiss = _context.onNavigationDismiss;
            ...
            var indicatorMarkup = hasNewChild ? createElement(
                'span',
                { className: styles$69.Indicator },
                createElement(Indicator$1, { pulse: true })
            ) : null;
            var badgeMarkup = badge || isNew ? createElement(
                'div',
                { className: styles$69.Badge },
                createElement(
                    Badge$2,
                    { status: 'new', size: 'small' },
                    badge || intl.translate('Polaris.Badge.STATUS_LABELS.new')
                )
            ) : null;
            var iconMarkup = iconBody ? createElement('span', { className: styles$69.Icon, dangerouslySetInnerHTML: { __html: iconBody } }) : icon && createElement(
                'div',
                { className: styles$69.Icon },
                createElement(Icon$2, { source: icon })
            );
            var itemContentMarkup = createElement(
                Fragment,
                null,
                iconMarkup,
                createElement(
                    'span',
                    { className: styles$69.Text },
                    label,
                    indicatorMarkup
                ),
                badgeMarkup
            ...
            if (url == null) {
                var _className = classNames(styles$69.Item, disabled && styles$69['Item-disabled']);
                return createElement(
                    'li',
                    { className: styles$69.ListItem },
                    createElement(
                        'button',
                        { type: 'button', className: _className, disabled: disabled, 'aria-disabled': disabled, 'aria-label': accessibilityLabel, onClick: this.getClickHandler(onClick) },
                        itemContentMarkup
                    )
                );
            }
            var secondaryActionMarkup = secondaryAction && createElement(
                UnstyledLink$2,
                { external: true, url: secondaryAction.url, className: styles$69.SecondaryAction, tabIndex: tabIndex, 'aria-disabled': disabled, 'aria-label': secondaryAction.accessibilityLabel },
                createElement(Icon$2, { source: secondaryAction.icon })
            );
            ...
            var itemClassName = classNames(styles$69.Item, disabled && styles$69['Item-disabled'], selected && subNavigationItems.length === 0 && styles$69['Item-selected'], showExpanded && styles$69.subNavigationActive);
            ...
            if (subNavigationItems.length > 0 && showExpanded) {
                ...
                secondaryNavigationMarkup = createElement(
                    'div',
                    { className: styles$69.SecondaryNavigation },
                    createElement(
                        Secondary$1,
                        ...
                        subNavigationItems.map(function (item) {
                            ...
                            return createElement(Item$15, Object.assign({}, rest, { key: label, label: label, matches: item === longestMatch, onClick: onNavigationDismiss }));
                        })
                    )
                );
            }
            var className = classNames(styles$69.ListItem, secondaryAction && styles$69['ListItem-hasAction']);
            return createElement(
                'li',
                { className: className },
                createElement(
                    UnstyledLink$2,
                    { url: url, className: itemClassName, tabIndex: tabIndex, 'aria-disabled': disabled, 'aria-label': accessibilityLabel, onClick: this.getClickHandler(onClick) },
                    itemContentMarkup
                ),
                secondaryActionMarkup,
        ...
        value: function getClickHandler(onClick) {
            ...
            return function (event) {
                ...
                var _context2 = _this2.context,
                    location = _context2.location,
                    onNavigationDismiss = _context2.onNavigationDismiss;
...
var Item$15 = withAppProvider()(BaseItem);

var createAdditionalItemsId = createUniqueIDFactory('AdditionalItems');

var Section$11 = function (_React$Component) {
    ...
    _createClass(Section, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$69.Section, separator && styles$69['Section-withSeparator'], fill && styles$69['Section-fill']);
            var actionMarkup = action && createElement(
                'button',
                { type: 'button', className: styles$69.Action, 'aria-label': action.accessibilityLabel, onClick: action.onClick },
                createElement(Icon$2, { source: action.icon })
            );
            var sectionHeadingMarkup = title && createElement(
                'li',
                { className: styles$69.SectionHeading },
                createElement(
                    'span',
                    { className: styles$69.Text },
                    title
            ...
            var itemsMarkup = items.map(function (item) {
                ...
                return createElement(Item$15, Object.assign({}, rest, { key: label, label: label, onClick: _this2.handleClick(onClick) }));
            });
            var toggleClassName = classNames(styles$69.Item, styles$69.RollupToggle);
            var ariaLabel = rollup && (expanded ? rollup.hide : rollup.view);
            var toggleRollup = rollup && items.length > rollup.after && createElement(
                'div',
                { className: styles$69.ListItem, key: 'List Item' },
                createElement(
                    'button',
                    { type: 'button', className: toggleClassName, onClick: this.toggleViewAll, 'aria-label': ariaLabel },
                    createElement(
                        'span',
                        { className: styles$69.Icon },
                        createElement(Icon$2, { source: ellipsis })
                    ),
                    ariaLabel
                )
            );
            ...
            var activeItemsMarkup = rollup && additionalItems.length > 0 && createElement(
                'li',
                { className: styles$69.RollupSection },
                createElement(
                    Collapsible$2,
                    { id: additionalItemsId, open: expanded },
                    createElement(
                        'ul',
                        { className: styles$69.List },
                        additionalItems
        ...
        value: function handleClick(onClick) {
            ...
            return function () {
                ...
                _this3.animationFrame = requestAnimationFrame(function () {
                    return _this3.setState({ expanded: false });
                });
            };
        }
    }, {
...
Section$11.contextTypes = contextTypes$2;
__decorate([memoize()], Section$11.prototype, "handleClick", null);
__decorate([autobind], Section$11.prototype, "toggleViewAll", null);
...
function Message$1(_ref) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        Button$3,
        { onClick: action.onClick, plain: true },
        action.content
      )
    )
  );
...
function MessageIndicator$1(_ref) {
  var children = _ref.children,
      active = _ref.active;

  var indicatorMarkup = active && createElement('div', { className: styles$71.MessageIndicator });
  return createElement(
    'div',
    { className: styles$71.MessageIndicatorWrapper },
    indicatorMarkup,
    children
  );
}
...
var UserMenu$1 = function (_React$PureComponent) {
    ...
    _createClass(UserMenu, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                avatarInitials = _props.avatarInitials,
                avatarSource = _props.avatarSource,
                actions$$1 = _props.actions,
                message = _props.message;
            var userMenuExpanded = this.state.userMenuExpanded;

            var className = classNames(styles$72.UserMenu, userMenuExpanded && styles$72.expanded);
            var itemClassName = styles$72.Item;
            var tabIndex = userMenuExpanded ? 0 : -1;
            var itemsMarkup = actions$$1 && actions$$1.map(function (section) {
                return createElement(
                    'div',
                    { className: styles$72.Section, key: section.id },
                    section.items.map(function (item) {
                        var icon = item.icon;
                        return item.url ? createElement(
                            UnstyledLink$2,
                            { url: item.url, key: item.content, className: itemClassName, tabIndex: tabIndex, onClick: _this2.handleClick },
                            icon && createElement(
                                'span',
                                { className: styles$72.Icon },
                                createElement(Icon$2, { source: icon })
                            ),
                            item.content
                        ) : createElement(
                            'button',
                            { type: 'button', key: item.content, onClick: item.onAction ? _this2.createActionHandler(item.onAction) : _this2.handleClick, className: itemClassName, tabIndex: tabIndex },
                            item.icon && createElement(
                                'span',
                                { className: styles$72.Icon },
                                createElement(Icon$2, { source: item.icon })
                            ),
                            item.content
                        );
                    })
            ...
            var messageMarkup = message && createElement(
                'div',
                { className: styles$72.Section },
                createElement(Message$1, { title: message.title, description: message.description, action: {
            ...
            return createElement(
                ...
                createElement(
                    'button',
                    { type: 'button', className: styles$72.Button, onClick: this.handleClick, onMouseUp: handleMouseUp$1 },
                    createElement(
                        'span',
                        { className: styles$72.Avatar },
                        createElement(
                            MessageIndicator$1,
                            { active: showIndicator },
                            createElement(Avatar$2, { size: 'small', source: avatarSource, initials: avatarInitials && avatarInitials.replace(' ', '') })
                        )
                    ),
                    createElement(
                        'span',
                        { className: styles$72.Details },
                        createElement(
                            'span',
                            { className: styles$72.Name },
                            name
                        ),
                        createElement(
                            'span',
                            { className: styles$72.Detail },
                            detail
                        )
                    ),
                    createElement(
                        'span',
                        { className: styles$72.DisclosureIcon },
                        createElement(Icon$2, { source: 'chevronDown', color: 'inkLightest', accessibilityLabel: 'Show user menu' })
                    )
                ),
                createElement(
                    'div',
                    { className: styles$72.List, 'aria-hidden': !userMenuExpanded },
                    itemsMarkup,
                    messageMarkup
                )
            );
...
__decorate([memoize()], UserMenu$1.prototype, "createActionHandler", null);
__decorate([autobind], UserMenu$1.prototype, "handleClick", null);
...
var Navigation$4 = function (_React$Component) {
    ...
    _createClass(Navigation, [{
        ...
        value: function render() {
            ...
            return createElement(
                'nav',
                { className: styles$69.Navigation },
                createElement(
                    'div',
                    { className: styles$69.UserMenu },
                    userMenu
                ),
                createElement(
                    Scrollable$2,
                    { className: styles$69.PrimaryNavigation },
                    children
                )
            );
        }
...
Navigation$4.Item = Item$15;
Navigation$4.UserMenu = UserMenu$1;
Navigation$4.Section = Section$11;
Navigation$4.childContextTypes = contextTypes$2;
...
var TooltipOverlay$1 = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderTooltip(overlayDetails) {
            ...
            var containerClassName = classNames(styles$73.Tooltip, light && styles$73.light, measuring && styles$73.measuring, positioning === 'above' && styles$73.positionedAbove);
            ...
            return createElement(
                ...
                createElement(
                    'div',
                    { className: styles$73.Wrapper },
                    createElement(
                        'div',
                        { id: id, role: 'tooltip', className: styles$73.Content, style: contentStyles },
                        children
                    )
                )
            );
...
__decorate([autobind], TooltipOverlay$1.prototype, "renderOverlay", null);
__decorate([autobind], TooltipOverlay$1.prototype, "renderTooltip", null);

var getUniqueID$10 = createUniqueIDFactory('TooltipContent');
    ...
    _createClass(Tooltip, [{
        ...
        value: function render() {
            ...
            var portal = activatorNode ? createElement(
                ...
                createElement(
                    TooltipOverlay$1,
                    { id: id, preferredPosition: preferredPosition, activator: activatorNode, active: active, onClose: noop, light: light },
                    createElement(
                        'div',
                        { className: styles$73.Label },
                        content
                    )
                )
            ) : null;
...
function Pagination$1(_ref) {
    ...
    var className = classNames$1(styles$74.Pagination, plain && styles$74.plain);
    var previousButton = previousURL ? createElement(
        UnstyledLink$2,
        { className: styles$74.Button, url: previousURL, onMouseUp: handleMouseUpByBlurring, 'aria-label': intl.translate('Polaris.Pagination.previous'), id: 'previousURL' },
        createElement(Icon$2, { source: 'arrowLeft' })
    ) : createElement(
        'button',
        { onClick: onPrevious, type: 'button', onMouseUp: handleMouseUpByBlurring, className: styles$74.Button, 'aria-label': intl.translate('Polaris.Pagination.previous'), disabled: !hasPrevious },
        createElement(Icon$2, { source: 'arrowLeft' })
    );
    var nextButton = nextURL ? createElement(
        UnstyledLink$2,
        { className: styles$74.Button, url: nextURL, onMouseUp: handleMouseUpByBlurring, 'aria-label': intl.translate('Polaris.Pagination.next'), id: 'nextURL' },
        createElement(Icon$2, { source: 'arrowRight' })
    ) : createElement(
        'button',
        { onClick: onNext, type: 'button', onMouseUp: handleMouseUpByBlurring, className: styles$74.Button, 'aria-label': intl.translate('Polaris.Pagination.next'), disabled: !hasNext },
        createElement(Icon$2, { source: 'arrowRight' })
    );
    var constructedPrevious = previousTooltip ? createElement(
        Tooltip$1,
        { content: previousTooltip },
        previousButton
    ) : previousButton;
    var constructedNext = nextTooltip ? createElement(
        Tooltip$1,
        { content: nextTooltip },
        nextButton
    ) : nextButton;
    var previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map(function (key) {
        return createElement(KeypressListener$1, { key: key, keyCode: key, handler: previousURL ? handleCallback(clickPaginationLink('previousURL', node)) : handleCallback(onPrevious) });
    });
    var nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map(function (key) {
        return createElement(KeypressListener$1, { key: key, keyCode: key, handler: nextURL ? handleCallback(clickPaginationLink('nextURL', node)) : handleCallback(onNext) });
    });
    return createElement(
        'nav',
        { className: className, 'aria-label': label, ref: node },
...
function Action(_ref) {
  ...
  var iconMarkup = icon && createElement(
    'span',
    { className: styles$75.ActionIcon },
    createElement(Icon$2, { source: icon })
  );
  var disclosureIconMarkup = disclosure && createElement(
    'span',
  ...
  var contentMarkup = iconMarkup || disclosureIconMarkup ? createElement(
    'span',
    { className: styles$75.ActionContent },
    iconMarkup,
    createElement(
      'span',
      null,
  ...
  if (url) {
    return createElement(
      UnstyledLink$2,
      { key: children, external: external, url: url, onMouseUp: handleMouseUpByBlurring, className: styles$75.Action, 'aria-label': accessibilityLabel },
      contentMarkup
    );
  }
  var className = classNames$1(styles$75.Action, disabled && styles$75.disabled, icon && children == null && styles$75.iconOnly);
  return createElement(
    'button',
...
var ActionGroup = function (_React$Component) {
    ...
    _createClass(ActionGroup, [{
        ...
        value: function render() {
            ...
            var detailsMarkup = details && createElement(
                'div',
                { className: styles$76.Details },
                details
            );
            return createElement(
                'div',
                { className: styles$76.ActionGroup, key: 'ActionGroup-' + title },
                createElement(
                    Popover$1,
                    { key: title, active: active, onClose: this.handleClose, activator: createElement(
                            Action,
                            { disclosure: true, icon: icon, onAction: this.handleOpen },
                            title
                        ) },
                    createElement(ActionList$1, { items: actions$$1, onActionAnyItem: this.handleClose }),
                    detailsMarkup
                )
            );
        }
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                secondaryActions = _props.secondaryActions,
                icon = _props.icon,
                actionGroups = _props.actionGroups,
                intl = _props.polaris.intl;
            ...
            var className = classNames(styles$77.Header, titleHidden && styles$77['Title-hidden'], pagination && styles$77['Header-hasPagination'], separator && styles$77['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$77['Header-hasBreadcrumbs'], this.hasRollup && styles$77['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$77['Header-hasSecondaryActions']);
            ...
            var primaryActionMarkup = primaryAction ? createElement(
                'div',
                { className: styles$77.PrimaryAction },
                buttonsFrom(primaryAction, { primary: primary })
            ) : null;
            var paginationMarkup = pagination ? createElement(
                'div',
                { className: styles$77.Pagination },
                createElement(Pagination$2, Object.assign({}, pagination, { plain: true }))
            ) : null;
            var nonPrimaryActionsMarkup = this.renderSecondaryActions();
            var actionsMarkup = primaryAction || secondaryActions || actionGroups ? createElement(
                'div',
                { className: styles$77.Actions },
                primaryActionMarkup,
                nonPrimaryActionsMarkup
            ) : null;
            var navigationMarkup = breadcrumbMarkup || paginationMarkup ? createElement(
                'div',
                { className: styles$77.Navigation },
                breadcrumbMarkup,
                paginationMarkup
            ) : null;
            var titleMarkup = createElement(
                'div',
                { className: styles$77.Title },
                createElement(
                    'div',
                    null,
                    createElement(
            ...
            return primaryActionMarkup ? createElement(
                ...
                createElement(
                    'div',
                    { className: styles$77.MainContent },
                    createElement(
                        'div',
                        { className: styles$77.TitleAndActions },
                        titleMarkup,
                        actionsMarkup
                    ),
                    primaryActionMarkup
        ...
        value: function renderSecondaryActions() {
            ...
            var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref, index) {
                ...
                return createElement(
                    'div',
                    { className: styles$77.IndividualAction, key: 'ActionGroup-' + title + '-' + index },
                    createElement(ActionGroup, { title: title, icon: icon, actions: actions$$1, details: details, onOpen: _this2.handleActionGroupOpen, onClose: _this2.handleActionGroupClose, active: title === openActionGroup })
                );
            }) : null;
            var rollupMarkup = this.hasRollup ? createElement(
                'div',
                { className: styles$77.Rollup },
                createElement(
                    Popover$1,
            ...
            return createElement(
                'div',
                { className: styles$77.SecondaryActions },
                rollupMarkup,
                createElement(
                    'div',
                    { className: styles$77.IndividualActions },
                    secondaryActionMarkup,
                    actionGroupsMarkup
                )
            );
...
__decorate([autobind], Header$4.prototype, "handleRollupToggle", null);
__decorate([autobind], Header$4.prototype, "handleActionGroupClose", null);
__decorate([autobind], Header$4.prototype, "handleActionGroupOpen", null);
function convertActionGroupToActionListSection(_ref4) {
    var title = _ref4.title,
        actions$$1 = _ref4.actions;

    return { title: title, items: actions$$1 };
}
function secondaryActionsFrom(actions$$1) {
    return actions$$1.map(function (_a, index) {
        ...
        return createElement(
            'div',
            { className: styles$77.IndividualAction, key: 'Action-' + (content || index) },
            createElement(
                Action,
                action,
                content
...
var Header$5 = withAppProvider()(Header$4);
...
var Page = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$78.Page, fullWidth && styles$78.fullWidth, singleColumn && styles$78.singleColumn);
            var headerMarkup = this.props.polaris.appBridge || this.hasHeaderContent() === false ? null : createElement(Header$5, rest);
            return createElement(
                'div',
                { className: className },
                headerMarkup,
        ...
        value: function transformProps() {
            ...
            var _props2 = this.props,
                ...
                primaryAction = _props2.primaryAction,
                secondaryActions = _props2.secondaryActions,
                actionGroups = _props2.actionGroups;
...
function PageActions$1(_ref) {
  ...
  return createElement(
    'div',
    { className: styles$79.PageActions },
    createElement(
      Stack$1,
...
var getUniqueID$11 = createUniqueIDFactory('RangeSlider');
...
var RangeSlider$1 = function (_React$PureComponent) {
    ...
    _createClass(RangeSlider, [{
        ...
        value: function render() {
            ...
            var outputMarkup = !disabled && output && createElement(
                'output',
                { htmlFor: id, className: styles$80.Output },
                createElement(
                    'div',
                    { className: styles$80.OutputBubble },
                    createElement(
                        'span',
                        { className: styles$80.OutputText },
                        value
                    )
                )
            );
            var prefixMarkup = prefix && createElement(
                'div',
                { className: styles$80.Prefix },
                prefix
            );
            var suffixMarkup = suffix && createElement(
                'div',
                { className: styles$80.Suffix },
                suffix
            );
            var className = classNames(styles$80.RangeSlider, error && styles$80.error, disabled && styles$80.disabled);
            return createElement(
                Labelled$1,
                { id: id, label: label, error: error, action: labelAction, labelHidden: labelHidden, helpText: helpText },
                createElement(
                    'div',
                    { className: className, style: cssVars },
                    prefixMarkup,
                    createElement(
                        'div',
                        { className: styles$80.InputWrapper },
                        createElement('input', { type: 'range', className: styles$80.Input, id: id, name: id, min: min, max: max, step: step, value: value, disabled: disabled, onChange: this.handleChange, onFocus: onFocus, onBlur: onBlur, 'aria-valuemin': min, 'aria-valuemax': max, 'aria-valuenow': value, 'aria-invalid': Boolean(error), 'aria-describedby': ariaDescribedBy }),
                        outputMarkup
                    ),
                    suffixMarkup
                )
...
__decorate([autobind], RangeSlider$1.prototype, "handleChange", null);
...
var RangeSlider$2 = withAppProvider()(RangeSlider$1);
    ...
    _createClass(Sticky, [{
        ...
        value: function render() {
            ...
            return createElement(
                'div',
                null,
                createElement('div', { ref: this.setPlaceHolderNode }),
                createElement(
                    'div',
                    { ref: this.setStickyNode, style: style },
                    childrenContent
                )
            );
        }
...
__decorate([autobind], Sticky$1.prototype, "setPlaceHolderNode", null);
__decorate([autobind], Sticky$1.prototype, "setStickyNode", null);
__decorate([autobind], Sticky$1.prototype, "handlePositioning", null);
__decorate([autobind], Sticky$1.prototype, "adjustPlaceHolderNode", null);
...
var getUniqueID$13 = createUniqueIDFactory('Select');
function Select$1(_ref) {
    var optionsProp = _ref.options,
        ...
        _ref$id = _ref.id,
        id = _ref$id === undefined ? getUniqueID$13() : _ref$id,
        name = _ref.name,
    ...
    var className = classNames(styles$81.Select, error && styles$81.error, disabled && styles$81.disabled);
    ...
    var inlineLabelMarkup = labelInline && createElement(
        'span',
        { className: styles$81.InlineLabel },
        label
    );
    var selectedOption = getSelectedOption(normalizedOptions, value);
    var contentMarkup = createElement(
        'div',
        { className: styles$81.Content, 'aria-hidden': true },
        inlineLabelMarkup,
        createElement(
            'span',
            { className: styles$81.SelectedOption },
            selectedOption
        ),
        createElement(
            'span',
            { className: styles$81.Icon },
            createElement(Icon$2, { source: 'arrowUpDown' })
        )
    );
    ...
    return createElement(
        ...
        createElement(
            ...
            createElement(
                'select',
                { id: id, name: name, value: value, className: styles$81.Input, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: handleChange, 'aria-invalid': Boolean(error), 'aria-describedby': describedBy.length ? describedBy.join(' ') : undefined },
                optionsMarkup
            ),
            contentMarkup,
            createElement('div', { className: styles$81.Backdrop })
        )
    );
}
...
function CheckableButton$1(_ref) {
    ...
    var className = plain ? classNames(styles$82.CheckableButton, styles$82['CheckableButton-plain']) : classNames(styles$82.CheckableButton, selectMode && styles$82['CheckableButton-selectMode'], selected && styles$82['CheckableButton-selected'], measuring && styles$82['CheckableButton-measuring']);
    return createElement(
        'div',
        { className: className, onClick: onToggleAll },
        createElement(
            'div',
            { className: styles$82.Checkbox },
            createElement(Checkbox$4, { label: accessibilityLabel, labelHidden: true, checked: selected, disabled: disabled })
        ),
        createElement(
            'span',
            { className: styles$82.Label },
            label
        )
    );
}
...
var BulkActionButton$1 = function (_React$PureComponent) {
    ...
    _createClass(BulkActionButton, [{
        ...
        value: function render() {
            ...
            var disclosureIconMarkup = disclosure ? createElement(
                'span',
                { className: styles$83.ActionIcon },
                createElement(Icon$2, { source: 'caretDown' })
            ) : null;
            var contentMarkup = disclosureIconMarkup ? createElement(
                'span',
                { className: styles$83.ActionContent },
                createElement(
                    'span',
                    null,
                    content
            ...
            if (url) {
                return createElement(
                    UnstyledLink$2,
                    { external: external, url: url, onMouseUp: handleMouseUpByBlurring, className: styles$83.Button, 'aria-label': accessibilityLabel },
                    contentMarkup
                );
            }
            var className = classNames$1(styles$83.Button, disabled && styles$83.disabled);
            return createElement(
                'button',
                { className: className, onClick: onAction, onMouseUp: handleMouseUpByBlurring, 'aria-label': accessibilityLabel, type: 'button', disabled: disabled },
                contentMarkup
            );
        }
    }]);
...
var slideClasses = {
    appear: classNames(styles$83.Slide, styles$83['Slide-appear']),
    appearActive: classNames(styles$83.Slide, styles$83['Slide-appearing']),
    enter: classNames(styles$83.Slide, styles$83['Slide-enter']),
    enterActive: classNames(styles$83.Slide, styles$83['Slide-entering']),
    exit: classNames(styles$83.Slide, styles$83['Slide-exit'])
};
var BulkActions$1 = function (_React$PureComponent) {
    ...
    _createClass(BulkActions, [{
        ...
        value: function render() {
            ...
            var paginatedSelectAllActionMarkup = paginatedSelectAllAction ? createElement(
                Button$3,
                { onClick: paginatedSelectAllAction.onAction, plain: true, disabled: disabled },
                paginatedSelectAllAction.content
            ) : null;
            var paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? createElement(
                'span',
                { 'aria-live': 'polite' },
                paginatedSelectAllText
            ) : paginatedSelectAllText;
            var paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? createElement(
                'div',
                { className: styles$83.PaginatedSelectAll },
                paginatedSelectAllTextMarkup,
                ' ',
                paginatedSelectAllActionMarkup
            ) : null;
            var cancelButtonClassName = classNames(styles$83.Button, styles$83['Button-cancel']);
            ...
            var allActionsPopover = this.hasActions ? createElement(
                'div',
                { className: styles$83.Popover, ref: this.setMoreActionsNode },
                createElement(
                    Popover$1,
                    { active: smallScreenPopoverVisible, activator: createElement(BulkActionButton$1, { disclosure: true, onAction: this.toggleSmallScreenPopover, content: intl.translate('Polaris.ResourceList.BulkActions.actionsActivatorLabel') }), onClose: this.toggleSmallScreenPopover },
                    createElement(ActionList$1, { items: promotedActions, sections: this.actionSections, onActionAnyItem: this.toggleSmallScreenPopover })
                )
            ) : null;
            var promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [].concat(_toConsumableArray(promotedActions)).slice(0, numberOfPromotedActionsToRender).map(function (action, index) {
                return createElement(BulkActionButton$1, Object.assign({}, action, { key: index, handleMeasurement: _this2.handleMeasurement }));
            }) : null;
            ...
            var actionsPopover = this.actionSections || rolledInPromotedActions.length > 0 || measuring ? createElement(
                'div',
                { className: styles$83.Popover, ref: this.setMoreActionsNode },
                createElement(
                    Popover$1,
                    { active: largeScreenPopoverVisible, activator: createElement(BulkActionButton$1, { disclosure: true, onAction: this.toggleLargeScreenPopover, content: activatorLabel, disabled: disabled }), onClose: this.toggleLargeScreenPopover },
                    createElement(ActionList$1, { sections: combinedActions, onActionAnyItem: this.toggleLargeScreenPopover })
                )
            ) : null;
            ...
            var smallScreenGroup = createElement(
                Transition,
                { timeout: 0, 'in': selectMode, key: 'smallGroup' },
                function (status) {
                    var smallScreenGroupClassName = classNames(styles$83.Group, styles$83['Group-smallScreen'], styles$83['Group-' + status]);
                    return createElement(
                        'div',
                        { className: smallScreenGroupClassName },
                        createElement(
                            'div',
                            { className: styles$83.ButtonGroup },
                            createElement(
                                CSSTransition,
                                { 'in': selectMode, timeout: Duration.Base, classNames: slideClasses, appear: true },
                                createElement(CheckableButton$2, checkableButtonProps)
                            ),
                            allActionsPopover,
                            cancelButton
                        ),
            ...
            var largeScreenGroup = createElement(
                Transition,
                { timeout: 0, 'in': selectMode, key: 'largeGroup' },
                function (status) {
                    var largeScreenGroupClassName = classNames(styles$83.Group, styles$83['Group-largeScreen'], !measuring && styles$83['Group-' + status], measuring && styles$83['Group-measuring']);
                    return createElement(
                        'div',
                        { className: largeScreenGroupClassName },
                        createElement(EventListener$1, { event: 'resize', handler: _this2.handleResize }),
                        createElement(
                            'div',
                            { className: styles$83.ButtonGroup, ref: _this2.setLargeScreenButtonsNode },
                            createElement(CheckableButton$2, checkableButtonProps),
...
__decorate([autobind], BulkActions$1.prototype, "setLargeScreenButtonsNode", null);
__decorate([autobind], BulkActions$1.prototype, "setContainerNode", null);
__decorate([autobind], BulkActions$1.prototype, "setMoreActionsNode", null);
__decorate([autobind], BulkActions$1.prototype, "setSelectMode", null);
__decorate([autobind], BulkActions$1.prototype, "toggleSmallScreenPopover", null);
__decorate([autobind], BulkActions$1.prototype, "toggleLargeScreenPopover", null);
__decorate([autobind, debounce(50, { trailing: true })], BulkActions$1.prototype, "handleResize", null);
__decorate([autobind], BulkActions$1.prototype, "handleMeasurement", null);
...
function Tag$1(_ref) {
  ...
  var className = classNames$1(disabled && styles$84.disabled, styles$84.Tag);
  ...
  return createElement(
    ...
    createElement(
      'span',
      { title: children, className: styles$84.TagText },
      children
    ),
    createElement(
      'button',
      { type: 'button', 'aria-label': ariaLabel, className: styles$84.Button, onClick: onRemove, onMouseUp: handleMouseUpByBlurring, disabled: disabled },
      createElement(Icon$2, { source: 'cancelSmall' })
    )
  );
}
...
var DateSelector$1 = function (_React$PureComponent) {
    ...
    _createClass(DateSelector, [{
        ...
        value: function render() {
            ...
            var datePredicateMarkup = showDatePredicate && createElement(
                Fragment,
                null,
                createElement(
                    'div',
                    { className: styles$85.DateTextField },
                    createElement(TextField$5, { label: intl.translate('Polaris.ResourceList.DateSelector.dateValueLabel'), placeholder: intl.translate('Polaris.ResourceList.DateSelector.dateValuePlaceholder'), value: this.dateTextFieldValue, error: userInputDateError, prefix: createElement(Icon$2, { source: 'calendar', color: 'skyDark' }), autoComplete: false, onChange: this.handleDateFieldChange, onBlur: this.handleDateBlur })
                ),
                createElement(
                    'div',
                    { className: styles$85.DatePicker },
                    createElement(DatePicker$2, { selected: selectedDate, month: datePickerMonth, year: datePickerYear, onChange: this.handleDatePickerChange, onMonthChange: this.handleDatePickerMonthChange })
                )
            );
            return createElement(
                Fragment,
                null,
                createElement(Select$1, { label: intl.translate('Polaris.ResourceList.DateSelector.SelectOptions.dateFilterLabel'), labelHidden: true, options: dateOptionType ? this.dateOptionTypes[dateOptionType] : this.dateOptionTypes.full, placeholder: intl.translate('Polaris.ResourceList.FilterValueSelector.selectFilterValuePlaceholder'), value: dateFilterOption, onChange: this.handleDateFilterOptionsChange }),
                datePredicateMarkup
            );
        }
    }, {
...
__decorate([autobind], DateSelector$1.prototype, "handleDateFilterOptionsChange", null);
__decorate([autobind], DateSelector$1.prototype, "handleDateFieldChange", null);
__decorate([autobind], DateSelector$1.prototype, "handleDateBlur", null);
__decorate([autobind], DateSelector$1.prototype, "handleDatePickerChange", null);
__decorate([autobind], DateSelector$1.prototype, "handleDatePickerMonthChange", null);
...
var FilterValueSelector$1 = function (_React$PureComponent) {
    ...
    _createClass(FilterValueSelector, [{
        ...
        value: function render() {
            ...
            var operatorOptionsMarkup = showOperatorOptions ? createElement(Select$1, { label: filter.label, labelHidden: true, options: buildOperatorOptions(operatorText), value: filterKey, onChange: this.handleOperatorOptionChange }) : null;
            ...
            switch (filter.type) {
                case FilterType.Select:
                    return createElement(
                        ...
                        createElement(Select$1, { label: selectedFilterLabel, options: filter.options, placeholder: intl.translate('Polaris.ResourceList.FilterValueSelector.selectFilterValuePlaceholder'), value: value, onChange: onChange })
                    );
                case FilterType.TextField:
                    return createElement(
                        ...
                        { vertical: true },
                        operatorOptionsMarkup,
                        createElement(TextField$5, { label: selectedFilterLabel, value: value, type: filter.textFieldType, onChange: onChange })
                    );
                case FilterType.DateSelector:
                    return createElement(DateSelector$2, { dateOptionType: filter.dateOptionType, filterValue: value, filterKey: filterKey, filterMinKey: filter.minKey, filterMaxKey: filter.maxKey, onFilterValueChange: onChange, onFilterKeyChange: onFilterKeyChange });
                default:
                    return null;
            }
        }
...
__decorate([autobind], FilterValueSelector$1.prototype, "handleOperatorOptionChange", null);
    ...
    _createClass(FilterCreator, [{
        ...
        value: function render() {
            ...
            var activator = createElement(
                Button$3,
                { onClick: this.togglePopover, disclosure: true, disabled: disabled, onFocus: this.handleButtonFocus },
            ...
            var filterValueSelectionMarkup = selectedFilter ? createElement(FilterValueSelector$2, { filter: selectedFilter, filterKey: selectedFilterKey, value: selectedFilterValue, onFilterKeyChange: this.handleFilterKeyChange, onChange: this.handleFilterValueChange }) : null;
            var addFilterButtonMarkup = selectedFilter ? createElement(
                Button$3,
                { onClick: this.handleAddFilter, disabled: !this.canAddFilter },
                intl.translate('Polaris.ResourceList.FilterCreator.addFilterButtonLabel')
            ) : null;
            return createElement(
                Popover$1,
                { active: popoverActive, activator: activator, onClose: this.togglePopover, sectioned: true, fullHeight: true },
                createElement(
                    Form$1,
...
__decorate([autobind], FilterCreator$1.prototype, "handleButtonFocus", null);
__decorate([autobind], FilterCreator$1.prototype, "togglePopover", null);
__decorate([autobind], FilterCreator$1.prototype, "handleFilterKeyChange", null);
__decorate([autobind], FilterCreator$1.prototype, "handleFilterValueChange", null);
__decorate([autobind], FilterCreator$1.prototype, "handleAddFilter", null);
...
var FilterControl$1 = function (_React$Component) {
    ...
    _createClass(FilterControl, [{
        ...
        value: function render() {
            ...
            var filterCreatorMarkup = filters.length > 0 ? createElement(FilterCreator$2, { resourceName: resourceName, filters: filters, onAddFilter: this.handleAddFilter, disabled: selectMode }) : null;
            var appliedFiltersMarkup = appliedFilters.map(function (appliedFilter) {
                ...
                return createElement(
                    'li',
                    { className: styles$86.AppliedFilter, key: filterId },
                    createElement(
                        Tag$2,
                        { onRemove: _this2.getRemoveFilterCallback(filterId), disabled: selectMode },
                        activeFilterLabel
                    )
                );
            });
            var appliedFiltersWrapper = appliedFilters.length > 0 ? createElement(
                'ul',
                { className: styles$86.AppliedFilters },
                appliedFiltersMarkup
            ) : null;
            return createElement(
                FormLayout$1,
                null,
                createElement(TextField$5, { connectedLeft: filterCreatorMarkup, connectedRight: additionalActionButton, label: textFieldLabel, labelHidden: true, placeholder: textFieldLabel, prefix: createElement(Icon$2, { source: 'search', color: 'skyDark' }), value: searchValue, onChange: onSearchChange, onBlur: onSearchBlur, focused: focused, disabled: selectMode }),
...
__decorate([autobind], FilterControl$1.prototype, "handleAddFilter", null);
__decorate([memoize()], FilterControl$1.prototype, "getRemoveFilterCallback", null);
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            if (selectable) {
                ...
                handleMarkup = createElement(
                    'div',
                    { className: styles$87.Handle, onClick: this.handleLargerSelectionArea },
                    createElement(
                        'div',
                        { onClick: stopPropagation, className: styles$87.CheckboxWrapper },
                        createElement(Checkbox$4, { id: this.checkboxId, label: label, labelHidden: true, onChange: this.handleSelection, checked: selected, disabled: loading })
                    )
                );
            }
            if (media || selectable) {
                ownedMarkup = createElement(
                    'div',
                    { className: styles$87.Owned },
                    handleMarkup,
                    mediaMarkup
                );
            }
            var className = classNames(styles$87.Item, focused && styles$87.focused, selectable && styles$87.selectable, selected && styles$87.selected, selectMode && styles$87.selectMode, persistActions && styles$87.persistActions, focusedInner && styles$87.focusedInner);
            ...
            if (shortcutActions) {
                if (persistActions) {
                    actionsMarkup = createElement(
                        'div',
                        { className: styles$87.Actions, onClick: stopPropagation },
                        createElement(
                            ButtonGroup$2,
                            null,
                    ...
                    disclosureMarkup = createElement(
                        'div',
                        { className: styles$87.Disclosure, onClick: stopPropagation },
                        createElement(
                            Popover$1,
                            { activator: createElement(Button$3, { 'aria-label': intl.translate('Polaris.ResourceList.Item.actionsDropdown'), onClick: this.handleActionsClick, plain: true, icon: 'horizontalDots' }), onClose: this.handleCloseRequest, active: actionsMenuVisible },
                            createElement(ActionList$1, { items: shortcutActions })
                        )
                    );
                } else {
                    actionsMarkup = createElement(
            ...
            var content = children ? createElement(
                'div',
                { className: styles$87.Content },
                children
            ) : null;
            var containerMarkup = createElement(
                'div',
                { className: styles$87.Container, id: this.props.id },
                ownedMarkup,
                content,
                actionsMarkup,
                disclosureMarkup
            );
            var accessibleMarkup = url ? createElement(UnstyledLink$2, { 'aria-describedby': this.props.id, 'aria-label': accessibilityLabel, className: styles$87.Link, url: url, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur }) : createElement('button', { className: styles$87.Button, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, onClick: this.handleClick, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur });
            return createElement(
                'div',
                { ref: this.setNode, className: className, onClick: this.handleClick, onFocus: this.handleFocus, onBlur: this.handleBlur, onMouseDown: this.handleMouseDown, onKeyUp: this.handleKeypress },
                accessibleMarkup,
                containerMarkup
            );
        }
        ...
        value: function handleKeypress(event) {
            var _props4 = this.props,
                ...
                onClick = _props4$onClick === undefined ? noop : _props4$onClick,
...
__decorate([autobind], Item$18.prototype, "setNode", null);
__decorate([autobind], Item$18.prototype, "handleAnchorFocus", null);
__decorate([autobind], Item$18.prototype, "handleFocusedBlur", null);
__decorate([autobind], Item$18.prototype, "handleFocus", null);
__decorate([autobind], Item$18.prototype, "handleBlur", null);
__decorate([autobind], Item$18.prototype, "handleMouseDown", null);
__decorate([autobind], Item$18.prototype, "handleLargerSelectionArea", null);
__decorate([autobind], Item$18.prototype, "handleSelection", null);
__decorate([autobind], Item$18.prototype, "handleClick", null);
__decorate([autobind], Item$18.prototype, "handleKeypress", null);
__decorate([autobind], Item$18.prototype, "handleActionsClick", null);
__decorate([autobind], Item$18.prototype, "handleCloseRequest", null);
function stopPropagation(event) {
    event.stopPropagation();
}
var Item$19 = compose(withContext$1(Consumer$2), withAppProvider())(Item$18);
...
var getUniqueID$12 = createUniqueIDFactory('Select');
var ResourceList$1 = function (_React$Component) {
    ...
    _createClass(ResourceList, [{
        ...
        value: function render() {
            ...
            var filterControlMarkup = filterControl ? createElement(
                'div',
                { className: styles$88.FiltersWrapper },
                filterControl
            ) : null;
            var bulkActionsMarkup = this.selectable ? createElement(
                'div',
                { className: styles$88.BulkActionsWrapper },
                createElement(BulkActions$2, { label: this.bulkActionsLabel, accessibilityLabel: this.bulkActionsAccessibilityLabel, selected: this.bulkSelectState, onToggleAll: this.handleToggleAll, selectMode: selectMode, onSelectModeToggle: this.handleSelectMode, promotedActions: promotedBulkActions, paginatedSelectAllAction: this.paginatedSelectAllAction, paginatedSelectAllText: this.paginatedSelectAllText, actions: bulkActions, disabled: loading }),
                createElement(EventListener$1, { event: 'resize', handler: this.handleResize })
            ) : null;
            var selectId = getUniqueID$12();
            var sortingLabelMarkup = createElement(
                'label',
                { className: styles$88.SortLabel, htmlFor: selectId },
                intl.translate('Polaris.ResourceList.sortingLabel')
            );
            var sortingSelectMarkup = sortOptions && sortOptions.length > 0 ? createElement(
                'div',
                { className: styles$88.SortWrapper },
                sortingLabelMarkup,
                createElement(Select$1, { label: intl.translate('Polaris.ResourceList.sortingLabel'), labelHidden: true, options: sortOptions, onChange: onSortChange, value: sortValue, disabled: selectMode })
            ) : null;
            var headerTitleMarkup = createElement(
                'div',
                { className: styles$88.HeaderTitleWrapper },
                this.headerTitle
            );
            var selectButtonMarkup = this.selectable ? createElement(
                'div',
                { className: styles$88.SelectButtonWrapper },
                createElement(
                    Button$3,
            ...
            var checkableButtonMarkup = this.selectable ? createElement(
                'div',
                { className: styles$88.CheckableButtonWrapper },
                createElement(CheckableButton$2, { accessibilityLabel: this.bulkActionsAccessibilityLabel, label: this.headerTitle, onToggleAll: this.handleToggleAll, plain: true, disabled: loading })
            ) : null;
            var needsHeader = this.selectable || sortOptions && sortOptions.length > 0;
            var headerWrapperOverlay = loading ? createElement('div', { className: styles$88['HeaderWrapper-overlay'] }) : null;
            var headerMarkup = (showHeader || needsHeader) && listNode && createElement(
                'div',
                { className: styles$88.HeaderOuterWrapper },
                createElement(
                    Sticky$1,
                    { boundingElement: listNode },
                    function (isSticky) {
                        var headerClassName = classNames(styles$88.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$88['HeaderWrapper-hasSort'], _this3.selectable && styles$88['HeaderWrapper-hasSelect'], loading && styles$88['HeaderWrapper-disabled'], _this3.selectable && selectMode && styles$88['HeaderWrapper-inSelectMode'], isSticky && styles$88['HeaderWrapper-isSticky']);
                        return createElement(
                            'div',
                            ...
                            createElement(
                                'div',
                                { className: styles$88.HeaderContentWrapper },
                                headerTitleMarkup,
            ...
            var emptyStateMarkup = filterControl && !itemsExist && !loading ? createElement(
                'div',
                { className: styles$88.EmptySearchResultWrapper },
                createElement(EmptySearchResult$2, Object.assign({}, this.emptySearchResultText, { withIllustration: true }))
            ) : null;
            ...
            var loadingOverlay = loading ? createElement(
                Fragment,
                null,
                createElement(
                    'div',
                    { className: styles$88.SpinnerContainer, style: spinnerStyle },
                    createElement(Spinner$2, { size: spinnerSize, accessibilityLabel: 'Items are loading' })
                ),
                createElement('div', { className: styles$88.LoadingOverlay })
            ) : null;
            var className = classNames(styles$88.ItemWrapper, loading && styles$88['ItemWrapper-isLoading']);
            var loadingWithoutItemsMarkup = loading && !itemsExist ? createElement(
                'div',
                { className: className, tabIndex: -1 },
                loadingOverlay
            ) : null;
            var resourceListClassName = classNames(styles$88.ResourceList, loading && styles$88.disabledPointerEvents);
            var listMarkup = itemsExist ? createElement(
                'ul',
                { className: resourceListClassName, ref: this.listRef, 'aria-live': 'polite', 'aria-busy': loading },
                loadingOverlay,
            ...
            return createElement(
                ...
                createElement(
                    'div',
                    { className: styles$88.ResourceListWrapper },
                    filterControlMarkup,
                    headerMarkup,
                    listMarkup,
        ...
        value: function renderItem(item, index) {
            ...
            return createElement(
                'li',
                { key: id, className: styles$88.ItemWrapper, tabIndex: tabIndex },
                renderItem(item, id)
            );
        }
    }, {
...
ResourceList$1.Item = Item$19;
ResourceList$1.FilterControl = FilterControl$2;
__decorate([autobind], ResourceList$1.prototype, "bulkSelectState", null);
__decorate([autobind], ResourceList$1.prototype, "headerTitle", null);
__decorate([autobind], ResourceList$1.prototype, "bulkActionsLabel", null);
__decorate([autobind], ResourceList$1.prototype, "bulkActionsAccessibilityLabel", null);
__decorate([autobind], ResourceList$1.prototype, "paginatedSelectAllText", null);
__decorate([autobind], ResourceList$1.prototype, "paginatedSelectAllAction", null);
__decorate([debounce(50), autobind], ResourceList$1.prototype, "handleResize", null);
__decorate([autobind], ResourceList$1.prototype, "setLoadingPosition", null);
__decorate([autobind], ResourceList$1.prototype, "handleSelectAllItemsInStore", null);
__decorate([autobind], ResourceList$1.prototype, "renderItem", null);
__decorate([autobind], ResourceList$1.prototype, "handleSelectionChange", null);
__decorate([autobind], ResourceList$1.prototype, "handleSelectMode", null);
__decorate([autobind], ResourceList$1.prototype, "handleToggleAll", null);
...
var ResourceList$2 = withAppProvider()(ResourceList$1);
...
var ResourcePicker$2 = function (_React$PureComponent) {
    ...
    function ResourcePicker$$1() {
        ...
        var _this = _possibleConstructorReturn(this, (ResourcePicker$$1.__proto__ || Object.getPrototypeOf(ResourcePicker$$1)).apply(this, arguments));
    ...
    _createClass(ResourcePicker$$1, [{
        ...
        value: function componentDidMount() {
            ...
            var _props = this.props,
                ...
                _props$showHidden = _props.showHidden,
                showHidden = _props$showHidden === undefined ? false : _props$showHidden,
                _props$allowMultiple = _props.allowMultiple,
                allowMultiple = _props$allowMultiple === undefined ? true : _props$allowMultiple,
                _props$showVariants = _props.showVariants,
                showVariants = _props$showVariants === undefined ? true : _props$showVariants,
        ...
        value: function componentDidUpdate(prevProps) {
            ...
            var _props2 = this.props,
                open = _props2.open,
                initialQuery = _props2.initialQuery,
                _props2$showHidden = _props2.showHidden,
                showHidden = _props2$showHidden === undefined ? false : _props2$showHidden,
                _props2$allowMultiple = _props2.allowMultiple,
                allowMultiple = _props2$allowMultiple === undefined ? true : _props2$allowMultiple,
                _props2$showVariants = _props2.showVariants,
                showVariants = _props2$showVariants === undefined ? true : _props2$showVariants;
...
var ResourcePicker$3 = withAppProvider()(ResourcePicker$2);
...
var Item$21 = function (_React$PureComponent) {
    _inherits(Item, _React$PureComponent);
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var sharedProps = {
                ...
                onClick: onClick,
                className: styles$89.Item,
                'aria-controls': panelID,
                'aria-selected': false,
                'aria-label': accessibilityLabel
            };
            var markup = url ? createElement(UnstyledLink$2, Object.assign({ url: url }, sharedProps), children) : createElement(
                'button',
                Object.assign({}, sharedProps, { type: 'button' }),
                children
            );
            return createElement(
                'li',
...
__decorate([autobind], Item$21.prototype, "setFocusedNode", null);
...
var List$3 = function (_React$PureComponent) {
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            return createElement(
                'ul',
                { className: styles$89.List, onKeyDown: handleKeyDown$2, onKeyUp: this.handleKeypress },
                tabs
            );
        }
    }, {
...
__decorate([autobind], List$3.prototype, "handleKeypress", null);
...
function Panel$1(_ref) {
  ...
  return createElement(
    'div',
    { className: styles$89.Panel, id: id, role: 'tabpanel', 'aria-labelledby': tabID, tabIndex: -1 },
    children
  );
}
...
var Tab$1 = function (_React$PureComponent) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$89.Tab, selected && styles$89['Tab-selected']);
            var tabIndex = void 0;
            ...
            var markup = url ? createElement(
                ...
                createElement(
                    'span',
                    { className: styles$89.Title },
                    children
                )
            ) : createElement(
                'button',
                { id: id, role: 'tab', type: 'button', tabIndex: tabIndex, className: className, onClick: handleClick, 'aria-selected': selected, 'aria-controls': panelID, 'aria-label': accessibilityLabel, onMouseUp: handleMouseUpByBlurring },
                createElement(
                    'span',
                    { className: styles$89.Title },
                    children
            ...
            return createElement(
                'li',
                { role: 'presentation', className: styles$89.TabContainer, ref: this.setNode },
                markup
            );
        }
    }, {
...
__decorate([autobind], Tab$1.prototype, "setNode", null);
...
var TabMeasurer$1 = function (_React$PureComponent) {
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var classname = classNames(styles$89.Tabs, styles$89.TabMeasurer);
            return createElement(
                'div',
...
__decorate([autobind], TabMeasurer$1.prototype, "setContainerNode", null);
__decorate([autobind], TabMeasurer$1.prototype, "handleMeasurement", null);
...
var Tabs$1 = function (_React$PureComponent) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var classname = classNames(styles$89.Tabs, fitted && styles$89.fitted, disclosureActivatorVisible && styles$89.fillSpace);
            var disclosureTabClassName = classNames(styles$89.DisclosureTab, disclosureActivatorVisible && styles$89['DisclosureTab-visible']);
            var activator = createElement(
                'button',
                { tabIndex: -1, className: styles$89.DisclosureActivator, onClick: this.handleDisclosureActivatorClick },
                createElement(Icon$2, { source: 'horizontalDots' })
            );
            return createElement(
                'div',
                null,
                createElement(
                    ...
                    createElement(
                        ...
                        createElement(
                            Popover$1,
                            { preferredPosition: 'below', activator: activator, active: disclosureActivatorVisible && showDisclosure, onClose: this.handleClose },
                            createElement(List$3, { focusIndex: hiddenTabs.indexOf(tabToFocus), disclosureTabs: disclosureTabs, onClick: this.handleTabClick, onKeyPress: this.handleKeyPress })
                        )
                    )
                ),
                createElement(TabMeasurer$1, { tabToFocus: tabToFocus, activator: activator, selected: selected, tabs: tabs, siblingTabHasFocus: tabToFocus > -1, handleMeasurement: this.handleMeasurement }),
                panelMarkup
            );
        }
    }, {
        ...
        value: function handleFocus(event) {
            ...
            var target$$1 = event.target;
            if (target$$1.classList.contains(styles$89.Tab) || target$$1.classList.contains(styles$89.Item)) {
                var tabToFocus = -1;
            ...
            if (target$$1.classList.contains(styles$89.DisclosureActivator)) {
                return;
            }
            ...
            var relatedTarget = event.relatedTarget;
            if (!relatedTarget.classList.contains(styles$89.Tab) && !relatedTarget.classList.contains(styles$89.Item) && !relatedTarget.classList.contains(styles$89.DisclosureActivator)) {
                this.setState({ tabToFocus: selected });
            }
        }
    }, {
...
function Thumbnail$1(_ref) {
    ...
    var className = classNames(styles$90.Thumbnail, size && styles$90[variationName('size', size)]);
    return createElement(
        'span',
        { className: className },
        createElement(Image$1, { alt: alt, source: source, className: styles$90.Image })
    );
}

var createId = createUniqueIDFactory('Toast');
var Toast$3 = function (_React$PureComponent) {
    ...
    _createClass(Toast, [{
        ...
        value: function componentDidMount() {
            ...
            var error = props.error,
                ...
                duration = _props$duration === undefined ? DEFAULT_TOAST_DURATION : _props$duration,
                onDismiss = props.onDismiss;
            var appBridge = props.polaris.appBridge;

            if (appBridge == null) {
                context.frame.showToast(Object.assign({ id: id }, props));
            } else {
...
Toast$3.contextTypes = frameContextTypes;
var Toast$4 = withAppProvider()(Toast$3);
...
var Search$1 = function (_React$PureComponent) {
    ...
    _createClass(Search, [{
        ...
        value: function render() {
            ...
            var searchClassName = classNames(styles$91.Search, visible && styles$91.visible);
            return createElement(
                'div',
                { ref: this.node, className: searchClassName, onClick: this.handleDismiss },
                createElement(
                    'div',
                    { className: styles$91.Overlay },
                    children
                )
            );
        }
...
__decorate([autobind], Search$1.prototype, "handleDismiss", null);
...
var SearchField$1 = function (_React$Component) {
    _inherits(SearchField, _React$Component);

    function SearchField() {
        _classCallCheck(this, SearchField);

        var _this = _possibleConstructorReturn(this, (SearchField.__proto__ || Object.getPrototypeOf(SearchField)).apply(this, arguments));
    ...
    _createClass(SearchField, [{
        ...
        value: function render() {
            ...
            var clearMarkup = value !== '' && createElement(
                'button',
                { type: 'button', 'aria-label': 'Clear', className: styles$92.Clear, onClick: this.handleClear },
                createElement(Icon$2, { source: 'circleCancel' })
            );
            var className = classNames(styles$92.SearchField, (focused || active) && styles$92.focused);
            return createElement(
                'div',
                { className: className, onFocus: this.handleFocus, onBlur: this.handleBlur },
                createElement('input', { className: styles$92.Input, placeholder: placeholder, type: 'search', autoCapitalize: 'off', autoComplete: 'off', autoCorrect: 'off', ref: this.input, value: value, onChange: this.handleChange, onKeyDown: preventDefault }),
                createElement(
                    'span',
                    { className: styles$92.Icon },
                    createElement(Icon$2, { source: 'search' })
                ),
                clearMarkup,
                createElement('div', { className: styles$92.Backdrop })
            );
        }
    }, {
        key: 'handleFocus',
        ...
        value: function handleClear() {
            var _props2 = this.props,
                ...
                onCancel = _props2$onCancel === undefined ? noop$1 : _props2$onCancel,
                onChange = _props2.onChange;
            var input = this.input.current;
...
__decorate([autobind], SearchField$1.prototype, "handleFocus", null);
__decorate([autobind], SearchField$1.prototype, "handleBlur", null);
__decorate([autobind], SearchField$1.prototype, "handleClear", null);
__decorate([autobind], SearchField$1.prototype, "handleChange", null);
...
function Menu$1(props) {
    ...
    var messageMarkup = message && createElement(Message$3, { title: message.title, description: message.description, action: {
            onClick: message.action.onClick,
            content: message.action.content
        }, link: { to: message.link.to, content: message.link.content }, badge: badgeProps });
    ...
    return createElement(
        ...
        { activator: createElement(
                'button',
                { type: 'button', className: styles$94.Activator, onClick: onOpen },
                activatorContent
            ), active: open, onClose: onClose, fixed: true, fullHeight: isFullHeight },
        createElement(ActionList$1, { onActionAnyItem: onClose, sections: actions$$1 }),
        messageMarkup
    );
}
...
function UserMenu$4(_ref) {
  ...
  var showIndicator = Boolean(message);
  var activatorContentMarkup = createElement(
    'div',
    { className: styles$95.UserMenu },
    createElement(
      MessageIndicator$1,
      { active: showIndicator },
      createElement(Avatar$2, { size: 'small', source: avatar, initials: initials && initials.replace(' ', '') })
    ),
    createElement(
      'span',
      { className: styles$95.Details },
      createElement(
        'p',
        { className: styles$95.Name, title: 'altText' },
        name
      ),
      createElement(
        'p',
        { className: styles$95.Detail },
        detail
      )
    )
  );
  return createElement(Menu$1, { activatorContent: activatorContentMarkup, open: open, onOpen: onToggle, onClose: onToggle, actions: actions$$1, message: message });
}
...
var TopBar$1 = function (_React$PureComponent) {
    _inherits(TopBar, _React$PureComponent);

    function TopBar() {
        _classCallCheck(this, TopBar);

        var _this = _possibleConstructorReturn(this, (TopBar.__proto__ || Object.getPrototypeOf(TopBar)).apply(this, arguments));
    ...
    _createClass(TopBar, [{
        ...
        value: function render() {
            var _props = this.props,
                showNavigationToggle = _props.showNavigationToggle,
                userMenu = _props.userMenu,
                searchResults = _props.searchResults,
                searchField = _props.searchField,
                secondaryMenu = _props.secondaryMenu,
                searchResultsVisible = _props.searchResultsVisible,
                onNavigationToggle = _props.onNavigationToggle,
                onSearchResultsDismiss = _props.onSearchResultsDismiss,
                logo = _props.polaris.theme.logo;
            var focused = this.state.focused;

            var className = classNames(styles$96.NavigationIcon, focused && styles$96.focused);
            var navigationButtonMarkup = showNavigationToggle ? createElement(
                'button',
                { type: 'button', className: className, onClick: onNavigationToggle, onFocus: this.handleFocus, onBlur: this.handleBlur, 'aria-label': 'Toggle menu' },
                createElement(Icon$2, { source: menu, color: 'white' })
            ) : null;
            var width = getWidth(logo, 104);
            var logoMarkup = logo ? createElement(
                UnstyledLink$2,
                { url: logo.url || '', className: styles$96.LogoLink, style: { width: width } },
                createElement(Image$1, { source: logo.topBarSource || '', alt: logo.accessibilityLabel || '', className: styles$96.Logo, style: { width: width } })
            ) : null;
            var searchResultsMarkup = searchResults && searchResultsVisible ? createElement(
                Search$1,
                { visible: searchResultsVisible, onDismiss: onSearchResultsDismiss },
                searchResults
            ) : null;
            var searchMarkup = searchField ? createElement(
                Fragment,
                null,
                searchField,
                searchResultsMarkup
            ...
            return createElement(
                'div',
                { className: styles$96.TopBar },
                navigationButtonMarkup,
                createElement(
                    'div',
                    { className: styles$96.LogoContainer },
                    logoMarkup
                ),
                createElement(
                    'div',
                    { className: styles$96.Contents },
                    searchMarkup,
                    secondaryMenu,
                    userMenu
                )
...
TopBar$1.UserMenu = UserMenu$4;
TopBar$1.SearchField = SearchField$1;
TopBar$1.Menu = Menu$1;
__decorate([autobind], TopBar$1.prototype, "handleFocus", null);
__decorate([autobind], TopBar$1.prototype, "handleBlur", null);
var TopBar$2 = withAppProvider()(TopBar$1);
...
function SkeletonDisplayText$1(_ref) {
    ...
    var className = classNames(styles$97.DisplayText, size && styles$97[variationName('size', size)]);
...
function SkeletonBodyText$1(_ref) {
    ...
    for (var i = 0; i < lines; i++) {
        bodyTextLines.push(createElement('div', { className: styles$98.SkeletonBodyText, key: i }));
    }
    return createElement(
        'div',
        { className: styles$98.SkeletonBodyTextContainer },
        bodyTextLines
    );
}
...
var SkeletonPage = function (_React$PureComponent) {
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$99.Page, fullWidth && styles$99.fullWidth, singleColumn && styles$99.singleColumn);
      var headerClassName = classNames(styles$99.Header, breadcrumbs && styles$99['Header-hasBreadcrumbs'], secondaryActions && styles$99['Header-hasSecondaryActions']);
      var titleMarkup = title !== null ? renderTitle(title) : null;
      var primaryActionMarkup = primaryAction ? createElement(
        'div',
        { className: styles$99.PrimaryAction },
        createElement(SkeletonDisplayText$1, { size: 'large' })
      ) : null;
      var secondaryActionsMarkup = secondaryActions ? renderSecondaryActions(secondaryActions) : null;
      var breadcrumbMarkup = breadcrumbs ? createElement(
        'div',
        { className: styles$99.BreadcrumbAction, style: { width: 60 } },
        createElement(SkeletonBodyText$1, { lines: 1 })
      ) : null;
      var headerMarkup = !this.props.polaris.appBridge ? createElement(
        'div',
        { className: headerClassName },
        breadcrumbMarkup,
        createElement(
          'div',
          { className: styles$99.TitleAndPrimaryAction },
          titleMarkup,
          primaryActionMarkup
        ),
        secondaryActionsMarkup
...
function renderSecondaryActions(actionCount) {
  ...
  for (var i = 0; i < actionCount; i++) {
    ...
    actions$$1.push(createElement(
      'div',
      { className: styles$99.Action, style: { width: width }, key: i },
      createElement(SkeletonBodyText$1, { lines: 1 })
    ));
  }
  return createElement(
    'div',
    { className: styles$99.Actions },
    actions$$1
  );
}
function renderTitle(title) {
  ...
  return createElement(
    'div',
    { className: styles$99.Title },
    titleContent
  );
}
var SkeletongBodyText$1 = withAppProvider()(SkeletonPage);
...
function ProgressBar$1(_ref) {
    ...
    var className = classNames(styles$100.ProgressBar, size && styles$100[variationName('size', size)]);
    ...
    return createElement(
        'div',
        { className: className },
        createElement('progress', { className: styles$100.Progress, value: parsedProgress, max: '100' }),
        createElement(
            'div',
            { className: styles$100.Indicator, style: { width: parsedProgress + '%' } },
            createElement(
                'span',
                { className: styles$100.Label },
                parsedProgress,
                '%'
            )
        )
...
var ProgressBar$2 = withAppProvider()(ProgressBar$1);

export { Key, contentContextTypes, AccountConnection$1 as AccountConnection, ActionList$1 as ActionList, AppProvider, polarisAppProviderContextTypes as polarisContextTypes, createAppProviderContext, createPolarisContext, withAppProvider, Autocomplete$2 as Autocomplete, Avatar$2 as Avatar, Badge$2 as Badge, Banner$1 as Banner, Backdrop$1 as Backdrop, Breadcrumbs$1 as Breadcrumbs, Button$3 as Button, buttonFrom, buttonsFrom, ButtonGroup$2 as ButtonGroup, CalloutCard$1 as CalloutCard, Caption$1 as Caption, Card$1 as Card, Checkbox$4 as Checkbox, ChoiceList$2 as ChoiceList, Collapsible$2 as Collapsible, ColorPicker$1 as ColorPicker, rgbToHex, rgbToHsb, rgbToHsl, hsbToRgb, hsbToHex, rgbString, rgbaString, Connected$1 as Connected, ContextualSaveBar$1 as ContextualSaveBar, DataTable$2 as DataTable, DatePicker$2 as DatePicker, DescriptionList$1 as DescriptionList, DisplayText$1 as DisplayText, DropZone$2 as DropZone, EmptySearchResult$2 as EmptySearchResult, EmptyState$1 as EmptyState, EventListener$1 as EventListener, ExceptionList$1 as ExceptionList, Focus$1 as Focus, TrapFocus$1 as TrapFocus, FooterHelp$1 as FooterHelp, Form$1 as Form, FormLayout$1 as FormLayout, Frame$2 as Frame, DEFAULT_TOAST_DURATION, Heading$1 as Heading, Icon$2 as Icon, Image$1 as Image, InlineError$1 as InlineError, KeyboardKey$1 as KeyboardKey, KeypressListener$1 as KeypressListener, Label$1 as Label, Labelled$1 as Labelled, Layout$1 as Layout, Link$3 as Link, ContentList as List, Loading$6 as Loading, Modal$3 as Modal, OptionList$2 as OptionList, Navigation$4 as Navigation, isNavigationItemActive, Page$1 as Page, PageActions$1 as PageActions, Pagination$2 as Pagination, Popover$1 as Popover, CloseSource as PopoverCloseSource, Portal$1 as Portal, RadioButton$1 as RadioButton, RangeSlider$2 as RangeSlider, ResourceList$2 as ResourceList, FilterType, ResourcePicker$3 as ResourcePicker, Scrollable$2 as Scrollable, ScrollLock$1 as ScrollLock, Select$1 as Select, SettingToggle$1 as SettingToggle, Spinner$2 as Spinner, Stack$1 as Stack, Sticky$1 as Sticky, Subheading$1 as Subheading, Tabs$1 as Tabs, Tag$2 as Tag, TextContainer$1 as TextContainer, TextField$5 as TextField, TextStyle$1 as TextStyle, Thumbnail$1 as Thumbnail, ThemeProvider$1 as ThemeProvider, Toast$4 as Toast, Tooltip$1 as Tooltip, TopBar$2 as TopBar, Truncate$1 as Truncate, UnstyledLink$2 as UnstyledLink, VisuallyHidden$1 as VisuallyHidden, SkeletongBodyText$1 as SkeletonPage, SkeletonBodyText$1 as SkeletonBodyText, SkeletonDisplayText$1 as SkeletonDisplayText, ProgressBar$2 as ProgressBar, Indicator$1 as Indicator, withContext$1 as withContext, withRef$1 as withRef };
