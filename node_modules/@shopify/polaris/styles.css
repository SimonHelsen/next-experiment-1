...
.Polaris-Indicator--pulseIndicator::before{
  z-index:1;
  -webkit-animation:Polaris-Indicator--bounce 5s ease infinite;
          animation:Polaris-Indicator--bounce 5s ease infinite; }

.Polaris-Indicator--pulseIndicator::after{
  right:-0.4rem;
  top:-0.4rem;
  -webkit-animation:Polaris-Indicator--pulse 5s ease infinite;
          animation:Polaris-Indicator--pulse 5s ease infinite; }

@-webkit-keyframes Polaris-Indicator--bounce{
  from,
  65%,
  85%{
...
@-webkit-keyframes Polaris-Indicator--pulse{
  from,
  75%{
    -webkit-transform:scale(0.85);
            transform:scale(0.85);
...
.Polaris-Backdrop{
  ...
  -webkit-animation:Polaris-Backdrop__fade--in 200ms 1 forwards;
...
@-webkit-keyframes Polaris-Backdrop__fade--in{
  0%{
    opacity:0; }
  100%{
    opacity:1; } }
...
.Polaris-Frame-ToastManager__ToastWrapper{
  ...
  -webkit-transform:translateY(var(--toast-translate-y-out));
...
.Polaris-Frame-ToastManager--toastWrapperEnterDone{
  -webkit-transform:translateY(var(--toast-translate-y-in));
...
.Polaris-Frame-Loading__Level{
  ...
  -webkit-transform-origin:0;
          transform-origin:0;
  background-color:#47c1bf;
  transition:-webkit-transform 500ms cubic-bezier(0, 0, 0.42, 1);
  transition:transform 500ms cubic-bezier(0, 0, 0.42, 1);
  transition:transform 500ms cubic-bezier(0, 0, 0.42, 1), -webkit-transform 500ms cubic-bezier(0, 0, 0.42, 1); }
...
@-webkit-keyframes Polaris-Navigation__fade--in{
  0%{
    opacity:0; }
  100%{
    opacity:1; } }
...
.Polaris-Navigation__ListItem{
  ...
  .Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__ListItem{
    opacity:0;
    -webkit-animation:Polaris-Navigation__fade--in 500ms 1 forwards;
...
@-webkit-keyframes Polaris-Navigation-UserMenu__fade--in{
  0%{
    opacity:0; }
  100%{
    opacity:1; } }
...
.Polaris-Navigation-UserMenu__Details{
  ...
  -webkit-box-flex:1;
      -ms-flex:1 1 auto;
          flex:1 1 auto;
  max-width:calc( 100% - 0.8rem - 3.2rem - 2rem);
  padding-right:0.8rem; }
...
.Polaris-Navigation-UserMenu__List{
  ...
  transition:transform 200ms cubic-bezier(0.64, 0, 0.35, 1), opacity 200ms cubic-bezier(0.64, 0, 0.35, 1), -webkit-transform 200ms cubic-bezier(0.64, 0, 0.35, 1);
  display:none; }
...
.Polaris-TopBar-SearchField__Backdrop{
  ...
  transition:background-color 200ms cubic-bezier(0.64, 0, 0.35, 1);
  border-radius:3px;
  -webkit-animation:Polaris-TopBar-SearchField--toLightBackground 0.01ms;
          animation:Polaris-TopBar-SearchField--toLightBackground 0.01ms; }

@-webkit-keyframes Polaris-TopBar-SearchField--toLightBackground{
  to{
    background-color:var(--top-bar-background-lighter); } }
...
.Polaris-TopBar__LogoContainer{
  ...
  @media (min-width: 48.0625em){
    .Polaris-TopBar__LogoContainer{
      ...
      -ms-flex-preferred-size:calc(24rem + constant(safe-area-inset-left));
          flex-basis:calc(24rem + constant(safe-area-inset-left));
      -ms-flex-preferred-size:calc(24rem + env(safe-area-inset-left));
