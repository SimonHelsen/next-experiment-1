...
export class Item extends React.PureComponent {
    ...
    render() {
        ...
        const accessibleMarkup = url ? (<UnstyledLink aria-describedby={this.props.id} aria-label={accessibilityLabel} className={styles.Link} url={url} onFocus={this.handleAnchorFocus} onBlur={this.handleFocusedBlur}/>) : (<button className={styles.Button} aria-label={accessibilityLabel} aria-controls={ariaControls} aria-expanded={ariaExpanded} onClick={this.handleClick} onFocus={this.handleAnchorFocus} onBlur={this.handleFocusedBlur}/>);
